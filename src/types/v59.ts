...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_144,
            minCreateBond: Type_144,
            maxPools: Type_145,
            maxMembers: Type_145,
...
export type Type_146 = Type_146_Noop | Type_146_Remove | Type_146_Set
...
export type Call = Call_Aleph | Call_Balances | Call_Contracts | Call_Elections | Call_Identity | Call_Multisig | Call_NominationPools | Call_Scheduler | Call_Session | Call_Staking | Call_Sudo | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting
