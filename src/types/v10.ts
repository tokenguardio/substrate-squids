...
export type CallOf = CallOf_System | CallOf_Timestamp | CallOf_Sudo | CallOf_Scheduler | CallOf_Indices | CallOf_Balances | CallOf_Currencies | CallOf_TransactionPayment | CallOf_Authority | CallOf_Utility | CallOf_Multisig | CallOf_EvmAccounts | CallOf_EVM | CallOf_Authorship | CallOf_Babe | CallOf_Grandpa | CallOf_Staking | CallOf_Session | CallOf_ImOnline | CallOf_Identity | CallOf_TechCouncil | CallOf_Poc
...
export type Type_50 = Type_50_System | Type_50_Timestamp | Type_50_Sudo | Type_50_Scheduler | Type_50_Indices | Type_50_Balances | Type_50_Currencies | Type_50_TransactionPayment | Type_50_Authority | Type_50_Utility | Type_50_Multisig | Type_50_EvmAccounts | Type_50_EVM | Type_50_Authorship | Type_50_Babe | Type_50_Grandpa | Type_50_Staking | Type_50_Session | Type_50_ImOnline | Type_50_Identity | Type_50_TechCouncil | Type_50_Poc
...
export interface Type_50_Indices {
    __kind: 'Indices'
    value: IndicesCall
}
...
export interface Type_50_TransactionPayment {
    __kind: 'TransactionPayment'
    value: TransactionPaymentCall
}

export interface Type_50_Authority {
    __kind: 'Authority'
    value: AuthorityCall
}
...
export interface Type_50_Multisig {
    __kind: 'Multisig'
    value: MultisigCall
}

export interface Type_50_EvmAccounts {
    __kind: 'EvmAccounts'
    value: EvmAccountsCall
}

export interface Type_50_EVM {
    __kind: 'EVM'
    value: EVMCall
}
...
export interface Type_50_Babe {
    __kind: 'Babe'
    value: BabeCall
}

export interface Type_50_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaCall
}

export interface Type_50_Staking {
    __kind: 'Staking'
    value: StakingCall
}
...
export interface Type_50_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineCall
}

export interface Type_50_Identity {
    __kind: 'Identity'
    value: IdentityCall
}

export interface Type_50_TechCouncil {
    __kind: 'TechCouncil'
    value: TechCouncilCall
}

export interface Type_50_Poc {
    __kind: 'Poc'
    value: PocCall
}
...
export type Proposal = Proposal_System | Proposal_Timestamp | Proposal_Sudo | Proposal_Scheduler | Proposal_Indices | Proposal_Balances | Proposal_Currencies | Proposal_TransactionPayment | Proposal_Authority | Proposal_Utility | Proposal_Multisig | Proposal_EvmAccounts | Proposal_EVM | Proposal_Authorship | Proposal_Babe | Proposal_Grandpa | Proposal_Staking | Proposal_Session | Proposal_ImOnline | Proposal_Identity | Proposal_TechCouncil | Proposal_Poc
