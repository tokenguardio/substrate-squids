...
export type Type_363 = Type_363_Member | Type_363_Members | Type_363__Phantom
...
export type Type_365 = Type_365_Relay | Type_365_SiblingParachain

export interface Type_365_Relay {
    __kind: 'Relay'
}

export interface Type_365_SiblingParachain {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OmnipoolCall = OmnipoolCall_add_liquidity | OmnipoolCall_add_token | OmnipoolCall_buy | OmnipoolCall_initialize_pool | OmnipoolCall_refund_refused_asset | OmnipoolCall_remove_liquidity | OmnipoolCall_remove_token | OmnipoolCall_sacrifice_position | OmnipoolCall_sell | OmnipoolCall_set_asset_tradable_state | OmnipoolCall_set_asset_weight_cap | OmnipoolCall_set_tvl_cap | OmnipoolCall_withdraw_protocol_liquidity
