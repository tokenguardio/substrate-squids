...
export const Type_421: sts.Type<Type_421> = sts.struct(() => {
    return  {
        first: VoteMessage,
        second: VoteMessage,
    }
...
export const Type_407: sts.Type<Type_407> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_410),
        V3: sts.array(() => Type_414),
    }
})
...
export const Type_414: sts.Type<Type_414> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_414),
        SetErrorHandler: sts.array(() => Type_414),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_411: sts.Type<Type_411> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_411 {
    encoded: Bytes
}

export type Type_414 = Type_414_AliasOrigin | Type_414_BurnAsset | Type_414_BuyExecution | Type_414_ClaimAsset | Type_414_ClearError | Type_414_ClearOrigin | Type_414_ClearTopic | Type_414_ClearTransactStatus | Type_414_DepositAsset | Type_414_DepositReserveAsset | Type_414_DescendOrigin | Type_414_ExchangeAsset | Type_414_ExpectAsset | Type_414_ExpectError | Type_414_ExpectOrigin | Type_414_ExpectPallet | Type_414_ExpectTransactStatus | Type_414_ExportMessage | Type_414_HrmpChannelAccepted | Type_414_HrmpChannelClosing | Type_414_HrmpNewChannelOpenRequest | Type_414_InitiateReserveWithdraw | Type_414_InitiateTeleport | Type_414_LockAsset | Type_414_NoteUnlockable | Type_414_QueryPallet | Type_414_QueryResponse | Type_414_ReceiveTeleportedAsset | Type_414_RefundSurplus | Type_414_ReportError | Type_414_ReportHolding | Type_414_ReportTransactStatus | Type_414_RequestUnlock | Type_414_ReserveAssetDeposited | Type_414_SetAppendix | Type_414_SetErrorHandler | Type_414_SetFeesMode | Type_414_SetTopic | Type_414_SubscribeVersion | Type_414_Transact | Type_414_TransferAsset | Type_414_TransferReserveAsset | Type_414_Trap | Type_414_UniversalOrigin | Type_414_UnlockAsset | Type_414_UnpaidExecution | Type_414_UnsubscribeVersion | Type_414_WithdrawAsset
...
export const Type_410: sts.Type<Type_410> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_410),
        SetErrorHandler: sts.array(() => Type_410),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_410 = Type_410_BuyExecution | Type_410_ClaimAsset | Type_410_ClearError | Type_410_ClearOrigin | Type_410_DepositAsset | Type_410_DepositReserveAsset | Type_410_DescendOrigin | Type_410_ExchangeAsset | Type_410_HrmpChannelAccepted | Type_410_HrmpChannelClosing | Type_410_HrmpNewChannelOpenRequest | Type_410_InitiateReserveWithdraw | Type_410_InitiateTeleport | Type_410_QueryHolding | Type_410_QueryResponse | Type_410_ReceiveTeleportedAsset | Type_410_RefundSurplus | Type_410_ReportError | Type_410_ReserveAssetDeposited | Type_410_SetAppendix | Type_410_SetErrorHandler | Type_410_SubscribeVersion | Type_410_Transact | Type_410_TransferAsset | Type_410_TransferReserveAsset | Type_410_Trap | Type_410_UnsubscribeVersion | Type_410_WithdrawAsset
...
export type Type_119 = Type_119_Noop | Type_119_Remove | Type_119_Set
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_289,
            minCreateBond: Type_289,
            maxPools: Type_290,
            maxMembers: Type_290,
...
export const Type_292: sts.Type<Type_292> = sts.closedEnum(() => {
    return  {
        Noop: sts.unit(),
        Remove: sts.unit(),
        Set: AccountId32,
...
export type Type_292 = Type_292_Noop | Type_292_Remove | Type_292_Set
...
export type Type_291 = Type_291_Noop | Type_291_Remove | Type_291_Set
...
export const Type_129: sts.Type<Type_129> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export const Type_131: sts.Type<Type_131> = sts.struct(() => {
    return  {
...
export const Type_137: sts.Type<Type_137> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
