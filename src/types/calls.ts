...
export class AssetRegistryRegisterAssetCall {
    ...
    get asV3000(): {metadata: v3000.AssetMetadata, assetId: (number | undefined)} {
        assert(this.isV3000)
...
export class AssetRegistryUpdateAssetCall {
    ...
    get asV3000(): {assetId: number, decimals: (number | undefined), name: (Uint8Array | undefined), symbol: (Uint8Array | undefined), existentialDeposit: (bigint | undefined), location: Option<(v3000.VersionedMultiLocation | undefined)>, additional: (v3000.CustomMetadata | undefined)} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class AuthorshipSetUnclesCall {
     ...
     * Provide a set of uncles.
     */
    get asV3000(): {newUncles: v3000.Header[]} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ClaimsClaimCall {
     ...
     * </weight>
     */
    get asV1(): {dest: Uint8Array, ethereumSignature: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ClaimsMintClaimCall {
     ...
     * </weight>
     */
    get asV1(): {who: Uint8Array, value: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ClaimsMoveClaimCall {
    ...
    get asV1(): {old: Uint8Array, new: Uint8Array, maybePreclaim: (Uint8Array | undefined)} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
...
export class CollatorStakingForceSetMinCollatorStakeCall {
     ...
     * ForceOrigin call only
     */
    get asV3012(): {minCollatorStake: bigint} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CollatorStakingJoinCandidatesCall {
     ...
     * Join the list of candidates for collation.
     */
    get asV3012(): {amount: bigint, rewardsCut: number} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CollatorStakingNominateCall {
     ...
     * Nominate a specific candidate to be selected for collation and block production.
     */
    get asV1(): {collatorId: Uint8Array, amount: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CollatorStakingRemoveNominationCall {
     ...
     * Remove a nomination previously registered for a specific collator candidate.
     */
    get asV1(): {collatorId: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CommunityPoolSpendCall {
     ...
     * beneficiary.
     */
    get asV3000(): {amount: bigint, beneficiary: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilCloseCall {
     ...
     * # </weight>
     */
    get asV2(): {proposalHash: Uint8Array, index: number, proposalWeightBound: bigint, lengthBound: number} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV3012(): {proposalHash: Uint8Array, index: number, proposalWeightBound: v3012.Weight, lengthBound: number} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilSetMembersCall {
     ...
     * # </weight>
     */
    get asV2(): {newMembers: Uint8Array[], prime: (Uint8Array | undefined), oldCount: number} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilVoteCall {
     ...
     * # </weight>
     */
    get asV2(): {proposal: Uint8Array, index: number, approve: boolean} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyBlacklistCall {
     ...
     *   reasonable value).
     */
    get asV2(): {proposalHash: Uint8Array, maybeRefIndex: (number | undefined)} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV2(): {to: Uint8Array, conviction: v2.Conviction, balance: bigint} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV3000(): {to: v3000.MultiAddress, conviction: v3000.Conviction, balance: bigint} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyEnactProposalCall {
     ...
     * Enact a proposal from a referendum. For now we just make the weight be the maximum.
     */
    get asV2(): {proposalHash: Uint8Array, index: number} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyExternalProposeCall {
     ...
     * - `proposal_hash`: The preimage hash of the proposal.
     */
    get asV3012(): {proposal: v3012.Bounded} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyFastTrackCall {
     ...
     * Weight: `O(1)`
     */
    get asV2(): {proposalHash: Uint8Array, votingPeriod: number, delay: number} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyProposeCall {
     ...
     * Weight: `O(p)`
     */
    get asV2(): {proposalHash: Uint8Array, value: bigint} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Emits `Proposed`.
     */
    get asV3012(): {proposal: v3012.Bounded, value: bigint} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyReapPreimageCall {
     ...
     * Weight: `O(D)` where D is length of proposal.
     */
    get asV2(): {proposalHash: Uint8Array, proposalLenUpperBound: number} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV2(): {target: Uint8Array, index: number} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV3000(): {target: v3000.MultiAddress, index: number} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyUnlockCall {
     ...
     * Weight: `O(R)` with R number of vote of target.
     */
    get asV3000(): {target: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DmpQueueServiceOverweightCall {
     ...
     * - `OverweightServiced`: On success.
     */
    get asV3012(): {index: bigint, weightLimit: bigint} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class EfinityXcmForceSetMinimumWeightCall {
     ...
     * Update xcm fees amount to be used in xcm.Withdraw message
     */
    get asV3012(): {xcmCall: v3012.XcmOperation, xcmWeightFeeMisc: v3012.MinimumWeightFeePair} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class EfinityXcmTransferAssetToParachainCall {
     ...
     * - `InvalidAccountId`: `beneficiary` is invalid, i.e could not be converted to
     */
    get asV3012(): {paraId: v3012.ParachainId, beneficiary: v3012.Account, assetId: v3012.AssetId, amount: bigint, destWeight: (bigint | undefined)} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class EfinityXcmTransferToAcalaCall {
     ...
     * `origin` transfers `amount` of EFI to `beneficiary` to the Acala parachain.
     */
    get asV3000(): {beneficiary: Uint8Array, amount: bigint} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class EfinityXcmTransferToParachainCall {
     ...
     *   `MultiLocation`
     */
    get asV3012(): {paraId: v3012.ParachainId, beneficiary: v3012.Account, amount: bigint, destWeight: (bigint | undefined)} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksAddAccountCall {
     ...
     * - `AccountAlreadyExists` if account at `user_id` already exists
     */
    get asV3000(): {tankId: v3000.MultiAddress, userId: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksBatchAddAccountCall {
     ...
     * - `AccountAlreadyExists` if account at `user_id` already exists
     */
    get asV3000(): {tankId: v3000.MultiAddress, userIds: v3000.MultiAddress[]} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksDestroyFuelTankCall {
     ...
     * Can only be destroyed if all accounts are removed
     */
    get asV3000(): {tankId: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksForceSetConsumptionCall {
     ...
     * - `NoPermission` if caller is not ForceOrigin or fuel tank owner
     */
    get asV3000(): {tankId: v3000.MultiAddress, userId: (v3000.MultiAddress | undefined), ruleSetId: number, consumption: v3000.Consumption} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksMutateFuelTankCall {
     ...
     * - `NoPermission` if `origin` is not the fuel tank owner
     */
    get asV3012(): {tankId: v3012.MultiAddress, mutation: v3012.DefaultTankMutation} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksRemoveAccountRuleDataCall {
     ...
     * - `RuleNotFound` if rule does not exist for `rule_kind`
     */
    get asV3012(): {tankId: v3012.MultiAddress, userId: v3012.MultiAddress, ruleSetId: number, ruleKind: v3012.DispatchRuleKind} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksRemoveRuleSetCall {
     ...
     *   data
     */
    get asV3000(): {tankId: v3000.MultiAddress, ruleSetId: number} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FuelTanksScheduleMutateFreezeStateCall {
     ...
     * - `FreezeQueueFull` if the queue is full
     */
    get asV3000(): {tankId: v3000.MultiAddress, ruleSetId: (number | undefined), isFrozen: boolean} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceCreateListingCall {
     ...
     * - `ListingAlreadyExists` if a listing with the same ID already exists
     */
    get asV3000(): {makeAssetId: v3000.AssetId, takeAssetId: v3000.AssetId, amount: bigint, price: bigint, salt: Uint8Array, auctionData: (v3000.AuctionData | undefined)} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceFillListingCall {
     ...
     * - `LowTokenBalance` if the buyer does not have enough tokens for reserve
     */
    get asV3000(): {listingId: Uint8Array, amount: bigint} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplacePlaceBidCall {
     ...
     * - `Overflow` if new bid price is too large
     */
    get asV3000(): {listingId: Uint8Array, price: bigint} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceSetProtocolFeeCall {
     ...
     * - `protocol_fee`: Percentage of fee to set
     */
    get asV3000(): {protocolFee: number} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsBatchTransferCall {
     ...
     * `source` account.
     */
    get asV1(): {asset: bigint, recipients: v1.Recipient[]} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsBatchTransferByChunkCall {
     ...
     * - `recipients_by_chunk` must be bounded.
     */
    get asV1(): {asset: bigint, recipientsByChunk: v1.RecipientsByChunk[]} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsBurnCall {
     ...
     * See `Pallet::do_burn_by_chunk`.
     */
    get asV1(): {asset: bigint, token: number, amount: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsBurnAssetCall {
     ...
     * See `Pallet::do_burn_asset`.
     */
    get asV1(): {asset: bigint, assetAttributeCount: number, nextTokenId: number} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsBurnByChunkCall {
     ...
     * See `Pallet::do_burn_by_chunk`.
     */
    get asV1(): {asset: bigint, tokens: v1.Range[]} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsClearAssetAttributeCall {
     ...
     * See `Pallet::do_set_asset_attribute`.
     */
    get asV1(): {asset: bigint, key: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsClearTokenAttributeCall {
     ...
     * See `Pallet::do_set_token_attribute`.
     */
    get asV1(): {asset: bigint, token: number, key: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsMintCall {
     ...
     * Mints new `amount` of `asset` and transfer to `origin` account.
     */
    get asV1(): {asset: bigint, amount: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsSetAssetAttributeCall {
     ...
     * See `Pallet::do_set_asset_attribute`.
     */
    get asV1(): {asset: bigint, key: Uint8Array, value: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsSetTokenAttributeCall {
     ...
     * See `Pallet::do_set_token_attribute`.
     */
    get asV1(): {asset: bigint, token: number, key: Uint8Array, value: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsTransferCall {
     ...
     * See `chunks::do_transfer`.
     */
    get asV1(): {target: v1.MultiAddress, asset: bigint, token: number, amount: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsTransferByChunkCall {
     ...
     * Transfers the `tokens` of `asset` from `origin` to `target`.
     */
    get asV1(): {target: v1.MultiAddress, asset: bigint, tokens: v1.Range[]} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsTransferOwnershipCall {
     ...
     * - Weight based on number of chunks instead of number or elements of tokens.
     */
    get asV1(): {target: v1.MultiAddress, asset: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsOperatorExtApproveAssetCall {
     ...
     * Approve the `operator` to manage all of `origin`'s tokens belonging to `asset`
     */
    get asV1(): {operator: Uint8Array, asset: bigint, expiration: v1.Expiration} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsOperatorExtApproveForAllCall {
     ...
     * Approve `operator` to manage all the `origin`'s assets.
     */
    get asV1(): {operator: Uint8Array, expiration: v1.Expiration} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsOperatorExtApproveTokenCall {
     ...
     * Approve the `operator` to transfer up to `amount` of `origin`'s `token`s
     */
    get asV1(): {operator: Uint8Array, asset: bigint, token: number, amount: bigint, expiration: v1.Expiration} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsOperatorExtTransferFromCall {
     ...
     * Transfers `amount` of `tokens` from account `from` to address `to` if `origin` has enough allowance
     */
    get asV1(): {from: Uint8Array, to: Uint8Array, asset: bigint, token: number, amount: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsOperatorExtUnapproveAssetCall {
     ...
     * Unapprove the `operator` to manage all of `origin`'s tokens belonging to `asset`
     */
    get asV1(): {operator: Uint8Array, asset: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiAssetsOperatorExtUnapproveTokenCall {
     ...
     * Unapprove `operator` to transfer `origin`'s `token`s
     */
    get asV1(): {operator: Uint8Array, asset: bigint, token: number} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensApproveCollectionCall {
     ...
     * Approve the `operator` to manage all of `origin`'s tokens belonging to `collection`
     */
    get asV2(): {collectionId: bigint, operator: Uint8Array, expiration: (number | undefined)} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensApproveTokenCall {
     ...
     * Approve the `operator` to transfer up to `amount` of `origin`'s `token`s
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, operator: Uint8Array, amount: bigint, expiration: (number | undefined), currentAmount: bigint} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensBatchMintCall {
     ...
     * - `DepositReserveFailed` if the issuer does not have sufficent balance for token deposit
     */
    get asV2(): {collectionId: bigint, recipients: v2.Type_274[]} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     * - `DepositReserveFailed` if the issuer does not have sufficent balance for token deposit
     */
    get asV3000(): {collectionId: bigint, recipients: v3000.Type_351[], continueOnFailure: boolean} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
     ...
     * - `DepositReserveFailed` if the issuer does not have sufficent balance for token deposit
     */
    get asV3012(): {collectionId: bigint, recipients: v3012.Type_373[]} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensBatchSetAttributeCall {
     ...
     * - `DepositReserveFailed` if unable to reserve the deposit for the attribute storage.
     */
    get asV3012(): {collectionId: bigint, tokenId: (bigint | undefined), attributes: v3012.AttributeKeyValuePair[]} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensBatchTransferCall {
     ...
     * - `BalanceOverflow` if `target` balance of `collection` overflows.
     */
    get asV2(): {collectionId: bigint, recipients: v2.Recipient[]} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     * - `BalanceOverflow` if `target` balance of `collection` overflows.
     */
    get asV3012(): {collectionId: bigint, recipients: v3012.Recipient[]} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensCreateCollectionCall {
     ...
     * - `DepositReserveFailed` if the deposit cannot be reserved
     */
    get asV3012(): {descriptor: v3012.DefaultCollectionDescriptor} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensForceCreateCollectionCall {
     ...
     * - `DepositReserveFailed` if the deposit cannot be reserved
     */
    get asV3012(): {owner: Uint8Array, collectionId: bigint, descriptor: v3012.DefaultCollectionDescriptor} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensMintCall {
     ...
     *   another asset in `AssetIdsByLocation`
     */
    get asV3012(): {recipient: v3012.MultiAddress, collectionId: bigint, params: v3012.DefaultMintParams} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensRemoveAllAttributesCall {
     ...
     * - other errors from `remove_attribute`
     */
    get asV3012(): {collectionId: bigint, tokenId: (bigint | undefined), attributeCount: number} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensUnapproveCollectionCall {
     ...
     * Unapprove the `operator` to manage all of `origin`'s tokens belonging to `collection`
     */
    get asV2(): {collectionId: bigint, operator: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultiTokensUnapproveTokenCall {
     ...
     * Unapprove `operator` to transfer `origin`'s `token`s
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, operator: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultisigApproveAsMultiCall {
     ...
     * # </weight>
     */
    get asV2(): {threshold: number, otherSignatories: Uint8Array[], maybeTimepoint: (v2.Timepoint | undefined), callHash: Uint8Array, maxWeight: bigint} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV3012(): {threshold: number, otherSignatories: Uint8Array[], maybeTimepoint: (v3012.Timepoint | undefined), callHash: Uint8Array, maxWeight: v3012.Weight} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultisigAsMultiCall {
     ...
     * # </weight>
     */
    get asV2(): {threshold: number, otherSignatories: Uint8Array[], maybeTimepoint: (v2.Timepoint | undefined), call: Uint8Array, storeCall: boolean, maxWeight: bigint} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
...
export class MultisigCancelAsMultiCall {
     ...
     * # </weight>
     */
    get asV2(): {threshold: number, otherSignatories: Uint8Array[], timepoint: v2.Timepoint, callHash: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmExecuteCall {
     ...
     * to completion; only that *some* of it was executed.
     */
    get asV1(): {message: v1.Type_178, maxWeight: bigint} {
        assert(this.isV1)
        return this._chain.decodeCall(this.call)
    }
     ...
     * to completion; only that *some* of it was executed.
     */
    get asV3000(): {message: v3000.Type_315, maxWeight: v3000.Weight} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
     ...
     * to completion; only that *some* of it was executed.
     */
    get asV3012(): {message: v3012.Type_329, maxWeight: bigint} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PoolsMutatePoolsCall {
     ...
     * Mutate the pools. Can only be called by root.
     */
    get asV3000(): {mutation: v3000.PoolsMutation} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TechnicalMembershipAddMemberCall {
     ...
     * May only be called from `T::AddOrigin`.
     */
    get asV3000(): {who: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TechnicalMembershipChangeKeyCall {
     ...
     * Prime membership is passed from the origin account to `new`, if extant.
     */
    get asV3000(): {new: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TechnicalMembershipSwapMemberCall {
     ...
     * Prime membership is *not* passed from `remove` to `add`, if extant.
     */
    get asV2(): {remove: Uint8Array, add: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Prime membership is *not* passed from `remove` to `add`, if extant.
     */
    get asV3000(): {remove: v3000.MultiAddress, add: v3000.MultiAddress} {
        assert(this.isV3000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferCall {
     ...
     * messages correctly.
     */
    get asV3012(): {currencyId: v3012.AssetId, amount: bigint, dest: v3012.VersionedMultiLocation, destWeightLimit: v3012.V2WeightLimit} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMultiassetCall {
     ...
     * messages correctly.
     */
    get asV3012(): {asset: v3012.VersionedMultiAsset, dest: v3012.VersionedMultiLocation, destWeightLimit: v3012.V2WeightLimit} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMultiassetWithFeeCall {
     ...
     * messages correctly.
     */
    get asV3012(): {asset: v3012.VersionedMultiAsset, fee: v3012.VersionedMultiAsset, dest: v3012.VersionedMultiLocation, destWeightLimit: v3012.V2WeightLimit} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMultiassetsCall {
     ...
     * messages correctly.
     */
    get asV3012(): {assets: v3012.VersionedMultiAssets, feeItem: number, dest: v3012.VersionedMultiLocation, destWeightLimit: v3012.V2WeightLimit} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMulticurrenciesCall {
     ...
     * messages correctly.
     */
    get asV3012(): {currencies: [v3012.AssetId, bigint][], feeItem: number, dest: v3012.VersionedMultiLocation, destWeightLimit: v3012.V2WeightLimit} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferWithFeeCall {
     ...
     * messages correctly.
     */
    get asV3012(): {currencyId: v3012.AssetId, amount: bigint, fee: bigint, dest: v3012.VersionedMultiLocation, destWeightLimit: v3012.V2WeightLimit} {
        assert(this.isV3012)
        return this._chain.decodeCall(this.call)
    }
}
