...
export interface CrossInOutCall_register_linked_account {
    ...
    currencyId: CurrencyId
    who: Uint8Array
    foreignLocation: V1MultiLocation
}
...
export type Type_386 = Type_386_Members | Type_386_Member | Type_386__Phantom

export interface Type_386_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_386_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_386__Phantom {
    __kind: '_Phantom'
}

export type Type_387 = Type_387_Members | Type_387_Member | Type_387__Phantom

export interface Type_387_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_387_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_387__Phantom {
    __kind: '_Phantom'
}
...
export type Type_389 = Type_389_Relay | Type_389_SiblingParachain

export interface Type_389_Relay {
    __kind: 'Relay'
}

export interface Type_389_SiblingParachain {
...
export type Type_368 = Type_368_V0 | Type_368_V1 | Type_368_V2

export interface Type_368_V0 {
    __kind: 'V0'
    value: Type_369
}

export interface Type_368_V1 {
    __kind: 'V1'
    value: Type_374
}

export interface Type_368_V2 {
    __kind: 'V2'
    value: Type_380[]
}
...
export type Type_472 = Type_472_Ongoing | Type_472_Retired | Type_472_Success | Type_472_Failed | Type_472_RefundWithdrew | Type_472_RedeemWithdrew | Type_472_FailedToContinue

export interface Type_472_Ongoing {
    __kind: 'Ongoing'
}

export interface Type_472_Retired {
    __kind: 'Retired'
}

export interface Type_472_Success {
    __kind: 'Success'
}

export interface Type_472_Failed {
    __kind: 'Failed'
}

export interface Type_472_RefundWithdrew {
    __kind: 'RefundWithdrew'
}

export interface Type_472_RedeemWithdrew {
    __kind: 'RedeemWithdrew'
}

export interface Type_472_FailedToContinue {
    __kind: 'FailedToContinue'
}
...
export type TimeUnit = TimeUnit_Era | TimeUnit_SlashingSpan | TimeUnit_Round | TimeUnit_Kblock
...
export type Ledger = Ledger_Substrate | Ledger_Moonbeam | Ledger_ParachainStaking | Ledger_Filecoin
...
export type Type_369 = Type_369_WithdrawAsset | Type_369_ReserveAssetDeposit | Type_369_TeleportAsset | Type_369_QueryResponse | Type_369_TransferAsset | Type_369_TransferReserveAsset | Type_369_Transact | Type_369_HrmpNewChannelOpenRequest | Type_369_HrmpChannelAccepted | Type_369_HrmpChannelClosing | Type_369_RelayedFrom

export interface Type_369_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_371[]
}

export interface Type_369_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_371[]
}

export interface Type_369_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_371[]
}

export interface Type_369_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_369_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_369_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_369_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_369_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_369_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_369_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_374_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_374
}
...
export type Type_380 = Type_380_WithdrawAsset | Type_380_ReserveAssetDeposited | Type_380_ReceiveTeleportedAsset | Type_380_QueryResponse | Type_380_TransferAsset | Type_380_TransferReserveAsset | Type_380_Transact | Type_380_HrmpNewChannelOpenRequest | Type_380_HrmpChannelAccepted | Type_380_HrmpChannelClosing | Type_380_ClearOrigin | Type_380_DescendOrigin | Type_380_ReportError | Type_380_DepositAsset | Type_380_DepositReserveAsset | Type_380_ExchangeAsset | Type_380_InitiateReserveWithdraw | Type_380_InitiateTeleport | Type_380_QueryHolding | Type_380_BuyExecution | Type_380_RefundSurplus | Type_380_SetErrorHandler | Type_380_SetAppendix | Type_380_ClearError | Type_380_ClaimAsset | Type_380_Trap | Type_380_SubscribeVersion | Type_380_UnsubscribeVersion

export interface Type_380_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V1MultiAsset[]
}

export interface Type_380_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_380_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_380_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_380_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_380_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_380_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_380_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_380_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_380_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_380_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_380_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_380_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_380_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_380_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_380_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_380_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_380_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_380_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_380_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_380_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_380_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_380[]
}

export interface Type_380_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_380[]
}

export interface Type_380_ClearError {
    __kind: 'ClearError'
}

export interface Type_380_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_380_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_380_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_380_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_371 = Type_371_Null | Type_371_DepositAsset | Type_371_DepositReserveAsset | Type_371_ExchangeAsset | Type_371_InitiateReserveWithdraw | Type_371_InitiateTeleport | Type_371_QueryHolding | Type_371_BuyExecution

export interface Type_371_Null {
    __kind: 'Null'
}

export interface Type_371_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_371_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_371_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_371_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_371_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_371_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export interface Type_371_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export type Type_376 = Type_376_Noop | Type_376_DepositAsset | Type_376_DepositReserveAsset | Type_376_ExchangeAsset | Type_376_InitiateReserveWithdraw | Type_376_InitiateTeleport | Type_376_QueryHolding | Type_376_BuyExecution

export interface Type_376_Noop {
    __kind: 'Noop'
}

export interface Type_376_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_376_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_376_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_376_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_376_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_376_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_376_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_374[]
}
