...
export type Ledger = Ledger_Substrate | Ledger_Moonbeam | Ledger_ParachainStaking
...
export type Type_377 = Type_377_Members | Type_377_Member | Type_377__Phantom

export interface Type_377_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_377_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_377__Phantom {
    __kind: '_Phantom'
}
...
export type Type_379 = Type_379_Relay | Type_379_SiblingParachain

export interface Type_379_Relay {
    __kind: 'Relay'
}

export interface Type_379_SiblingParachain {
...
export type Type_358 = Type_358_V0 | Type_358_V1 | Type_358_V2

export interface Type_358_V0 {
    __kind: 'V0'
    value: Type_359
}

export interface Type_358_V1 {
    __kind: 'V1'
    value: Type_364
}

export interface Type_358_V2 {
    __kind: 'V2'
    value: Type_370[]
}
...
export type Type_457 = Type_457_Ongoing | Type_457_Retired | Type_457_Success | Type_457_Failed | Type_457_RefundWithdrew | Type_457_RedeemWithdrew | Type_457_FailedToContinue

export interface Type_457_Ongoing {
    __kind: 'Ongoing'
}

export interface Type_457_Retired {
    __kind: 'Retired'
}

export interface Type_457_Success {
    __kind: 'Success'
}

export interface Type_457_Failed {
    __kind: 'Failed'
}

export interface Type_457_RefundWithdrew {
    __kind: 'RefundWithdrew'
}

export interface Type_457_RedeemWithdrew {
    __kind: 'RedeemWithdrew'
}

export interface Type_457_FailedToContinue {
    __kind: 'FailedToContinue'
}
...
export type Type_359 = Type_359_WithdrawAsset | Type_359_ReserveAssetDeposit | Type_359_TeleportAsset | Type_359_QueryResponse | Type_359_TransferAsset | Type_359_TransferReserveAsset | Type_359_Transact | Type_359_HrmpNewChannelOpenRequest | Type_359_HrmpChannelAccepted | Type_359_HrmpChannelClosing | Type_359_RelayedFrom
...
export interface Type_359_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_361[]
}

export interface Type_359_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_361[]
}
...
export interface Type_359_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_359
}

export type Type_364 = Type_364_WithdrawAsset | Type_364_ReserveAssetDeposited | Type_364_ReceiveTeleportedAsset | Type_364_QueryResponse | Type_364_TransferAsset | Type_364_TransferReserveAsset | Type_364_Transact | Type_364_HrmpNewChannelOpenRequest | Type_364_HrmpChannelAccepted | Type_364_HrmpChannelClosing | Type_364_RelayedFrom | Type_364_SubscribeVersion | Type_364_UnsubscribeVersion
...
export interface Type_364_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_364
}
...
export type Type_361 = Type_361_Null | Type_361_DepositAsset | Type_361_DepositReserveAsset | Type_361_ExchangeAsset | Type_361_InitiateReserveWithdraw | Type_361_InitiateTeleport | Type_361_QueryHolding | Type_361_BuyExecution

export interface Type_361_Null {
    __kind: 'Null'
}
...
export interface Type_361_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Type_366 = Type_366_Noop | Type_366_DepositAsset | Type_366_DepositReserveAsset | Type_366_ExchangeAsset | Type_366_InitiateReserveWithdraw | Type_366_InitiateTeleport | Type_366_QueryHolding | Type_366_BuyExecution

export interface Type_366_Noop {
    __kind: 'Noop'
}

export interface Type_366_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_366_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_366_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_366_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_366_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_366_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_366_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_364[]
}
