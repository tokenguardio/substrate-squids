...
export type Call = Call_System | Call_Utility | Call_Identity | Call_Timestamp | Call_Multisig | Call_ParachainSystem | Call_ParachainInfo | Call_Balances | Call_Vesting | Call_DappsStaking | Call_BlockReward | Call_Assets | Call_Authorship | Call_CollatorSelection | Call_Session | Call_XcmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_DmpQueue | Call_XcAssetConfig | Call_EVM | Call_Ethereum | Call_EthCall | Call_BaseFee | Call_Contracts | Call_Sudo
