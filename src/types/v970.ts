...
export type Type_347 = Type_347_Member | Type_347_Members | Type_347__Phantom

export interface Type_347_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_347_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_347__Phantom {
    __kind: '_Phantom'
}
...
export type Type_349 = Type_349_Relay | Type_349_SiblingParachain

export interface Type_349_Relay {
    __kind: 'Relay'
}

export interface Type_349_SiblingParachain {
...
export type Type_346 = Type_346_Member | Type_346_Members | Type_346__Phantom

export interface Type_346_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_346_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_346__Phantom {
    __kind: '_Phantom'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SalpCall = SalpCall_batch_unlock | SalpCall_buyback | SalpCall_confirm_contribute | SalpCall_continue_fund | SalpCall_contribute | SalpCall_create | SalpCall_dissolve | SalpCall_dissolve_refunded | SalpCall_edit | SalpCall_fund_end | SalpCall_fund_fail | SalpCall_fund_retire | SalpCall_fund_success | SalpCall_redeem | SalpCall_refund | SalpCall_set_multisig_confirm_account | SalpCall_unlock | SalpCall_unlock_by_vsbond | SalpCall_unlock_vstoken | SalpCall_withdraw
...
export type Type_328 = Type_328_V0 | Type_328_V1 | Type_328_V2

export interface Type_328_V0 {
    __kind: 'V0'
    value: Type_329
}

export interface Type_328_V1 {
    __kind: 'V1'
    value: Type_334
}

export interface Type_328_V2 {
    __kind: 'V2'
    value: Type_340[]
}
...
export interface Type_333 {
    encoded: Bytes
}

export type Type_334 = Type_334_HrmpChannelAccepted | Type_334_HrmpChannelClosing | Type_334_HrmpNewChannelOpenRequest | Type_334_QueryResponse | Type_334_ReceiveTeleportedAsset | Type_334_RelayedFrom | Type_334_ReserveAssetDeposited | Type_334_SubscribeVersion | Type_334_Transact | Type_334_TransferAsset | Type_334_TransferReserveAsset | Type_334_UnsubscribeVersion | Type_334_WithdrawAsset
...
export type Type_336 = Type_336_BuyExecution | Type_336_DepositAsset | Type_336_DepositReserveAsset | Type_336_ExchangeAsset | Type_336_InitiateReserveWithdraw | Type_336_InitiateTeleport | Type_336_Noop | Type_336_QueryHolding
...
export interface Type_336_Noop {
    __kind: 'Noop'
}
...
export type Type_329 = Type_329_HrmpChannelAccepted | Type_329_HrmpChannelClosing | Type_329_HrmpNewChannelOpenRequest | Type_329_QueryResponse | Type_329_RelayedFrom | Type_329_ReserveAssetDeposit | Type_329_TeleportAsset | Type_329_Transact | Type_329_TransferAsset | Type_329_TransferReserveAsset | Type_329_WithdrawAsset
...
export interface Type_329_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_329
}

export interface Type_329_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_331[]
}

export interface Type_329_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_331[]
}
...
export type Type_331 = Type_331_BuyExecution | Type_331_DepositAsset | Type_331_DepositReserveAsset | Type_331_ExchangeAsset | Type_331_InitiateReserveWithdraw | Type_331_InitiateTeleport | Type_331_Null | Type_331_QueryHolding

export interface Type_331_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export interface Type_331_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_331_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_331_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_331_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_331_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_331_Null {
    __kind: 'Null'
}

export interface Type_331_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Call = Call_AssetRegistry | Call_Authorship | Call_Balances | Call_Bounties | Call_CallSwitchgear | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FeeShare | Call_FlexibleFee | Call_Identity | Call_Indices | Call_MerkleDistributor | Call_Multisig | Call_OrmlXcm | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_Utility | Call_VeMinting | Call_Vesting | Call_VtokenMinting | Call_XTokens | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
...
export const Type_333: sts.Type<Type_333> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_336: sts.Type<Type_336> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_334),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
