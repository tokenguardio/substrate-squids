...
export type Call = Call_System | Call_ParachainSystem | Call_Timestamp | Call_Balances | Call_Sudo | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_Scheduler | Call_Preimage | Call_Multisig | Call_Treasury | Call_Bounties | Call_ChildBounties | Call_Authorship | Call_Session | Call_ParachainStaking | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_Vesting | Call_Utility | Call_Currencies | Call_Tokens | Call_XTokens | Call_Identity | Call_Contracts | Call_DiaOracleModule | Call_ZenlinkProtocol | Call_VestingManager
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DiaOracleModuleCall = DiaOracleModuleCall_add_currency | DiaOracleModuleCall_remove_currency | DiaOracleModuleCall_authorize_account | DiaOracleModuleCall_deauthorize_account | DiaOracleModuleCall_set_updated_coin_infos | DiaOracleModuleCall_set_batching_api
...
export interface DiaOracleModuleCall_set_updated_coin_infos {
    ...
    coinInfos: [[Uint8Array, Uint8Array], CoinInfo][]
}
...
export type Type_244 = Type_244_Members | Type_244_Member | Type_244__Phantom
...
export type Type_247 = Type_247_Relay | Type_247_SiblingParachain

export interface Type_247_Relay {
    __kind: 'Relay'
}

export interface Type_247_SiblingParachain {
...
export type Type_224 = Type_224_V0 | Type_224_V1 | Type_224_V2

export interface Type_224_V0 {
    __kind: 'V0'
    value: Type_225
}

export interface Type_224_V1 {
    __kind: 'V1'
    value: Type_230
}

export interface Type_224_V2 {
    __kind: 'V2'
    value: Type_236[]
}
...
export type Type_225 = Type_225_WithdrawAsset | Type_225_ReserveAssetDeposit | Type_225_TeleportAsset | Type_225_QueryResponse | Type_225_TransferAsset | Type_225_TransferReserveAsset | Type_225_Transact | Type_225_HrmpNewChannelOpenRequest | Type_225_HrmpChannelAccepted | Type_225_HrmpChannelClosing | Type_225_RelayedFrom
...
export interface Type_225_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_227[]
}

export interface Type_225_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_227[]
}
...
export interface Type_225_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_225
}

export type Type_230 = Type_230_WithdrawAsset | Type_230_ReserveAssetDeposited | Type_230_ReceiveTeleportedAsset | Type_230_QueryResponse | Type_230_TransferAsset | Type_230_TransferReserveAsset | Type_230_Transact | Type_230_HrmpNewChannelOpenRequest | Type_230_HrmpChannelAccepted | Type_230_HrmpChannelClosing | Type_230_RelayedFrom | Type_230_SubscribeVersion | Type_230_UnsubscribeVersion

export interface Type_230_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V1MultiAsset[]
    effects: Type_232[]
}

export interface Type_230_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_232[]
}

export interface Type_230_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_232[]
}

export interface Type_230_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V1Response
}

export interface Type_230_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_230_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_230_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_230_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_230_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_230_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_230_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_230
}

export interface Type_230_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_230_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_236 = Type_236_WithdrawAsset | Type_236_ReserveAssetDeposited | Type_236_ReceiveTeleportedAsset | Type_236_QueryResponse | Type_236_TransferAsset | Type_236_TransferReserveAsset | Type_236_Transact | Type_236_HrmpNewChannelOpenRequest | Type_236_HrmpChannelAccepted | Type_236_HrmpChannelClosing | Type_236_ClearOrigin | Type_236_DescendOrigin | Type_236_ReportError | Type_236_DepositAsset | Type_236_DepositReserveAsset | Type_236_ExchangeAsset | Type_236_InitiateReserveWithdraw | Type_236_InitiateTeleport | Type_236_QueryHolding | Type_236_BuyExecution | Type_236_RefundSurplus | Type_236_SetErrorHandler | Type_236_SetAppendix | Type_236_ClearError | Type_236_ClaimAsset | Type_236_Trap | Type_236_SubscribeVersion | Type_236_UnsubscribeVersion
...
export interface Type_236_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_236_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_236_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_236_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_236_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_236[]
}

export interface Type_236_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_236[]
}

export interface Type_236_ClearError {
    __kind: 'ClearError'
}

export interface Type_236_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_236_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_227 = Type_227_Null | Type_227_DepositAsset | Type_227_DepositReserveAsset | Type_227_ExchangeAsset | Type_227_InitiateReserveWithdraw | Type_227_InitiateTeleport | Type_227_QueryHolding | Type_227_BuyExecution

export interface Type_227_Null {
    __kind: 'Null'
}

export interface Type_227_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_227_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_227_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_227_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_227_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_227_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export interface Type_227_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export type Type_232 = Type_232_Noop | Type_232_DepositAsset | Type_232_DepositReserveAsset | Type_232_ExchangeAsset | Type_232_InitiateReserveWithdraw | Type_232_InitiateTeleport | Type_232_QueryHolding | Type_232_BuyExecution
