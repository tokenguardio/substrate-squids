...
export type Call = Call_System | Call_Utility | Call_Identity | Call_Timestamp | Call_Multisig | Call_ParachainSystem | Call_Balances | Call_Vesting | Call_Authorship | Call_CollatorSelection | Call_Session | Call_EVM | Call_Ethereum | Call_EthCall | Call_Sudo
