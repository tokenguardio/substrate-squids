...
export type Type_168 = Type_168_EthereumTransaction

export interface Type_168_EthereumTransaction {
...
export type Call = Call_Authorship | Call_Balances | Call_CollatorSelection | Call_EVM | Call_EthCall | Call_Ethereum | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting
