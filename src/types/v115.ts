...
export const Type_271: sts.Type<Type_271> = sts.closedEnum(() => {
    return  {
        V0: Type_272,
        V1: Type_277,
        V2: sts.array(() => Type_283),
    }
})

export const Type_283: sts.Type<Type_283> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_283),
        SetErrorHandler: sts.array(() => Type_283),
...
export type Type_283 = Type_283_BuyExecution | Type_283_ClaimAsset | Type_283_ClearError | Type_283_ClearOrigin | Type_283_DepositAsset | Type_283_DepositReserveAsset | Type_283_DescendOrigin | Type_283_ExchangeAsset | Type_283_HrmpChannelAccepted | Type_283_HrmpChannelClosing | Type_283_HrmpNewChannelOpenRequest | Type_283_InitiateReserveWithdraw | Type_283_InitiateTeleport | Type_283_QueryHolding | Type_283_QueryResponse | Type_283_ReceiveTeleportedAsset | Type_283_RefundSurplus | Type_283_ReportError | Type_283_ReserveAssetDeposited | Type_283_SetAppendix | Type_283_SetErrorHandler | Type_283_SubscribeVersion | Type_283_Transact | Type_283_TransferAsset | Type_283_TransferReserveAsset | Type_283_Trap | Type_283_UnsubscribeVersion | Type_283_WithdrawAsset

export interface Type_283_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_283_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_283_ClearError {
    __kind: 'ClearError'
}

export interface Type_283_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_283_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_283_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_283_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_283_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_283_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_283_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_283_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_283_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_283_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_283_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_283_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_283_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_283_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_283_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_283_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_283_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_283[]
}

export interface Type_283_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_283[]
}

export interface Type_283_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_283_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_276
...
export interface Type_283_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_283_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_283_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_283_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_283_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V1MultiAsset[]
}
...
export const Type_279: sts.Type<Type_279> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_277),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_279 = Type_279_BuyExecution | Type_279_DepositAsset | Type_279_DepositReserveAsset | Type_279_ExchangeAsset | Type_279_InitiateReserveWithdraw | Type_279_InitiateTeleport | Type_279_Noop | Type_279_QueryHolding

export interface Type_279_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_277[]
}

export interface Type_279_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_279_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_279_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_279_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_279_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_279_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_277 = Type_277_HrmpChannelAccepted | Type_277_HrmpChannelClosing | Type_277_HrmpNewChannelOpenRequest | Type_277_QueryResponse | Type_277_ReceiveTeleportedAsset | Type_277_RelayedFrom | Type_277_ReserveAssetDeposited | Type_277_SubscribeVersion | Type_277_Transact | Type_277_TransferAsset | Type_277_TransferReserveAsset | Type_277_UnsubscribeVersion | Type_277_WithdrawAsset
...
export interface Type_277_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_277
}
...
export type Type_274 = Type_274_BuyExecution | Type_274_DepositAsset | Type_274_DepositReserveAsset | Type_274_ExchangeAsset | Type_274_InitiateReserveWithdraw | Type_274_InitiateTeleport | Type_274_Null | Type_274_QueryHolding
...
export interface Type_274_Null {
    __kind: 'Null'
}
...
export type Type_272 = Type_272_HrmpChannelAccepted | Type_272_HrmpChannelClosing | Type_272_HrmpNewChannelOpenRequest | Type_272_QueryResponse | Type_272_RelayedFrom | Type_272_ReserveAssetDeposit | Type_272_TeleportAsset | Type_272_Transact | Type_272_TransferAsset | Type_272_TransferReserveAsset | Type_272_WithdrawAsset
...
export interface Type_272_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_274[]
}

export interface Type_272_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_274[]
}
...
export type Type_271 = Type_271_V0 | Type_271_V1 | Type_271_V2

export interface Type_271_V0 {
    __kind: 'V0'
    value: Type_272
}

export interface Type_271_V1 {
    __kind: 'V1'
    value: Type_277
}

export interface Type_271_V2 {
    __kind: 'V2'
    value: Type_283[]
}
...
export type Call = Call_AssetRegistry | Call_Authorship | Call_Balances | Call_Claims | Call_CollatorSelection | Call_Council | Call_CumulusXcm | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Elections | Call_GenesisHistory | Call_Identity | Call_MultiTransactionPayment | Call_Multisig | Call_Omnipool | Call_OrmlXcm | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_RelayChainInfo | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Tips | Call_Tokens | Call_TransactionPause | Call_Treasury | Call_Uniques | Call_UnknownTokens | Call_Utility | Call_Vesting | Call_XTokens
...
export type Type_173 = Type_173_Member | Type_173_Members | Type_173__Phantom

export interface Type_173_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_173_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_173__Phantom {
    __kind: '_Phantom'
}
...
export type Type_175 = Type_175_Relay | Type_175_SiblingParachain

export interface Type_175_Relay {
    __kind: 'Relay'
}

export interface Type_175_SiblingParachain {
