...
export type Call = Call_System | Call_Timestamp | Call_Scheduler | Call_Preimage | Call_Balances | Call_Treasury | Call_Vesting | Call_MultiSig | Call_Bounties | Call_Democracy | Call_AdvisoryCommittee | Call_AdvisoryCommitteeMembership | Call_Council | Call_CouncilMembership | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Identity | Call_Utility | Call_Proxy | Call_AssetManager | Call_Authorized | Call_Court | Call_LiquidityMining | Call_Swaps | Call_PredictionMarkets | Call_Styx | Call_ParachainSystem | Call_ParachainStaking | Call_AuthorInherent | Call_AuthorFilter | Call_AuthorMapping | Call_DmpQueue | Call_PolkadotXcm | Call_XcmpQueue | Call_AssetRegistry | Call_XTokens | Call_Crowdloan | Call_GlobalDisputes | Call_Sudo
...
export type Type_324 = Type_324_V0 | Type_324_V1 | Type_324_V2

export interface Type_324_V0 {
    __kind: 'V0'
    value: Type_325
}

export interface Type_324_V1 {
    __kind: 'V1'
    value: Type_330
}

export interface Type_324_V2 {
    __kind: 'V2'
    value: Type_336[]
}
...
export type ProxyType = ProxyType_Any | ProxyType_CancelProxy | ProxyType_Governance | ProxyType_Staking
...
export type OriginCaller = OriginCaller_system | OriginCaller_AdvisoryCommittee | OriginCaller_Council | OriginCaller_TechnicalCommittee | OriginCaller_CumulusXcm | OriginCaller_PolkadotXcm | OriginCaller_Void
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AdvisoryCommitteeCall = AdvisoryCommitteeCall_set_members | AdvisoryCommitteeCall_execute | AdvisoryCommitteeCall_propose | AdvisoryCommitteeCall_vote | AdvisoryCommitteeCall_close | AdvisoryCommitteeCall_disapprove_proposal
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PredictionMarketsCall = PredictionMarketsCall_admin_destroy_market | PredictionMarketsCall_admin_move_market_to_closed | PredictionMarketsCall_admin_move_market_to_resolved | PredictionMarketsCall_approve_market | PredictionMarketsCall_request_edit | PredictionMarketsCall_buy_complete_set | PredictionMarketsCall_dispute | PredictionMarketsCall_create_cpmm_market_and_deploy_assets | PredictionMarketsCall_create_market | PredictionMarketsCall_edit_market | PredictionMarketsCall_deploy_swap_pool_and_additional_liquidity | PredictionMarketsCall_deploy_swap_pool_for_market | PredictionMarketsCall_redeem_shares | PredictionMarketsCall_reject_market | PredictionMarketsCall_report | PredictionMarketsCall_sell_complete_set | PredictionMarketsCall_start_global_dispute
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type GlobalDisputesCall = GlobalDisputesCall_add_vote_outcome | GlobalDisputesCall_purge_outcomes | GlobalDisputesCall_reward_outcome_owner | GlobalDisputesCall_vote_on_outcome | GlobalDisputesCall_unlock_vote_balance
...
export interface Type_325_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_327[]
}

export interface Type_325_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_327[]
}

export interface Type_325_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_325_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_325_TransferReserveAsset {
...
export interface Type_325_Transact {
    __kind: 'Transact'
...
export interface Type_325_HrmpNewChannelOpenRequest {
...
export interface Type_325_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_325_HrmpChannelClosing {
...
export interface Type_325_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_325
}

export type Type_330 = Type_330_WithdrawAsset | Type_330_ReserveAssetDeposited | Type_330_ReceiveTeleportedAsset | Type_330_QueryResponse | Type_330_TransferAsset | Type_330_TransferReserveAsset | Type_330_Transact | Type_330_HrmpNewChannelOpenRequest | Type_330_HrmpChannelAccepted | Type_330_HrmpChannelClosing | Type_330_RelayedFrom | Type_330_SubscribeVersion | Type_330_UnsubscribeVersion
...
export interface Type_330_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_332[]
}

export interface Type_330_ReceiveTeleportedAsset {
...
export interface Type_330_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_330_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_336 = Type_336_WithdrawAsset | Type_336_ReserveAssetDeposited | Type_336_ReceiveTeleportedAsset | Type_336_QueryResponse | Type_336_TransferAsset | Type_336_TransferReserveAsset | Type_336_Transact | Type_336_HrmpNewChannelOpenRequest | Type_336_HrmpChannelAccepted | Type_336_HrmpChannelClosing | Type_336_ClearOrigin | Type_336_DescendOrigin | Type_336_ReportError | Type_336_DepositAsset | Type_336_DepositReserveAsset | Type_336_ExchangeAsset | Type_336_InitiateReserveWithdraw | Type_336_InitiateTeleport | Type_336_QueryHolding | Type_336_BuyExecution | Type_336_RefundSurplus | Type_336_SetErrorHandler | Type_336_SetAppendix | Type_336_ClearError | Type_336_ClaimAsset | Type_336_Trap | Type_336_SubscribeVersion | Type_336_UnsubscribeVersion

export interface Type_336_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V1MultiAsset[]
}

export interface Type_336_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_336_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_336_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_336_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_336_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_336_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_336_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_336_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_336_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_336_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_336_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_336_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_336_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_336_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_336[]
}

export interface Type_336_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_336[]
}

export interface Type_336_ClearError {
    __kind: 'ClearError'
}

export interface Type_336_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_336_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_336_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_336_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_274 = Type_274_Members | Type_274_Member | Type_274__Phantom
...
export type Type_275 = Type_275_Members | Type_275_Member | Type_275__Phantom
...
export type Type_276 = Type_276_Members | Type_276_Member | Type_276__Phantom
...
export type Type_278 = Type_278_Xcm | Type_278_Response

export interface Type_278_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}

export interface Type_278_Response {
    __kind: 'Response'
    value: V1MultiLocation
}
...
export type Type_332 = Type_332_Noop | Type_332_DepositAsset | Type_332_DepositReserveAsset | Type_332_ExchangeAsset | Type_332_InitiateReserveWithdraw | Type_332_InitiateTeleport | Type_332_QueryHolding | Type_332_BuyExecution

export interface Type_332_Noop {
    __kind: 'Noop'
}
