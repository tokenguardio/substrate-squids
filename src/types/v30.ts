...
export type Call = Call_System | Call_Scheduler | Call_Timestamp | Call_Balances | Call_Authorship | Call_Staking | Call_Session | Call_Aleph | Call_Elections | Call_Treasury | Call_Vesting | Call_Utility | Call_Multisig | Call_Sudo | Call_Contracts | Call_NominationPools | Call_Identity
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_108
    maxValidatorCount: Type_108
    chillThreshold: Type_109
    minCommission: Type_110
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AlephCall = AlephCall_set_emergency_finalizer
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ElectionsCall = ElectionsCall_change_validators
...
export type Type_108 = Type_108_Noop | Type_108_Set | Type_108_Remove

export interface Type_108_Noop {
    __kind: 'Noop'
}

export interface Type_108_Set {
    __kind: 'Set'
    value: number
}

export interface Type_108_Remove {
    __kind: 'Remove'
}

export type Type_109 = Type_109_Noop | Type_109_Set | Type_109_Remove

export interface Type_109_Noop {
    __kind: 'Noop'
}

export interface Type_109_Set {
    __kind: 'Set'
    value: number
}

export interface Type_109_Remove {
    __kind: 'Remove'
}

export type Type_110 = Type_110_Noop | Type_110_Set | Type_110_Remove

export interface Type_110_Noop {
    __kind: 'Noop'
}

export interface Type_110_Set {
    __kind: 'Set'
    value: number
}

export interface Type_110_Remove {
    __kind: 'Remove'
}
