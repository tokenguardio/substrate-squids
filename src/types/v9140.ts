...
export const Type_408: sts.Type<Type_408> = sts.closedEnum(() => {
    return  {
        V0: Type_409,
        V1: Type_414,
        V2: sts.array(() => Type_420),
    }
})
...
export const Type_420: sts.Type<Type_420> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_420),
        SetErrorHandler: sts.array(() => Type_420),
...
export const Type_413: sts.Type<Type_413> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_413 {
    encoded: Bytes
}
...
export type Type_420 = Type_420_BuyExecution | Type_420_ClaimAsset | Type_420_ClearError | Type_420_ClearOrigin | Type_420_DepositAsset | Type_420_DepositReserveAsset | Type_420_DescendOrigin | Type_420_ExchangeAsset | Type_420_HrmpChannelAccepted | Type_420_HrmpChannelClosing | Type_420_HrmpNewChannelOpenRequest | Type_420_InitiateReserveWithdraw | Type_420_InitiateTeleport | Type_420_QueryHolding | Type_420_QueryResponse | Type_420_ReceiveTeleportedAsset | Type_420_RefundSurplus | Type_420_ReportError | Type_420_ReserveAssetDeposited | Type_420_SetAppendix | Type_420_SetErrorHandler | Type_420_SubscribeVersion | Type_420_Transact | Type_420_TransferAsset | Type_420_TransferReserveAsset | Type_420_Trap | Type_420_UnsubscribeVersion | Type_420_WithdrawAsset

export interface Type_420_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_420_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_420_ClearError {
    __kind: 'ClearError'
}

export interface Type_420_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_420_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_420_DepositReserveAsset {
...
export interface Type_420_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_420_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_420_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_420_HrmpChannelClosing {
...
export interface Type_420_HrmpNewChannelOpenRequest {
...
export interface Type_420_InitiateReserveWithdraw {
...
export interface Type_420_InitiateTeleport {
...
export interface Type_420_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_420_QueryResponse {
...
export interface Type_420_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_420_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_420_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_420_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_420_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_420[]
}

export interface Type_420_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_420[]
}

export interface Type_420_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_420_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
...
export interface Type_420_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_420_TransferReserveAsset {
...
export interface Type_420_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_420_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_420_WithdrawAsset {
...
export const Type_416: sts.Type<Type_416> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_414),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_416 = Type_416_BuyExecution | Type_416_DepositAsset | Type_416_DepositReserveAsset | Type_416_ExchangeAsset | Type_416_InitiateReserveWithdraw | Type_416_InitiateTeleport | Type_416_Noop | Type_416_QueryHolding

export interface Type_416_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_414[]
}

export interface Type_416_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_416_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_416_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_416_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_416_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_416_Noop {
    __kind: 'Noop'
}

export interface Type_416_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_414 = Type_414_HrmpChannelAccepted | Type_414_HrmpChannelClosing | Type_414_HrmpNewChannelOpenRequest | Type_414_QueryResponse | Type_414_ReceiveTeleportedAsset | Type_414_RelayedFrom | Type_414_ReserveAssetDeposited | Type_414_SubscribeVersion | Type_414_Transact | Type_414_TransferAsset | Type_414_TransferReserveAsset | Type_414_UnsubscribeVersion | Type_414_WithdrawAsset
...
export interface Type_414_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_414
}
...
export type Type_411 = Type_411_BuyExecution | Type_411_DepositAsset | Type_411_DepositReserveAsset | Type_411_ExchangeAsset | Type_411_InitiateReserveWithdraw | Type_411_InitiateTeleport | Type_411_Null | Type_411_QueryHolding
...
export interface Type_411_Null {
    __kind: 'Null'
}

export interface Type_411_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Type_409 = Type_409_HrmpChannelAccepted | Type_409_HrmpChannelClosing | Type_409_HrmpNewChannelOpenRequest | Type_409_QueryResponse | Type_409_RelayedFrom | Type_409_ReserveAssetDeposit | Type_409_TeleportAsset | Type_409_Transact | Type_409_TransferAsset | Type_409_TransferReserveAsset | Type_409_WithdrawAsset

export interface Type_409_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_409_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_409_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_409_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_409_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_409
}

export interface Type_409_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_411[]
}

export interface Type_409_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_411[]
}

export interface Type_409_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_413
...
export interface Type_409_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_409_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_409_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_411[]
}

export type Type_408 = Type_408_V0 | Type_408_V1 | Type_408_V2

export interface Type_408_V0 {
    __kind: 'V0'
    value: Type_409
}

export interface Type_408_V1 {
    __kind: 'V1'
    value: Type_414
}

export interface Type_408_V2 {
    __kind: 'V2'
    value: Type_420[]
}
...
export const V1InherentData: sts.Type<V1InherentData> = sts.struct(() => {
    return  {
        bitfields: sts.array(() => V1UncheckedSigned),
        backedCandidates: sts.array(() => V1BackedCandidate),
...
export const V1BackedCandidate: sts.Type<V1BackedCandidate> = sts.struct(() => {
    return  {
        candidate: V1CommittedCandidateReceipt,
        validityVotes: sts.array(() => V0ValidityAttestation),
...
export const V1CommittedCandidateReceipt: sts.Type<V1CommittedCandidateReceipt> = sts.struct(() => {
    return  {
...
export const V1CandidateCommitments: sts.Type<V1CandidateCommitments> = sts.struct(() => {
    return  {
...
export const V1UncheckedSigned: sts.Type<V1UncheckedSigned> = sts.struct(() => {
    return  {
        payload: V1AvailabilityBitfield,
        validatorIndex: V0ValidatorIndex,
        signature: sts.bytes(),
    }
})

export const V1AvailabilityBitfield = sts.bitseq()
...
export type V1AvailabilityBitfield = BitSequence
...
export type Type_240 = Type_240_Response | Type_240_Xcm

export interface Type_240_Response {
    __kind: 'Response'
    value: V1MultiLocation
}

export interface Type_240_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}
...
export type Type_238 = Type_238_Member | Type_238_Members | Type_238__Phantom
...
export const Type_237: sts.Type<Type_237> = sts.closedEnum(() => {
    return  {
        Member: AccountId32,
        Members: sts.tuple(() => [sts.number(), sts.number()]),
        _Phantom: sts.unit(),
...
export type Type_237 = Type_237_Member | Type_237_Members | Type_237__Phantom
...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_limits: sts.enumStruct({
...
export const SessionKeys: sts.Type<SessionKeys> = sts.struct(() => {
    return  {
        ...
        paraAssignment: V1Public,
        authorityDiscovery: sts.bytes(),
    }
})

export const V1Public = sts.bytes()
...
export const Type_198: sts.Type<Type_198> = sts.struct(() => {
    return  {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ElectionProviderMultiPhaseCall = ElectionProviderMultiPhaseCall_set_emergency_election_result | ElectionProviderMultiPhaseCall_set_minimum_untrusted_score | ElectionProviderMultiPhaseCall_submit | ElectionProviderMultiPhaseCall_submit_unsigned
...
export type Call = Call_Auctions | Call_Authorship | Call_Babe | Call_BagsList | Call_Balances | Call_Bounties | Call_Claims | Call_Configuration | Call_Council | Call_Crowdloan | Call_Democracy | Call_Dmp | Call_ElectionProviderMultiPhase | Call_Grandpa | Call_Hrmp | Call_Identity | Call_ImOnline | Call_Indices | Call_Initializer | Call_Multisig | Call_ParaInclusion | Call_ParaInherent | Call_Paras | Call_ParasShared | Call_PhragmenElection | Call_Proxy | Call_Registrar | Call_Scheduler | Call_Session | Call_Slots | Call_Staking | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_Treasury | Call_Ump | Call_Utility | Call_Vesting | Call_XcmPallet
