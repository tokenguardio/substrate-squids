...
export type Type_376 = Type_376_Split | Type_376_SplitAbstain | Type_376_Standard

export interface Type_376_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}

export interface Type_376_SplitAbstain {
    __kind: 'SplitAbstain'
    aye: bigint
    nay: bigint
    abstain: bigint
...
export interface Type_376_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}
...
export type Call = Call_AssetRegistry | Call_Balances | Call_CallSwitchgear | Call_ChannelCommission | Call_CloudsConvert | Call_CollatorSelection | Call_ConvictionVoting | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_CumulusXcm | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FeeShare | Call_FellowshipCollective | Call_FellowshipReferenda | Call_FlexibleFee | Call_Identity | Call_Indices | Call_LendMarket | Call_LeverageStaking | Call_MerkleDistributor | Call_MessageQueue | Call_Multisig | Call_Oracle | Call_OracleMembership | Call_OrmlXcm | Call_ParachainInfo | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Prices | Call_Proxy | Call_Referenda | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_Slpx | Call_StablePool | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_Utility | Call_VeMinting | Call_Vesting | Call_VtokenMinting | Call_VtokenVoting | Call_Whitelist | Call_XTokens | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
