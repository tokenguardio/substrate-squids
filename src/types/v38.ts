...
export type Call = Call_System | Call_Timestamp | Call_Scheduler | Call_Preimage | Call_Balances | Call_Treasury | Call_Vesting | Call_MultiSig | Call_Democracy | Call_AdvisoryCommittee | Call_AdvisoryCommitteeMembership | Call_Council | Call_CouncilMembership | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Identity | Call_Utility | Call_Proxy | Call_Currency | Call_Authorized | Call_Court | Call_LiquidityMining | Call_Swaps | Call_PredictionMarkets | Call_ParachainSystem | Call_ParachainStaking | Call_AuthorInherent | Call_AuthorFilter | Call_AuthorMapping | Call_DmpQueue | Call_PolkadotXcm | Call_XcmpQueue | Call_Crowdloan | Call_Sudo
...
export type Type_252 = Type_252_Members | Type_252_Member | Type_252__Phantom

export interface Type_252_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_252_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_252__Phantom {
    __kind: '_Phantom'
}
...
export type Type_256 = Type_256_Xcm | Type_256_Response

export interface Type_256_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}

export interface Type_256_Response {
    __kind: 'Response'
    value: V1MultiLocation
}
...
export type Type_301 = Type_301_V0 | Type_301_V1 | Type_301_V2

export interface Type_301_V0 {
    __kind: 'V0'
    value: Type_302
}

export interface Type_301_V1 {
    __kind: 'V1'
    value: Type_307
}

export interface Type_301_V2 {
    __kind: 'V2'
    value: Type_313[]
}
...
export type Type_302 = Type_302_WithdrawAsset | Type_302_ReserveAssetDeposit | Type_302_TeleportAsset | Type_302_QueryResponse | Type_302_TransferAsset | Type_302_TransferReserveAsset | Type_302_Transact | Type_302_HrmpNewChannelOpenRequest | Type_302_HrmpChannelAccepted | Type_302_HrmpChannelClosing | Type_302_RelayedFrom
...
export interface Type_302_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_304[]
}

export interface Type_302_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_304[]
}
...
export interface Type_307_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_307
}
...
export type Type_313 = Type_313_WithdrawAsset | Type_313_ReserveAssetDeposited | Type_313_ReceiveTeleportedAsset | Type_313_QueryResponse | Type_313_TransferAsset | Type_313_TransferReserveAsset | Type_313_Transact | Type_313_HrmpNewChannelOpenRequest | Type_313_HrmpChannelAccepted | Type_313_HrmpChannelClosing | Type_313_ClearOrigin | Type_313_DescendOrigin | Type_313_ReportError | Type_313_DepositAsset | Type_313_DepositReserveAsset | Type_313_ExchangeAsset | Type_313_InitiateReserveWithdraw | Type_313_InitiateTeleport | Type_313_QueryHolding | Type_313_BuyExecution | Type_313_RefundSurplus | Type_313_SetErrorHandler | Type_313_SetAppendix | Type_313_ClearError | Type_313_ClaimAsset | Type_313_Trap | Type_313_SubscribeVersion | Type_313_UnsubscribeVersion
...
export type Type_304 = Type_304_Null | Type_304_DepositAsset | Type_304_DepositReserveAsset | Type_304_ExchangeAsset | Type_304_InitiateReserveWithdraw | Type_304_InitiateTeleport | Type_304_QueryHolding | Type_304_BuyExecution

export interface Type_304_Null {
    __kind: 'Null'
}

export interface Type_304_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_304_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_304_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_304_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_304_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_304_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export interface Type_304_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export type Type_309 = Type_309_Noop | Type_309_DepositAsset | Type_309_DepositReserveAsset | Type_309_ExchangeAsset | Type_309_InitiateReserveWithdraw | Type_309_InitiateTeleport | Type_309_QueryHolding | Type_309_BuyExecution
