...
export type Proposal = Proposal_System | Proposal_Utility | Proposal_Timestamp | Proposal_Authorship | Proposal_Indices | Proposal_Balances | Proposal_Staking | Proposal_Session | Proposal_Democracy | Proposal_Council | Proposal_Elections | Proposal_FinalityTracker | Proposal_Grandpa | Proposal_Treasury | Proposal_Contracts | Proposal_Sudo | Proposal_ImOnline | Proposal_AuthorityDiscovery | Proposal_Offences | Proposal_RandomnessCollectiveFlip | Proposal_Identity | Proposal_Scheduler | Proposal_Recovery | Proposal_Vesting | Proposal_Proxy | Proposal_Multisig | Proposal_Signaling | Proposal_Voting | Proposal_TreasuryReward
