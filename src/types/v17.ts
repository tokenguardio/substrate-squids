...
export type Type_44 = Type_44_Attestations | Type_44_AuthorityDiscovery | Type_44_Authorship | Type_44_Babe | Type_44_Balances | Type_44_Claims | Type_44_Council | Type_44_Democracy | Type_44_ElectionsPhragmen | Type_44_FinalityTracker | Type_44_Grandpa | Type_44_Identity | Type_44_ImOnline | Type_44_Indices | Type_44_Multisig | Type_44_Offences | Type_44_Parachains | Type_44_Poll | Type_44_Proxy | Type_44_Purchase | Type_44_Registrar | Type_44_Scheduler | Type_44_Session | Type_44_Slots | Type_44_Staking | Type_44_System | Type_44_TechnicalCommittee | Type_44_TechnicalMembership | Type_44_Timestamp | Type_44_Treasury | Type_44_Utility | Type_44_Vesting
...
export interface Type_44_Proxy {
    __kind: 'Proxy'
    value: ProxyCall
}
...
export type PurchaseCall = PurchaseCall_create_account | PurchaseCall_payout | PurchaseCall_set_payment_account | PurchaseCall_set_statement | PurchaseCall_set_unlock_block | PurchaseCall_update_balance | PurchaseCall_update_validity_status
...
export interface PurchaseCall_update_balance {
    ...
    who: AccountId
    freeBalance: BalanceOf
    lockedBalance: BalanceOf
    vat: Permill
}
...
export type AccountValidity = AccountValidity_Completed | AccountValidity_Initiated | AccountValidity_Invalid | AccountValidity_Pending | AccountValidity_ValidHigh | AccountValidity_ValidLow
...
export type ProxyCall = ProxyCall_add_proxy | ProxyCall_anonymous | ProxyCall_kill_anonymous | ProxyCall_proxy | ProxyCall_remove_proxies | ProxyCall_remove_proxy
...
export type ParachainsCall = ParachainsCall_report_double_vote | ParachainsCall_send_xcmp_message | ParachainsCall_set_heads | ParachainsCall_transfer_to_parachain
...
export const PurchaseCall: sts.Type<PurchaseCall> = sts.closedEnum(() => {
    return  {
        create_account: sts.enumStruct({
            who: AccountId,
            signature: sts.bytes(),
        }),
        ...
        set_payment_account: sts.enumStruct({
            who: AccountId,
        }),
        set_statement: sts.enumStruct({
            statement: sts.bytes(),
        }),
        set_unlock_block: sts.enumStruct({
            unlockBlock: BlockNumber,
        }),
        ...
        update_validity_status: sts.enumStruct({
            who: AccountId,
            validity: AccountValidity,
        }),
    }
...
export const AccountValidity: sts.Type<AccountValidity> = sts.closedEnum(() => {
    return  {
        Completed: sts.unit(),
        Initiated: sts.unit(),
        Invalid: sts.unit(),
...
export const PollCall: sts.Type<PollCall> = sts.closedEnum(() => {
    return  {
        vote: sts.enumStruct({
            approvals: Approvals,
        }),
...
export const Approvals = sts.array(() => sts.boolean())
...
export const ParachainsCall: sts.Type<ParachainsCall> = sts.closedEnum(() => {
    return  {
        ...
        send_xcmp_message: sts.enumStruct({
            to: ParaId,
            msg: sts.bytes(),
        }),
