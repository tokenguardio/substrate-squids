...
export type Type_256 = Type_256_Response | Type_256_Xcm
...
export const Type_438: sts.Type<Type_438> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_438),
        SetErrorHandler: sts.array(() => Type_438),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_438 = Type_438_BuyExecution | Type_438_ClaimAsset | Type_438_ClearError | Type_438_ClearOrigin | Type_438_DepositAsset | Type_438_DepositReserveAsset | Type_438_DescendOrigin | Type_438_ExchangeAsset | Type_438_HrmpChannelAccepted | Type_438_HrmpChannelClosing | Type_438_HrmpNewChannelOpenRequest | Type_438_InitiateReserveWithdraw | Type_438_InitiateTeleport | Type_438_QueryHolding | Type_438_QueryResponse | Type_438_ReceiveTeleportedAsset | Type_438_RefundSurplus | Type_438_ReportError | Type_438_ReserveAssetDeposited | Type_438_SetAppendix | Type_438_SetErrorHandler | Type_438_SubscribeVersion | Type_438_Transact | Type_438_TransferAsset | Type_438_TransferReserveAsset | Type_438_Trap | Type_438_UnsubscribeVersion | Type_438_WithdrawAsset
...
export const Type_434: sts.Type<Type_434> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_432),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_434 = Type_434_BuyExecution | Type_434_DepositAsset | Type_434_DepositReserveAsset | Type_434_ExchangeAsset | Type_434_InitiateReserveWithdraw | Type_434_InitiateTeleport | Type_434_Noop | Type_434_QueryHolding
...
export type Type_432 = Type_432_HrmpChannelAccepted | Type_432_HrmpChannelClosing | Type_432_HrmpNewChannelOpenRequest | Type_432_QueryResponse | Type_432_ReceiveTeleportedAsset | Type_432_RelayedFrom | Type_432_ReserveAssetDeposited | Type_432_SubscribeVersion | Type_432_Transact | Type_432_TransferAsset | Type_432_TransferReserveAsset | Type_432_UnsubscribeVersion | Type_432_WithdrawAsset
...
export type Type_429 = Type_429_BuyExecution | Type_429_DepositAsset | Type_429_DepositReserveAsset | Type_429_ExchangeAsset | Type_429_InitiateReserveWithdraw | Type_429_InitiateTeleport | Type_429_Null | Type_429_QueryHolding
...
export type Type_427 = Type_427_HrmpChannelAccepted | Type_427_HrmpChannelClosing | Type_427_HrmpNewChannelOpenRequest | Type_427_QueryResponse | Type_427_RelayedFrom | Type_427_ReserveAssetDeposit | Type_427_TeleportAsset | Type_427_Transact | Type_427_TransferAsset | Type_427_TransferReserveAsset | Type_427_WithdrawAsset
...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_configs: sts.enumStruct({
            ...
            maxNominatorCount: Type_204,
            maxValidatorCount: Type_204,
            chillThreshold: Type_205,
            minCommission: Type_206,
        }),
...
export type Type_204 = Type_204_Noop | Type_204_Remove | Type_204_Set

export interface Type_204_Noop {
    __kind: 'Noop'
}

export interface Type_204_Remove {
    __kind: 'Remove'
}

export interface Type_204_Set {
    __kind: 'Set'
    value: number
}
...
export const Type_215: sts.Type<Type_215> = sts.struct(() => {
    return  {
...
export type Call = Call_Auctions | Call_Authorship | Call_Babe | Call_Balances | Call_Bounties | Call_ChildBounties | Call_Claims | Call_Configuration | Call_Council | Call_Crowdloan | Call_Democracy | Call_Dmp | Call_ElectionProviderMultiPhase | Call_Grandpa | Call_Hrmp | Call_Identity | Call_ImOnline | Call_Indices | Call_Initializer | Call_Multisig | Call_ParaInclusion | Call_ParaInherent | Call_Paras | Call_ParasDisputes | Call_ParasShared | Call_PhragmenElection | Call_Preimage | Call_Proxy | Call_Registrar | Call_Scheduler | Call_Session | Call_Slots | Call_Staking | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_Treasury | Call_Ump | Call_Utility | Call_Vesting | Call_VoterList | Call_XcmPallet
