...
export type Proposal = Proposal_System | Proposal_Utility | Proposal_Timestamp | Proposal_Authorship | Proposal_Indices | Proposal_Balances | Proposal_Staking | Proposal_Session | Proposal_Democracy | Proposal_Council | Proposal_Elections | Proposal_FinalityTracker | Proposal_Grandpa | Proposal_Treasury | Proposal_Contracts | Proposal_Sudo | Proposal_ImOnline | Proposal_AuthorityDiscovery | Proposal_Offences | Proposal_RandomnessCollectiveFlip | Proposal_Identity | Proposal_Recovery | Proposal_Vesting | Proposal_Scheduler | Proposal_Proxy | Proposal_Multisig | Proposal_Assets | Proposal_Signaling | Proposal_Voting | Proposal_TreasuryReward
...
export type Type_43 = Type_43_System | Type_43_Utility | Type_43_Timestamp | Type_43_Authorship | Type_43_Indices | Type_43_Balances | Type_43_Staking | Type_43_Session | Type_43_Democracy | Type_43_Council | Type_43_Elections | Type_43_FinalityTracker | Type_43_Grandpa | Type_43_Treasury | Type_43_Contracts | Type_43_Sudo | Type_43_ImOnline | Type_43_AuthorityDiscovery | Type_43_Offences | Type_43_RandomnessCollectiveFlip | Type_43_Identity | Type_43_Recovery | Type_43_Vesting | Type_43_Scheduler | Type_43_Proxy | Type_43_Multisig | Type_43_Assets | Type_43_Signaling | Type_43_Voting | Type_43_TreasuryReward
...
export interface Type_43_Indices {
    __kind: 'Indices'
    value: IndicesCall
}
...
export interface Type_43_Elections {
    __kind: 'Elections'
    value: ElectionsCall
}

export interface Type_43_FinalityTracker {
    __kind: 'FinalityTracker'
    value: FinalityTrackerCall
}
...
export interface Type_43_Treasury {
    __kind: 'Treasury'
    value: TreasuryCall
}

export interface Type_43_Contracts {
    __kind: 'Contracts'
    value: ContractsCall
}
...
export interface Type_43_AuthorityDiscovery {
    __kind: 'AuthorityDiscovery'
    value: AuthorityDiscoveryCall
}
...
export interface Type_43_Recovery {
    __kind: 'Recovery'
    value: RecoveryCall
}

export interface Type_43_Vesting {
    __kind: 'Vesting'
    value: VestingCall
}
...
export interface Type_43_Proxy {
    __kind: 'Proxy'
    value: ProxyCall
}
...
export interface Type_43_Signaling {
    __kind: 'Signaling'
    value: SignalingCall
}

export interface Type_43_Voting {
    __kind: 'Voting'
    value: VotingCall
}

export interface Type_43_TreasuryReward {
    __kind: 'TreasuryReward'
    value: TreasuryRewardCall
}
...
export type SystemCall = SystemCall_fill_block | SystemCall_remark | SystemCall_set_heap_pages | SystemCall_set_code | SystemCall_set_code_without_checks | SystemCall_set_changes_trie_config | SystemCall_set_storage | SystemCall_kill_storage | SystemCall_kill_prefix | SystemCall_suicide | SystemCall_migrate_accounts
...
export interface SystemCall_migrate_accounts {
    __kind: 'migrate_accounts'
    accounts: Uint8Array[]
}
...
export type AssetsCall = AssetsCall_issue | AssetsCall_transfer | AssetsCall_destroy
 ...
 *  # </weight>
 */
export interface AssetsCall_issue {
    __kind: 'issue'
    total: bigint
}
