...
export type Type_175 = Type_175_Response | Type_175_Xcm
...
export const Type_452: sts.Type<Type_452> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_455),
        V3: sts.array(() => Type_459),
        V4: sts.array(() => Type_462),
    }
})
...
export const Type_462: sts.Type<Type_462> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V4Asset),
        SetAppendix: sts.array(() => Type_462),
        SetErrorHandler: sts.array(() => Type_462),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_462 = Type_462_AliasOrigin | Type_462_BurnAsset | Type_462_BuyExecution | Type_462_ClaimAsset | Type_462_ClearError | Type_462_ClearOrigin | Type_462_ClearTopic | Type_462_ClearTransactStatus | Type_462_DepositAsset | Type_462_DepositReserveAsset | Type_462_DescendOrigin | Type_462_ExchangeAsset | Type_462_ExpectAsset | Type_462_ExpectError | Type_462_ExpectOrigin | Type_462_ExpectPallet | Type_462_ExpectTransactStatus | Type_462_ExportMessage | Type_462_HrmpChannelAccepted | Type_462_HrmpChannelClosing | Type_462_HrmpNewChannelOpenRequest | Type_462_InitiateReserveWithdraw | Type_462_InitiateTeleport | Type_462_LockAsset | Type_462_NoteUnlockable | Type_462_QueryPallet | Type_462_QueryResponse | Type_462_ReceiveTeleportedAsset | Type_462_RefundSurplus | Type_462_ReportError | Type_462_ReportHolding | Type_462_ReportTransactStatus | Type_462_RequestUnlock | Type_462_ReserveAssetDeposited | Type_462_SetAppendix | Type_462_SetErrorHandler | Type_462_SetFeesMode | Type_462_SetTopic | Type_462_SubscribeVersion | Type_462_Transact | Type_462_TransferAsset | Type_462_TransferReserveAsset | Type_462_Trap | Type_462_UniversalOrigin | Type_462_UnlockAsset | Type_462_UnpaidExecution | Type_462_UnsubscribeVersion | Type_462_WithdrawAsset

export interface Type_462_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_462_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}

export interface Type_462_BuyExecution {
    __kind: 'BuyExecution'
    fees: V4Asset
    weightLimit: V3WeightLimit
}

export interface Type_462_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_462_ClearError {
    __kind: 'ClearError'
}

export interface Type_462_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_462_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_462_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_462_DepositAsset {
    __kind: 'DepositAsset'
    assets: V4AssetFilter
    beneficiary: V4Location
}

export interface Type_462_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_462_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V4Junctions
}

export interface Type_462_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V4AssetFilter
    want: V4Asset[]
    maximal: boolean
...
export interface Type_462_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_462_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_462_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V4Location | undefined)
}

export interface Type_462_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_462_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_462_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_462_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_462_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_462_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_462_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V4AssetFilter
    reserve: V4Location
    xcm: V4Instruction[]
...
export interface Type_462_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_462_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_462_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_462_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}

export interface Type_462_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V4Response
    maxWeight: Weight
...
export interface Type_462_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V4Asset[]
}

export interface Type_462_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_462_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_462_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_462_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_462_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}

export interface Type_462_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V4Asset[]
}

export interface Type_462_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_462[]
}

export interface Type_462_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_462[]
}

export interface Type_462_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_462_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_462_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_462_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_456
...
export interface Type_462_TransferAsset {
    __kind: 'TransferAsset'
    assets: V4Asset[]
    beneficiary: V4Location
}

export interface Type_462_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V4Asset[]
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_462_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_462_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_462_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_462_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V4Location | undefined)
}

export interface Type_462_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_462_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V4Asset[]
}
...
export type Type_455 = Type_455_BuyExecution | Type_455_ClaimAsset | Type_455_ClearError | Type_455_ClearOrigin | Type_455_DepositAsset | Type_455_DepositReserveAsset | Type_455_DescendOrigin | Type_455_ExchangeAsset | Type_455_HrmpChannelAccepted | Type_455_HrmpChannelClosing | Type_455_HrmpNewChannelOpenRequest | Type_455_InitiateReserveWithdraw | Type_455_InitiateTeleport | Type_455_QueryHolding | Type_455_QueryResponse | Type_455_ReceiveTeleportedAsset | Type_455_RefundSurplus | Type_455_ReportError | Type_455_ReserveAssetDeposited | Type_455_SetAppendix | Type_455_SetErrorHandler | Type_455_SubscribeVersion | Type_455_Transact | Type_455_TransferAsset | Type_455_TransferReserveAsset | Type_455_Trap | Type_455_UnsubscribeVersion | Type_455_WithdrawAsset
...
export interface Type_455_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export type Type_452 = Type_452_V2 | Type_452_V3 | Type_452_V4

export interface Type_452_V2 {
    __kind: 'V2'
    value: Type_455[]
}

export interface Type_452_V3 {
    __kind: 'V3'
    value: Type_459[]
}

export interface Type_452_V4 {
    __kind: 'V4'
    value: Type_462[]
}
...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_configs: sts.enumStruct({
            ...
            maxNominatorCount: Type_132,
            maxValidatorCount: Type_132,
            chillThreshold: Type_133,
            minCommission: Type_134,
        }),
...
export type Type_134 = Type_134_Noop | Type_134_Remove | Type_134_Set
...
export type Type_133 = Type_133_Noop | Type_133_Remove | Type_133_Set
...
export type Type_132 = Type_132_Noop | Type_132_Remove | Type_132_Set

export interface Type_132_Noop {
    __kind: 'Noop'
}

export interface Type_132_Remove {
    __kind: 'Remove'
}

export interface Type_132_Set {
    __kind: 'Set'
    value: number
}
...
export const Type_151: sts.Type<Type_151> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export const Type_153: sts.Type<Type_153> = sts.struct(() => {
    return  {
...
export const Type_159: sts.Type<Type_159> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export const Type_471: sts.Type<Type_471> = sts.struct(() => {
    return  {
        first: VoteMessage,
        second: VoteMessage,
    }
...
export type Call = Call_AssetRate | Call_Auctions | Call_Babe | Call_Balances | Call_Beefy | Call_Bounties | Call_ChildBounties | Call_Claims | Call_Configuration | Call_ConvictionVoting | Call_Crowdloan | Call_ElectionProviderMultiPhase | Call_FastUnstake | Call_Grandpa | Call_Hrmp | Call_Identity | Call_IdentityMigrator | Call_Indices | Call_Initializer | Call_MessageQueue | Call_Multisig | Call_NominationPools | Call_ParaInclusion | Call_ParaInherent | Call_Paras | Call_ParasDisputes | Call_ParasShared | Call_ParasSlashing | Call_Preimage | Call_Proxy | Call_Referenda | Call_Registrar | Call_Scheduler | Call_Session | Call_Slots | Call_Staking | Call_StateTrieMigration | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_VoterList | Call_Whitelist | Call_XcmPallet
