...
export type Type_185 = Type_185_EthereumTransaction

export interface Type_185_EthereumTransaction {
...
export const DappsStakingCall: sts.Type<DappsStakingCall> = sts.closedEnum(() => {
    return  {
        ...
        unbond_unstake_and_withdraw: sts.enumStruct({
            contractId: SmartContract,
            value: sts.bigint(),
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DappsStakingCall = DappsStakingCall_bond_and_stake | DappsStakingCall_claim | DappsStakingCall_developer_pre_approval | DappsStakingCall_enable_developer_pre_approval | DappsStakingCall_force_new_era | DappsStakingCall_register | DappsStakingCall_unbond_unstake_and_withdraw | DappsStakingCall_unregister
 ...
 */
export interface DappsStakingCall_claim {
    __kind: 'claim'
    contractId: SmartContract
    era: number
}
 ...
 * 
 */
export interface DappsStakingCall_unbond_unstake_and_withdraw {
    __kind: 'unbond_unstake_and_withdraw'
    contractId: SmartContract
    value: bigint
}
...
export type Call = Call_Authorship | Call_Balances | Call_BaseFee | Call_CollatorSelection | Call_DappsStaking | Call_EVM | Call_EthCall | Call_Ethereum | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting
