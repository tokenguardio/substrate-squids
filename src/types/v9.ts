...
export type Call = Call_System | Call_Utility | Call_Identity | Call_Timestamp | Call_Multisig | Call_ParachainSystem | Call_Balances | Call_Vesting | Call_DappsStaking | Call_Authorship | Call_CollatorSelection | Call_Session | Call_EVM | Call_Ethereum | Call_EthCall | Call_BaseFee | Call_Sudo
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DappsStakingCall = DappsStakingCall_register | DappsStakingCall_unregister | DappsStakingCall_bond_and_stake | DappsStakingCall_unbond_unstake_and_withdraw | DappsStakingCall_claim | DappsStakingCall_force_new_era | DappsStakingCall_developer_pre_approval | DappsStakingCall_enable_developer_pre_approval
...
export type Event = Event_System | Event_Utility | Event_Identity | Event_Multisig | Event_ParachainSystem | Event_Balances | Event_Vesting | Event_DappsStaking | Event_CollatorSelection | Event_Session | Event_EVM | Event_Ethereum | Event_EthCall | Event_BaseFee | Event_Sudo
