 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type SlpxCall = SlpxCall_add_whitelist | SlpxCall_mint | SlpxCall_redeem | SlpxCall_remove_whitelist | SlpxCall_set_currency_ethereum_call_switch | SlpxCall_set_ethereum_call_configration | SlpxCall_set_execution_fee | SlpxCall_set_transfer_to_fee | SlpxCall_stable_pool_swap | SlpxCall_zenlink_swap
...
export type TargetChain = TargetChain_Astar | TargetChain_Hydradx | TargetChain_Interlay | TargetChain_Moonbeam
...
export type SupportChain = SupportChain_Astar | SupportChain_Hydradx | SupportChain_Interlay | SupportChain_Moonbeam
...
export type Call = Call_AssetRegistry | Call_Balances | Call_Bounties | Call_CallSwitchgear | Call_CollatorSelection | Call_ConvictionVoting | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_CumulusXcm | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FeeShare | Call_FellowshipCollective | Call_FellowshipReferenda | Call_FlexibleFee | Call_Identity | Call_Indices | Call_LendMarket | Call_LeverageStaking | Call_MerkleDistributor | Call_Multisig | Call_Oracle | Call_OracleMembership | Call_OrmlXcm | Call_ParachainInfo | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Prices | Call_Proxy | Call_Referenda | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_Slpx | Call_StablePool | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_Utility | Call_VeMinting | Call_Vesting | Call_VtokenMinting | Call_VtokenVoting | Call_Whitelist | Call_XTokens | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
...
export const ParachainStakingLedgerUpdateEntry: sts.Type<ParachainStakingLedgerUpdateEntry> = sts.struct(() => {
    return  {
        currencyId: CurrencyId,
        delegatorId: V3MultiLocation,
        validatorId: sts.option(() => V3MultiLocation),
        updateOperation: ParachainStakingLedgerUpdateOperation,
        amount: sts.bigint(),
        unlockTime: sts.option(() => TimeUnit),
    }
})

export const ParachainStakingLedgerUpdateOperation: sts.Type<ParachainStakingLedgerUpdateOperation> = sts.closedEnum(() => {
    return  {
        Bond: sts.unit(),
        BondLess: sts.unit(),
...
export type ParachainStakingLedgerUpdateOperation = ParachainStakingLedgerUpdateOperation_Bond | ParachainStakingLedgerUpdateOperation_BondLess | ParachainStakingLedgerUpdateOperation_CancelLeave | ParachainStakingLedgerUpdateOperation_CancelRequest | ParachainStakingLedgerUpdateOperation_ExecuteLeave | ParachainStakingLedgerUpdateOperation_ExecuteRequest | ParachainStakingLedgerUpdateOperation_LeaveDelegator | ParachainStakingLedgerUpdateOperation_Revoke

export interface ParachainStakingLedgerUpdateOperation_Bond {
    __kind: 'Bond'
}

export interface ParachainStakingLedgerUpdateOperation_BondLess {
    __kind: 'BondLess'
}

export interface ParachainStakingLedgerUpdateOperation_CancelLeave {
    __kind: 'CancelLeave'
}

export interface ParachainStakingLedgerUpdateOperation_CancelRequest {
    __kind: 'CancelRequest'
}

export interface ParachainStakingLedgerUpdateOperation_ExecuteLeave {
    __kind: 'ExecuteLeave'
}

export interface ParachainStakingLedgerUpdateOperation_ExecuteRequest {
    __kind: 'ExecuteRequest'
}

export interface ParachainStakingLedgerUpdateOperation_LeaveDelegator {
    __kind: 'LeaveDelegator'
}

export interface ParachainStakingLedgerUpdateOperation_Revoke {
    __kind: 'Revoke'
}

export interface ParachainStakingLedgerUpdateEntry {
    currencyId: CurrencyId
    delegatorId: V3MultiLocation
...
export interface LedgerUpdateEntry_Moonbeam {
    __kind: 'Moonbeam'
    value: ParachainStakingLedgerUpdateEntry
}
