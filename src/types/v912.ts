...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_ParachainSystem | Call_Balances | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_PhragmenElection | Call_CouncilMembership | Call_TechnicalMembership | Call_XcmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_DmpQueue | Call_Utility | Call_Scheduler | Call_Proxy | Call_Multisig | Call_Identity | Call_Vesting | Call_Treasury | Call_Bounties | Call_Tips | Call_XTokens | Call_Tokens | Call_Currencies | Call_OrmlXcm | Call_ZenlinkProtocol | Call_FlexibleFee | Call_Salp | Call_LiquidityMiningDOT | Call_LiquidityMining | Call_TokenIssuer | Call_LighteningRedeem | Call_SalpLite | Call_CallSwitchgear | Call_VSBondAuction
...
export type Type_267 = Type_267_V0 | Type_267_V1 | Type_267_V2

export interface Type_267_V0 {
    __kind: 'V0'
    value: Type_268
}

export interface Type_267_V1 {
    __kind: 'V1'
    value: Type_273
}

export interface Type_267_V2 {
    __kind: 'V2'
    value: Type_279[]
}
...
export type Type_268 = Type_268_WithdrawAsset | Type_268_ReserveAssetDeposit | Type_268_TeleportAsset | Type_268_QueryResponse | Type_268_TransferAsset | Type_268_TransferReserveAsset | Type_268_Transact | Type_268_HrmpNewChannelOpenRequest | Type_268_HrmpChannelAccepted | Type_268_HrmpChannelClosing | Type_268_RelayedFrom
...
export interface Type_268_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_270[]
}

export interface Type_268_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_270[]
}
...
export type Type_279 = Type_279_WithdrawAsset | Type_279_ReserveAssetDeposited | Type_279_ReceiveTeleportedAsset | Type_279_QueryResponse | Type_279_TransferAsset | Type_279_TransferReserveAsset | Type_279_Transact | Type_279_HrmpNewChannelOpenRequest | Type_279_HrmpChannelAccepted | Type_279_HrmpChannelClosing | Type_279_ClearOrigin | Type_279_DescendOrigin | Type_279_ReportError | Type_279_DepositAsset | Type_279_DepositReserveAsset | Type_279_ExchangeAsset | Type_279_InitiateReserveWithdraw | Type_279_InitiateTeleport | Type_279_QueryHolding | Type_279_BuyExecution | Type_279_RefundSurplus | Type_279_SetErrorHandler | Type_279_SetAppendix | Type_279_ClearError | Type_279_ClaimAsset | Type_279_Trap | Type_279_SubscribeVersion | Type_279_UnsubscribeVersion
...
export interface Type_279_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_279_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}
...
export interface Type_279_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_279_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_279_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_279_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_279_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_279[]
}

export interface Type_279_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_279[]
}

export interface Type_279_ClearError {
    __kind: 'ClearError'
}

export interface Type_279_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_279_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_279_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_279_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_270 = Type_270_Null | Type_270_DepositAsset | Type_270_DepositReserveAsset | Type_270_ExchangeAsset | Type_270_InitiateReserveWithdraw | Type_270_InitiateTeleport | Type_270_QueryHolding | Type_270_BuyExecution

export interface Type_270_Null {
    __kind: 'Null'
}
...
export type Type_275 = Type_275_Noop | Type_275_DepositAsset | Type_275_DepositReserveAsset | Type_275_ExchangeAsset | Type_275_InitiateReserveWithdraw | Type_275_InitiateTeleport | Type_275_QueryHolding | Type_275_BuyExecution
