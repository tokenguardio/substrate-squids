...
export interface SubstrateValidatorsByDelegatorUpdateEntry {
    currencyId: CurrencyId
    delegatorId: V3MultiLocation
    validators: [V3MultiLocation, Uint8Array][]
}
...
export type Type_372 = Type_372_WithdrawAsset | Type_372_ReserveAssetDeposited | Type_372_ReceiveTeleportedAsset | Type_372_QueryResponse | Type_372_TransferAsset | Type_372_TransferReserveAsset | Type_372_Transact | Type_372_HrmpNewChannelOpenRequest | Type_372_HrmpChannelAccepted | Type_372_HrmpChannelClosing | Type_372_ClearOrigin | Type_372_DescendOrigin | Type_372_ReportError | Type_372_DepositAsset | Type_372_DepositReserveAsset | Type_372_ExchangeAsset | Type_372_InitiateReserveWithdraw | Type_372_InitiateTeleport | Type_372_ReportHolding | Type_372_BuyExecution | Type_372_RefundSurplus | Type_372_SetErrorHandler | Type_372_SetAppendix | Type_372_ClearError | Type_372_ClaimAsset | Type_372_Trap | Type_372_SubscribeVersion | Type_372_UnsubscribeVersion | Type_372_BurnAsset | Type_372_ExpectAsset | Type_372_ExpectOrigin | Type_372_ExpectError | Type_372_ExpectTransactStatus | Type_372_QueryPallet | Type_372_ExpectPallet | Type_372_ReportTransactStatus | Type_372_ClearTransactStatus | Type_372_UniversalOrigin | Type_372_ExportMessage | Type_372_LockAsset | Type_372_UnlockAsset | Type_372_NoteUnlockable | Type_372_RequestUnlock | Type_372_SetFeesMode | Type_372_SetTopic | Type_372_ClearTopic | Type_372_AliasOrigin | Type_372_UnpaidExecution
...
export type Type_378 = Type_378_Members | Type_378_Member | Type_378__Phantom

export interface Type_378_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_378_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_378__Phantom {
    __kind: '_Phantom'
}
...
export type Type_381 = Type_381_Relay | Type_381_SiblingParachain

export interface Type_381_Relay {
    __kind: 'Relay'
}

export interface Type_381_SiblingParachain {
...
export type Type_462 = Type_462_Ongoing | Type_462_Retired | Type_462_Success | Type_462_Failed | Type_462_RefundWithdrew | Type_462_RedeemWithdrew | Type_462_FailedToContinue

export interface Type_462_Ongoing {
    __kind: 'Ongoing'
}

export interface Type_462_Retired {
    __kind: 'Retired'
}

export interface Type_462_Success {
    __kind: 'Success'
}

export interface Type_462_Failed {
    __kind: 'Failed'
}

export interface Type_462_RefundWithdrew {
    __kind: 'RefundWithdrew'
}

export interface Type_462_RedeemWithdrew {
    __kind: 'RedeemWithdrew'
}

export interface Type_462_FailedToContinue {
    __kind: 'FailedToContinue'
}
