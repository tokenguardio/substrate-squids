...
export type Type_349 = Type_349_Member | Type_349_Members | Type_349__Phantom
...
export type Type_351 = Type_351_Relay | Type_351_SiblingParachain

export interface Type_351_Relay {
    __kind: 'Relay'
}

export interface Type_351_SiblingParachain {
...
export type Type_348 = Type_348_Member | Type_348_Members | Type_348__Phantom
...
export type Type_335 = Type_335_V2 | Type_335_V3

export interface Type_335_V2 {
    __kind: 'V2'
    value: Type_338[]
}

export interface Type_335_V3 {
    __kind: 'V3'
    value: Type_342[]
}
...
export const Type_339: sts.Type<Type_339> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const SubstrateValidatorsByDelegatorUpdateEntry: sts.Type<SubstrateValidatorsByDelegatorUpdateEntry> = sts.struct(() => {
    return  {
        ...
        validators: sts.array(() => sts.tuple(() => [V3MultiLocation, H256])),
    }
})
...
export interface SubstrateValidatorsByDelegatorUpdateEntry {
    currencyId: CurrencyId
    delegatorId: V3MultiLocation
    validators: [V3MultiLocation, H256][]
}
