...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_configs: sts.enumStruct({
            ...
            maxNominatorCount: Type_114,
            maxValidatorCount: Type_114,
            chillThreshold: Type_115,
            minCommission: Type_116,
        }),
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_141,
            minCreateBond: Type_141,
            maxPools: Type_142,
            maxMembers: Type_142,
            maxMembersPerPool: Type_142,
        }),
        ...
        update_roles: sts.enumStruct({
            poolId: sts.number(),
            newRoot: Type_143,
            newNominator: Type_143,
            newStateToggler: Type_143,
        }),
        withdraw_unbonded: sts.enumStruct({
            memberAccount: MultiAddress,
            numSlashingSpans: sts.number(),
...
export type Type_141 = Type_141_Noop | Type_141_Remove | Type_141_Set
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ElectionsCall = ElectionsCall_ban_from_committee | ElectionsCall_cancel_ban | ElectionsCall_change_validators | ElectionsCall_set_ban_config | ElectionsCall_set_elections_openness
...
export type Call = Call_Aleph | Call_Authorship | Call_Balances | Call_Elections | Call_Identity | Call_Multisig | Call_NominationPools | Call_Scheduler | Call_Session | Call_Staking | Call_Sudo | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting
