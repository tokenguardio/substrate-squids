...
export const Type_263: sts.Type<Type_263> = sts.closedEnum(() => {
    return  {
        EthereumTransaction: H160,
    }
})

export type Type_263 = Type_263_EthereumTransaction

export interface Type_263_EthereumTransaction {
...
export const Type_238: sts.Type<Type_238> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_238),
        SetErrorHandler: sts.array(() => Type_238),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_231: sts.Type<Type_231> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_231 {
    encoded: Bytes
}

export type Type_238 = Type_238_BuyExecution | Type_238_ClaimAsset | Type_238_ClearError | Type_238_ClearOrigin | Type_238_DepositAsset | Type_238_DepositReserveAsset | Type_238_DescendOrigin | Type_238_ExchangeAsset | Type_238_HrmpChannelAccepted | Type_238_HrmpChannelClosing | Type_238_HrmpNewChannelOpenRequest | Type_238_InitiateReserveWithdraw | Type_238_InitiateTeleport | Type_238_QueryHolding | Type_238_QueryResponse | Type_238_ReceiveTeleportedAsset | Type_238_RefundSurplus | Type_238_ReportError | Type_238_ReserveAssetDeposited | Type_238_SetAppendix | Type_238_SetErrorHandler | Type_238_SubscribeVersion | Type_238_Transact | Type_238_TransferAsset | Type_238_TransferReserveAsset | Type_238_Trap | Type_238_UnsubscribeVersion | Type_238_WithdrawAsset
...
export const Type_234: sts.Type<Type_234> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_232),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_234 = Type_234_BuyExecution | Type_234_DepositAsset | Type_234_DepositReserveAsset | Type_234_ExchangeAsset | Type_234_InitiateReserveWithdraw | Type_234_InitiateTeleport | Type_234_Noop | Type_234_QueryHolding
...
export type Type_232 = Type_232_HrmpChannelAccepted | Type_232_HrmpChannelClosing | Type_232_HrmpNewChannelOpenRequest | Type_232_QueryResponse | Type_232_ReceiveTeleportedAsset | Type_232_RelayedFrom | Type_232_ReserveAssetDeposited | Type_232_SubscribeVersion | Type_232_Transact | Type_232_TransferAsset | Type_232_TransferReserveAsset | Type_232_UnsubscribeVersion | Type_232_WithdrawAsset
...
export const Type_227: sts.Type<Type_227> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export type Type_229 = Type_229_BuyExecution | Type_229_DepositAsset | Type_229_DepositReserveAsset | Type_229_ExchangeAsset | Type_229_InitiateReserveWithdraw | Type_229_InitiateTeleport | Type_229_Null | Type_229_QueryHolding
...
export type Type_227 = Type_227_HrmpChannelAccepted | Type_227_HrmpChannelClosing | Type_227_HrmpNewChannelOpenRequest | Type_227_QueryResponse | Type_227_RelayedFrom | Type_227_ReserveAssetDeposit | Type_227_TeleportAsset | Type_227_Transact | Type_227_TransferAsset | Type_227_TransferReserveAsset | Type_227_WithdrawAsset
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DappsStakingCall = DappsStakingCall_bond_and_stake | DappsStakingCall_claim_dapp | DappsStakingCall_claim_staker | DappsStakingCall_developer_pre_approval | DappsStakingCall_enable_developer_pre_approval | DappsStakingCall_force_new_era | DappsStakingCall_maintenance_mode | DappsStakingCall_register | DappsStakingCall_unbond_and_unstake | DappsStakingCall_unregister | DappsStakingCall_withdraw_from_unregistered | DappsStakingCall_withdraw_unbonded
