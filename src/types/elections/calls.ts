...
export const vote =  {
    ...
    v108: new CallType(
        'Elections.vote',
        sts.struct({
            votes: sts.array(() => v108.AccountId32),
            value: sts.bigint(),
        })
    ),
}
...
export const submitCandidacy =  {
    name: 'Elections.submit_candidacy',
    /**
...
export const renounceCandidacy =  {
    name: 'Elections.renounce_candidacy',
    /**
    ...
    v108: new CallType(
        ...
        sts.struct({
            renouncing: v108.Renouncing,
        })
    ),
}

export const removeMember =  {
    name: 'Elections.remove_member',
    /**
...
export const cleanDefunctVoters =  {
    name: 'Elections.clean_defunct_voters',
    /**
