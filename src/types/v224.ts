...
export type Type_409 = Type_409_Member | Type_409_Members | Type_409__Phantom

export interface Type_409_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_409_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_409__Phantom {
    __kind: '_Phantom'
}
...
export const Type_410: sts.Type<Type_410> = sts.closedEnum(() => {
    return  {
...
export type Type_412 = Type_412_Relay | Type_412_SiblingParachain

export interface Type_412_Relay {
    __kind: 'Relay'
}

export interface Type_412_SiblingParachain {
...
export type Type_408 = Type_408_Member | Type_408_Members | Type_408__Phantom

export interface Type_408_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_408_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_408__Phantom {
    __kind: '_Phantom'
}
...
export const Type_105: sts.Type<Type_105> = sts.struct(() => {
    return  {
        bits: sts.number(),
    }
})
...
export const Type_384: sts.Type<Type_384> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_387),
        V3: sts.array(() => Type_391),
    }
})
...
export const Type_391: sts.Type<Type_391> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_391),
        SetErrorHandler: sts.array(() => Type_391),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_391 = Type_391_AliasOrigin | Type_391_BurnAsset | Type_391_BuyExecution | Type_391_ClaimAsset | Type_391_ClearError | Type_391_ClearOrigin | Type_391_ClearTopic | Type_391_ClearTransactStatus | Type_391_DepositAsset | Type_391_DepositReserveAsset | Type_391_DescendOrigin | Type_391_ExchangeAsset | Type_391_ExpectAsset | Type_391_ExpectError | Type_391_ExpectOrigin | Type_391_ExpectPallet | Type_391_ExpectTransactStatus | Type_391_ExportMessage | Type_391_HrmpChannelAccepted | Type_391_HrmpChannelClosing | Type_391_HrmpNewChannelOpenRequest | Type_391_InitiateReserveWithdraw | Type_391_InitiateTeleport | Type_391_LockAsset | Type_391_NoteUnlockable | Type_391_QueryPallet | Type_391_QueryResponse | Type_391_ReceiveTeleportedAsset | Type_391_RefundSurplus | Type_391_ReportError | Type_391_ReportHolding | Type_391_ReportTransactStatus | Type_391_RequestUnlock | Type_391_ReserveAssetDeposited | Type_391_SetAppendix | Type_391_SetErrorHandler | Type_391_SetFeesMode | Type_391_SetTopic | Type_391_SubscribeVersion | Type_391_Transact | Type_391_TransferAsset | Type_391_TransferReserveAsset | Type_391_Trap | Type_391_UniversalOrigin | Type_391_UnlockAsset | Type_391_UnpaidExecution | Type_391_UnsubscribeVersion | Type_391_WithdrawAsset

export interface Type_391_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_391_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_391_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_391_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_391_ClearError {
    __kind: 'ClearError'
}

export interface Type_391_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_391_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_391_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_391_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_391_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_391_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_391_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_391_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_391_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_391_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_391_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_391_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_391_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_391_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_391_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_391_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_391_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_391_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_391_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_391_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_391_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_391_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_391_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_391_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_391_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_391_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_391_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_391_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_391_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_391_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_391[]
}

export interface Type_391_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_391[]
}

export interface Type_391_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_391_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_391_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_391_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_388
...
export interface Type_391_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_391_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_391_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_391_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_391_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_391_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_391_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_391_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}

export const Type_387: sts.Type<Type_387> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V2MultiAsset,
            weightLimit: V2WeightLimit,
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_387),
        SetErrorHandler: sts.array(() => Type_387),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_387 = Type_387_BuyExecution | Type_387_ClaimAsset | Type_387_ClearError | Type_387_ClearOrigin | Type_387_DepositAsset | Type_387_DepositReserveAsset | Type_387_DescendOrigin | Type_387_ExchangeAsset | Type_387_HrmpChannelAccepted | Type_387_HrmpChannelClosing | Type_387_HrmpNewChannelOpenRequest | Type_387_InitiateReserveWithdraw | Type_387_InitiateTeleport | Type_387_QueryHolding | Type_387_QueryResponse | Type_387_ReceiveTeleportedAsset | Type_387_RefundSurplus | Type_387_ReportError | Type_387_ReserveAssetDeposited | Type_387_SetAppendix | Type_387_SetErrorHandler | Type_387_SubscribeVersion | Type_387_Transact | Type_387_TransferAsset | Type_387_TransferReserveAsset | Type_387_Trap | Type_387_UnsubscribeVersion | Type_387_WithdrawAsset

export interface Type_387_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_387_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_387_ClearError {
    __kind: 'ClearError'
}

export interface Type_387_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_387_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_387_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_387_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_387_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_387_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_387_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_387_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_387_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_387_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_387_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_387_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_387_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_387_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_387_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_387_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_387_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_387[]
}

export interface Type_387_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_387[]
}

export interface Type_387_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_387_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_388
...
export interface Type_387_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_387_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_387_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_387_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_387_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_384 = Type_384_V2 | Type_384_V3

export interface Type_384_V2 {
    __kind: 'V2'
    value: Type_387[]
}

export interface Type_384_V3 {
    __kind: 'V3'
    value: Type_391[]
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type MultiTransactionPaymentCall = MultiTransactionPaymentCall_add_currency | MultiTransactionPaymentCall_remove_currency | MultiTransactionPaymentCall_reset_payment_currency | MultiTransactionPaymentCall_set_currency
