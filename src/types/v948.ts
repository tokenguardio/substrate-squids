 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetRegistryCall = AssetRegistryCall_register_foreign_asset | AssetRegistryCall_update_foreign_asset | AssetRegistryCall_register_native_asset | AssetRegistryCall_update_native_asset
...
export type Type_379 = Type_379_Members | Type_379_Member | Type_379__Phantom

export interface Type_379_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_379_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_379__Phantom {
    __kind: '_Phantom'
}
...
export type Type_382 = Type_382_Relay | Type_382_SiblingParachain

export interface Type_382_Relay {
    __kind: 'Relay'
}

export interface Type_382_SiblingParachain {
...
export type Type_460 = Type_460_Ongoing | Type_460_Retired | Type_460_Success | Type_460_Failed | Type_460_RefundWithdrew | Type_460_RedeemWithdrew | Type_460_FailedToContinue

export interface Type_460_Ongoing {
    __kind: 'Ongoing'
}

export interface Type_460_Retired {
    __kind: 'Retired'
}

export interface Type_460_Success {
    __kind: 'Success'
}

export interface Type_460_Failed {
    __kind: 'Failed'
}

export interface Type_460_RefundWithdrew {
    __kind: 'RefundWithdrew'
}

export interface Type_460_RedeemWithdrew {
    __kind: 'RedeemWithdrew'
}

export interface Type_460_FailedToContinue {
    __kind: 'FailedToContinue'
}
