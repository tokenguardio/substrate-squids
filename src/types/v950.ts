...
export type Call = Call_Authorship | Call_Balances | Call_Bounties | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_Democracy | Call_DmpQueue | Call_Identity | Call_Indices | Call_Multisig | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
...
export type Type_204 = Type_204_Member | Type_204_Members | Type_204__Phantom
...
export type Type_206 = Type_206_Relay | Type_206_SiblingParachain

export interface Type_206_Relay {
    __kind: 'Relay'
}

export interface Type_206_SiblingParachain {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TreasuryCall = TreasuryCall_approve_proposal | TreasuryCall_propose_spend | TreasuryCall_reject_proposal | TreasuryCall_remove_approval
...
export type Type_185 = Type_185_V0 | Type_185_V1 | Type_185_V2

export interface Type_185_V0 {
    __kind: 'V0'
    value: Type_186
}

export interface Type_185_V1 {
    __kind: 'V1'
    value: Type_191
}

export interface Type_185_V2 {
    __kind: 'V2'
    value: Type_197[]
}

export type Type_197 = Type_197_BuyExecution | Type_197_ClaimAsset | Type_197_ClearError | Type_197_ClearOrigin | Type_197_DepositAsset | Type_197_DepositReserveAsset | Type_197_DescendOrigin | Type_197_ExchangeAsset | Type_197_HrmpChannelAccepted | Type_197_HrmpChannelClosing | Type_197_HrmpNewChannelOpenRequest | Type_197_InitiateReserveWithdraw | Type_197_InitiateTeleport | Type_197_QueryHolding | Type_197_QueryResponse | Type_197_ReceiveTeleportedAsset | Type_197_RefundSurplus | Type_197_ReportError | Type_197_ReserveAssetDeposited | Type_197_SetAppendix | Type_197_SetErrorHandler | Type_197_SubscribeVersion | Type_197_Transact | Type_197_TransferAsset | Type_197_TransferReserveAsset | Type_197_Trap | Type_197_UnsubscribeVersion | Type_197_WithdrawAsset

export interface Type_197_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_197_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_197_ClearError {
    __kind: 'ClearError'
}

export interface Type_197_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_197_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_197_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_197_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_197_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}
...
export interface Type_197_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_197_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_197_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_197_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_197_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_197_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_197_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_197_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_197[]
}

export interface Type_197_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_197[]
}

export interface Type_197_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}
...
export interface Type_197_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_197_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export interface Type_190 {
    encoded: Bytes
}

export type Type_191 = Type_191_HrmpChannelAccepted | Type_191_HrmpChannelClosing | Type_191_HrmpNewChannelOpenRequest | Type_191_QueryResponse | Type_191_ReceiveTeleportedAsset | Type_191_RelayedFrom | Type_191_ReserveAssetDeposited | Type_191_SubscribeVersion | Type_191_Transact | Type_191_TransferAsset | Type_191_TransferReserveAsset | Type_191_UnsubscribeVersion | Type_191_WithdrawAsset

export interface Type_191_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_191_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_191_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_191_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V1Response
}

export interface Type_191_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_193[]
}

export interface Type_191_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_191
}

export interface Type_191_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_193[]
}

export interface Type_191_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_191_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_190
...
export interface Type_191_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_191_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_191_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_191_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V1MultiAsset[]
    effects: Type_193[]
}

export type Type_193 = Type_193_BuyExecution | Type_193_DepositAsset | Type_193_DepositReserveAsset | Type_193_ExchangeAsset | Type_193_InitiateReserveWithdraw | Type_193_InitiateTeleport | Type_193_Noop | Type_193_QueryHolding

export interface Type_193_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_191[]
}

export interface Type_193_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_193_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_193_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_193_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_193_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_193_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_186 = Type_186_HrmpChannelAccepted | Type_186_HrmpChannelClosing | Type_186_HrmpNewChannelOpenRequest | Type_186_QueryResponse | Type_186_RelayedFrom | Type_186_ReserveAssetDeposit | Type_186_TeleportAsset | Type_186_Transact | Type_186_TransferAsset | Type_186_TransferReserveAsset | Type_186_WithdrawAsset

export interface Type_186_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_186_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_186_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_186_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_186_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_186
}

export interface Type_186_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_188[]
}

export interface Type_186_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_188[]
}

export interface Type_186_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_190
...
export interface Type_186_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_186_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_186_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_188[]
}

export type Type_188 = Type_188_BuyExecution | Type_188_DepositAsset | Type_188_DepositReserveAsset | Type_188_ExchangeAsset | Type_188_InitiateReserveWithdraw | Type_188_InitiateTeleport | Type_188_Null | Type_188_QueryHolding
...
export interface Type_188_Null {
    __kind: 'Null'
}

export interface Type_188_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export const Type_197: sts.Type<Type_197> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_197),
        SetErrorHandler: sts.array(() => Type_197),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_190: sts.Type<Type_190> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_193: sts.Type<Type_193> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_191),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
