...
export type Type_354 = Type_354_V2 | Type_354_V3

export interface Type_354_V2 {
    __kind: 'V2'
    value: Type_357[]
}

export interface Type_354_V3 {
    __kind: 'V3'
    value: Type_361[]
}
...
export type OriginCaller = OriginCaller_system | OriginCaller_Ethereum | OriginCaller_CouncilCollective | OriginCaller_TechCommitteeCollective | OriginCaller_TreasuryCouncilCollective | OriginCaller_CumulusXcm | OriginCaller_PolkadotXcm | OriginCaller_Void
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type MigrationsCall = MigrationsCall_migrate_democracy_preimage

export interface MigrationsCall_migrate_democracy_preimage {
    __kind: 'migrate_democracy_preimage'
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CouncilCollectiveCall = CouncilCollectiveCall_set_members | CouncilCollectiveCall_execute | CouncilCollectiveCall_propose | CouncilCollectiveCall_vote | CouncilCollectiveCall_close_old_weight | CouncilCollectiveCall_disapprove_proposal | CouncilCollectiveCall_close
 ...
 * # </weight>
 */
export interface CouncilCollectiveCall_close_old_weight {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TechCommitteeCollectiveCall = TechCommitteeCollectiveCall_set_members | TechCommitteeCollectiveCall_execute | TechCommitteeCollectiveCall_propose | TechCommitteeCollectiveCall_vote | TechCommitteeCollectiveCall_close_old_weight | TechCommitteeCollectiveCall_disapprove_proposal | TechCommitteeCollectiveCall_close
 ...
 * # </weight>
 */
export interface TechCommitteeCollectiveCall_close_old_weight {
    __kind: 'close_old_weight'
    proposalHash: Uint8Array
    index: number
    proposalWeightBound: bigint
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TreasuryCouncilCollectiveCall = TreasuryCouncilCollectiveCall_set_members | TreasuryCouncilCollectiveCall_execute | TreasuryCouncilCollectiveCall_propose | TreasuryCouncilCollectiveCall_vote | TreasuryCouncilCollectiveCall_close_old_weight | TreasuryCouncilCollectiveCall_disapprove_proposal | TreasuryCouncilCollectiveCall_close
 ...
 * # </weight>
 */
export interface TreasuryCouncilCollectiveCall_close_old_weight {
    __kind: 'close_old_weight'
    proposalHash: Uint8Array
    index: number
    proposalWeightBound: bigint
...
export type Type_357 = Type_357_WithdrawAsset | Type_357_ReserveAssetDeposited | Type_357_ReceiveTeleportedAsset | Type_357_QueryResponse | Type_357_TransferAsset | Type_357_TransferReserveAsset | Type_357_Transact | Type_357_HrmpNewChannelOpenRequest | Type_357_HrmpChannelAccepted | Type_357_HrmpChannelClosing | Type_357_ClearOrigin | Type_357_DescendOrigin | Type_357_ReportError | Type_357_DepositAsset | Type_357_DepositReserveAsset | Type_357_ExchangeAsset | Type_357_InitiateReserveWithdraw | Type_357_InitiateTeleport | Type_357_QueryHolding | Type_357_BuyExecution | Type_357_RefundSurplus | Type_357_SetErrorHandler | Type_357_SetAppendix | Type_357_ClearError | Type_357_ClaimAsset | Type_357_Trap | Type_357_SubscribeVersion | Type_357_UnsubscribeVersion

export interface Type_357_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export interface Type_357_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_357_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_357_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_357_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_357_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
...
export interface Type_357_Transact {
    __kind: 'Transact'
...
export interface Type_357_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_357_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_357_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_357_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_357_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_357_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
...
export interface Type_357_DepositAsset {
    __kind: 'DepositAsset'
...
export interface Type_357_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_357_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_357_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
...
export interface Type_357_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_357_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_357_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_357_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_357_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_357[]
}

export interface Type_357_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_357[]
}

export interface Type_357_ClearError {
    __kind: 'ClearError'
}

export interface Type_357_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_357_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_357_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_357_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_361 = Type_361_WithdrawAsset | Type_361_ReserveAssetDeposited | Type_361_ReceiveTeleportedAsset | Type_361_QueryResponse | Type_361_TransferAsset | Type_361_TransferReserveAsset | Type_361_Transact | Type_361_HrmpNewChannelOpenRequest | Type_361_HrmpChannelAccepted | Type_361_HrmpChannelClosing | Type_361_ClearOrigin | Type_361_DescendOrigin | Type_361_ReportError | Type_361_DepositAsset | Type_361_DepositReserveAsset | Type_361_ExchangeAsset | Type_361_InitiateReserveWithdraw | Type_361_InitiateTeleport | Type_361_ReportHolding | Type_361_BuyExecution | Type_361_RefundSurplus | Type_361_SetErrorHandler | Type_361_SetAppendix | Type_361_ClearError | Type_361_ClaimAsset | Type_361_Trap | Type_361_SubscribeVersion | Type_361_UnsubscribeVersion | Type_361_BurnAsset | Type_361_ExpectAsset | Type_361_ExpectOrigin | Type_361_ExpectError | Type_361_ExpectTransactStatus | Type_361_QueryPallet | Type_361_ExpectPallet | Type_361_ReportTransactStatus | Type_361_ClearTransactStatus | Type_361_UniversalOrigin | Type_361_ExportMessage | Type_361_LockAsset | Type_361_UnlockAsset | Type_361_NoteUnlockable | Type_361_RequestUnlock | Type_361_SetFeesMode | Type_361_SetTopic | Type_361_ClearTopic | Type_361_AliasOrigin | Type_361_UnpaidExecution

export interface Type_361_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}

export interface Type_361_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_361_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_361_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_361_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_361_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_361_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: DoubleEncoded
...
export interface Type_361_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_361_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_361_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_361_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_361_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_361_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_361_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_361_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_361_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_361_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_361_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_361_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_361_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_361_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_361_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_361[]
}

export interface Type_361_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_361[]
}

export interface Type_361_ClearError {
    __kind: 'ClearError'
}

export interface Type_361_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_361_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_361_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_361_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_361_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_361_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_361_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value: (V3MultiLocation | undefined)
}

export interface Type_361_ExpectError {
    __kind: 'ExpectError'
    value: ([number, V3Error] | undefined)
}

export interface Type_361_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_361_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Uint8Array
    responseInfo: V3QueryResponseInfo
}

export interface Type_361_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Uint8Array
    moduleName: Uint8Array
...
export interface Type_361_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_361_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_361_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_361_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_361_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_361_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_361_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_361_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_361_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_361_SetTopic {
    __kind: 'SetTopic'
    value: Uint8Array
}

export interface Type_361_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_361_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_361_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin: (V3MultiLocation | undefined)
}
...
export type Type_379 = Type_379_EthereumTransaction

export interface Type_379_EthereumTransaction {
...
export type Type_382 = Type_382_Members | Type_382_Member | Type_382__Phantom

export interface Type_382_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_382_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_382__Phantom {
    __kind: '_Phantom'
}
...
export type Type_384 = Type_384_Xcm | Type_384_Response

export interface Type_384_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}

export interface Type_384_Response {
    __kind: 'Response'
    value: V3MultiLocation
}
