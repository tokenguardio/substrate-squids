...
export type Type_360 = Type_360_Member | Type_360_Members | Type_360__Phantom
...
export type Type_362 = Type_362_Relay | Type_362_SiblingParachain

export interface Type_362_Relay {
    __kind: 'Relay'
}

export interface Type_362_SiblingParachain {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SlpxCall = SlpxCall_add_whitelist | SlpxCall_mint | SlpxCall_redeem | SlpxCall_remove_whitelist | SlpxCall_set_execution_fee | SlpxCall_set_transfer_to_fee | SlpxCall_swap
 ...
 */
export interface SlpxCall_swap {
    __kind: 'swap'
    evmCaller: H160
    currencyIdIn: CurrencyId
    currencyIdOut: CurrencyId
