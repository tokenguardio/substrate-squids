...
export type Type_354 = Type_354_Member | Type_354_Members | Type_354__Phantom
...
export const Type_356: sts.Type<Type_356> = sts.closedEnum(() => {
    return  {
        Relay: sts.unit(),
        SiblingParachain: Id,
    }
...
export type Type_356 = Type_356_Relay | Type_356_SiblingParachain

export interface Type_356_Relay {
    __kind: 'Relay'
}

export interface Type_356_SiblingParachain {
...
export type Type_353 = Type_353_Member | Type_353_Members | Type_353__Phantom
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const XcmActionCall: sts.Type<XcmActionCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XcmActionCall = XcmActionCall_add_whitelist | XcmActionCall_mint | XcmActionCall_redeem | XcmActionCall_remove_whitelist | XcmActionCall_set_execution_fee | XcmActionCall_set_transfer_to_fee | XcmActionCall_swap

export interface XcmActionCall_add_whitelist {
 ...
 */
export interface XcmActionCall_mint {
    __kind: 'mint'
    evmCaller: H160
    currencyId: CurrencyId
    supportChain: SupportChain
 ...
 * Redeem
 */
export interface XcmActionCall_redeem {
    __kind: 'redeem'
    evmCaller: H160
    vtokenId: CurrencyId
    supportChain: SupportChain
...
export interface XcmActionCall_remove_whitelist {
    __kind: 'remove_whitelist'
    supportChain: SupportChain
    evmContractAccountId: AccountId32
}

export interface XcmActionCall_set_execution_fee {
    __kind: 'set_execution_fee'
    currencyId: CurrencyId
    executionFee: bigint
}

export interface XcmActionCall_set_transfer_to_fee {
 ...
 */
export interface XcmActionCall_swap {
    __kind: 'swap'
    evmCaller: H160
    currencyIdIn: CurrencyId
    currencyIdOut: CurrencyId
...
export type SupportChain = SupportChain_Astar | SupportChain_Moonbeam
...
export const Type_340: sts.Type<Type_340> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_343),
        V3: sts.array(() => Type_347),
    }
})
...
export const Type_347: sts.Type<Type_347> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_347),
        SetErrorHandler: sts.array(() => Type_347),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_344: sts.Type<Type_344> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_344 {
    encoded: Bytes
}

export type Type_347 = Type_347_AliasOrigin | Type_347_BurnAsset | Type_347_BuyExecution | Type_347_ClaimAsset | Type_347_ClearError | Type_347_ClearOrigin | Type_347_ClearTopic | Type_347_ClearTransactStatus | Type_347_DepositAsset | Type_347_DepositReserveAsset | Type_347_DescendOrigin | Type_347_ExchangeAsset | Type_347_ExpectAsset | Type_347_ExpectError | Type_347_ExpectOrigin | Type_347_ExpectPallet | Type_347_ExpectTransactStatus | Type_347_ExportMessage | Type_347_HrmpChannelAccepted | Type_347_HrmpChannelClosing | Type_347_HrmpNewChannelOpenRequest | Type_347_InitiateReserveWithdraw | Type_347_InitiateTeleport | Type_347_LockAsset | Type_347_NoteUnlockable | Type_347_QueryPallet | Type_347_QueryResponse | Type_347_ReceiveTeleportedAsset | Type_347_RefundSurplus | Type_347_ReportError | Type_347_ReportHolding | Type_347_ReportTransactStatus | Type_347_RequestUnlock | Type_347_ReserveAssetDeposited | Type_347_SetAppendix | Type_347_SetErrorHandler | Type_347_SetFeesMode | Type_347_SetTopic | Type_347_SubscribeVersion | Type_347_Transact | Type_347_TransferAsset | Type_347_TransferReserveAsset | Type_347_Trap | Type_347_UniversalOrigin | Type_347_UnlockAsset | Type_347_UnpaidExecution | Type_347_UnsubscribeVersion | Type_347_WithdrawAsset

export interface Type_347_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_347_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_347_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_347_ClearError {
    __kind: 'ClearError'
}

export interface Type_347_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_347_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_347_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_347_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}
...
export interface Type_347_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_347_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_347_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_347_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_347_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_347_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_347_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_347_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_347_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_347_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_347_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_347_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_347_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_347_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_347_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_347_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_347_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_347_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_347_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_347_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_347[]
}

export interface Type_347_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_347[]
}

export interface Type_347_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_347_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_347_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_347_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_344
...
export interface Type_347_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_347_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_347_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_347_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_347_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_347_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_347_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_347_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export const Type_343: sts.Type<Type_343> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_343),
        SetErrorHandler: sts.array(() => Type_343),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_343 = Type_343_BuyExecution | Type_343_ClaimAsset | Type_343_ClearError | Type_343_ClearOrigin | Type_343_DepositAsset | Type_343_DepositReserveAsset | Type_343_DescendOrigin | Type_343_ExchangeAsset | Type_343_HrmpChannelAccepted | Type_343_HrmpChannelClosing | Type_343_HrmpNewChannelOpenRequest | Type_343_InitiateReserveWithdraw | Type_343_InitiateTeleport | Type_343_QueryHolding | Type_343_QueryResponse | Type_343_ReceiveTeleportedAsset | Type_343_RefundSurplus | Type_343_ReportError | Type_343_ReserveAssetDeposited | Type_343_SetAppendix | Type_343_SetErrorHandler | Type_343_SubscribeVersion | Type_343_Transact | Type_343_TransferAsset | Type_343_TransferReserveAsset | Type_343_Trap | Type_343_UnsubscribeVersion | Type_343_WithdrawAsset
...
export interface Type_343_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export type Type_340 = Type_340_V2 | Type_340_V3

export interface Type_340_V2 {
    __kind: 'V2'
    value: Type_343[]
}

export interface Type_340_V3 {
    __kind: 'V3'
    value: Type_347[]
}
...
export type Call = Call_AssetRegistry | Call_Balances | Call_Bounties | Call_CallSwitchgear | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FeeShare | Call_FlexibleFee | Call_Identity | Call_Indices | Call_MerkleDistributor | Call_Multisig | Call_OrmlXcm | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_Utility | Call_VeMinting | Call_Vesting | Call_VtokenMinting | Call_XTokens | Call_XcmAction | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
...
export interface Call_XcmAction {
    __kind: 'XcmAction'
    value: XcmActionCall
}
