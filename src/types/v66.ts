...
export type Type_290 = Type_290_Xcm | Type_290_Response

export interface Type_290_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}

export interface Type_290_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export type Type_291 = Type_291_Relay | Type_291_SiblingParachain

export interface Type_291_Relay {
    __kind: 'Relay'
}

export interface Type_291_SiblingParachain {
    __kind: 'SiblingParachain'
    value: number
}

export type Type_292 = Type_292_EthereumTransaction

export interface Type_292_EthereumTransaction {
...
export type Type_252 = Type_252_V2 | Type_252_V3

export interface Type_252_V2 {
    __kind: 'V2'
    value: Type_255[]
}

export interface Type_252_V3 {
    __kind: 'V3'
    value: Type_259[]
}
...
export type Type_255 = Type_255_WithdrawAsset | Type_255_ReserveAssetDeposited | Type_255_ReceiveTeleportedAsset | Type_255_QueryResponse | Type_255_TransferAsset | Type_255_TransferReserveAsset | Type_255_Transact | Type_255_HrmpNewChannelOpenRequest | Type_255_HrmpChannelAccepted | Type_255_HrmpChannelClosing | Type_255_ClearOrigin | Type_255_DescendOrigin | Type_255_ReportError | Type_255_DepositAsset | Type_255_DepositReserveAsset | Type_255_ExchangeAsset | Type_255_InitiateReserveWithdraw | Type_255_InitiateTeleport | Type_255_QueryHolding | Type_255_BuyExecution | Type_255_RefundSurplus | Type_255_SetErrorHandler | Type_255_SetAppendix | Type_255_ClearError | Type_255_ClaimAsset | Type_255_Trap | Type_255_SubscribeVersion | Type_255_UnsubscribeVersion

export interface Type_255_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export interface Type_255_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_255_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_255_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_255_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_255_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_255_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_255_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_255_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_255_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_255_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_255_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_255_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_255_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_255_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_255_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_255_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_255_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_255_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_255_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_255_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_255_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_255[]
}

export interface Type_255_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_255[]
}

export interface Type_255_ClearError {
    __kind: 'ClearError'
}

export interface Type_255_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_255_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_255_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_255_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_259 = Type_259_WithdrawAsset | Type_259_ReserveAssetDeposited | Type_259_ReceiveTeleportedAsset | Type_259_QueryResponse | Type_259_TransferAsset | Type_259_TransferReserveAsset | Type_259_Transact | Type_259_HrmpNewChannelOpenRequest | Type_259_HrmpChannelAccepted | Type_259_HrmpChannelClosing | Type_259_ClearOrigin | Type_259_DescendOrigin | Type_259_ReportError | Type_259_DepositAsset | Type_259_DepositReserveAsset | Type_259_ExchangeAsset | Type_259_InitiateReserveWithdraw | Type_259_InitiateTeleport | Type_259_ReportHolding | Type_259_BuyExecution | Type_259_RefundSurplus | Type_259_SetErrorHandler | Type_259_SetAppendix | Type_259_ClearError | Type_259_ClaimAsset | Type_259_Trap | Type_259_SubscribeVersion | Type_259_UnsubscribeVersion | Type_259_BurnAsset | Type_259_ExpectAsset | Type_259_ExpectOrigin | Type_259_ExpectError | Type_259_ExpectTransactStatus | Type_259_QueryPallet | Type_259_ExpectPallet | Type_259_ReportTransactStatus | Type_259_ClearTransactStatus | Type_259_UniversalOrigin | Type_259_ExportMessage | Type_259_LockAsset | Type_259_UnlockAsset | Type_259_NoteUnlockable | Type_259_RequestUnlock | Type_259_SetFeesMode | Type_259_SetTopic | Type_259_ClearTopic | Type_259_AliasOrigin | Type_259_UnpaidExecution
...
export interface Type_259_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}
...
export interface Type_259_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_259_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_259_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value: (V3MultiLocation | undefined)
}

export interface Type_259_ExpectError {
    __kind: 'ExpectError'
    value: ([number, V3Error] | undefined)
}

export interface Type_259_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_259_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Uint8Array
    responseInfo: V3QueryResponseInfo
}

export interface Type_259_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Uint8Array
    moduleName: Uint8Array
...
export interface Type_259_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_259_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_259_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_259_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_259_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_259_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_259_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_259_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_259_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_259_SetTopic {
    __kind: 'SetTopic'
    value: Uint8Array
}

export interface Type_259_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_259_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_259_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin: (V3MultiLocation | undefined)
}
