...
export const DappStaking: sts.Type<DappStaking> = sts.closedEnum(() => {
    return  {
        ClaimBonusReward: AstarValidator,
        ClaimStakerRewards: sts.unit(),
        ClaimUnlocked: sts.unit(),
        Lock: sts.bigint(),
        RelockUnlocking: sts.unit(),
        Stake: sts.tuple(() => [AstarValidator, sts.bigint()]),
        Unlock: sts.bigint(),
        Unstake: sts.tuple(() => [AstarValidator, sts.bigint()]),
    }
})

export const AstarValidator: sts.Type<AstarValidator> = sts.closedEnum(() => {
    return  {
        Evm: H160,
        Wasm: AccountId32,
    }
...
export type AstarValidator = AstarValidator_Evm | AstarValidator_Wasm

export interface AstarValidator_Evm {
    __kind: 'Evm'
    value: H160
}

export interface AstarValidator_Wasm {
    __kind: 'Wasm'
    value: AccountId32
}
...
export type DappStaking = DappStaking_ClaimBonusReward | DappStaking_ClaimStakerRewards | DappStaking_ClaimUnlocked | DappStaking_Lock | DappStaking_RelockUnlocking | DappStaking_Stake | DappStaking_Unlock | DappStaking_Unstake

export interface DappStaking_ClaimBonusReward {
    __kind: 'ClaimBonusReward'
    value: AstarValidator
}

export interface DappStaking_ClaimStakerRewards {
    __kind: 'ClaimStakerRewards'
}

export interface DappStaking_ClaimUnlocked {
    __kind: 'ClaimUnlocked'
}

export interface DappStaking_Lock {
    __kind: 'Lock'
    value: bigint
}

export interface DappStaking_RelockUnlocking {
    __kind: 'RelockUnlocking'
}

export interface DappStaking_Stake {
    __kind: 'Stake'
    value: [AstarValidator, bigint]
}

export interface DappStaking_Unlock {
    __kind: 'Unlock'
    value: bigint
}

export interface DappStaking_Unstake {
    __kind: 'Unstake'
    value: [AstarValidator, bigint]
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const SlpV2Call: sts.Type<SlpV2Call> = sts.closedEnum(() => {
    return  {
        add_delegator: sts.enumStruct({
            stakingProtocol: StakingProtocol,
            delegator: sts.option(() => Delegator),
        }),
        ...
        astar_dapp_staking: sts.enumStruct({
            delegator: Delegator,
            task: DappStaking,
        }),
        notify_astar_dapp_staking: sts.enumStruct({
            queryId: sts.bigint(),
            response: V4Response,
        }),
        ...
        set_ledger: sts.enumStruct({
            stakingProtocol: StakingProtocol,
            delegator: Delegator,
            ledger: Type_461,
        }),
        set_protocol_configuration: sts.enumStruct({
            stakingProtocol: StakingProtocol,
        ...
        update_ongoing_time_unit: sts.enumStruct({
            stakingProtocol: StakingProtocol,
            timeUintOption: sts.option(() => TimeUnit),
        }),
        update_token_exchange_rate: sts.enumStruct({
            stakingProtocol: StakingProtocol,
            delegator: Delegator,
            amount: sts.bigint(),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type SlpV2Call = SlpV2Call_add_delegator | SlpV2Call_add_validator | SlpV2Call_astar_dapp_staking | SlpV2Call_notify_astar_dapp_staking | SlpV2Call_remove_delegator | SlpV2Call_remove_validator | SlpV2Call_set_ledger | SlpV2Call_set_protocol_configuration | SlpV2Call_transfer_back | SlpV2Call_transfer_to | SlpV2Call_update_ongoing_time_unit | SlpV2Call_update_token_exchange_rate
 ...
 *   account.
 */
export interface SlpV2Call_add_delegator {
    __kind: 'add_delegator'
    stakingProtocol: StakingProtocol
 ...
 */
export interface SlpV2Call_add_validator {
 ...
 */
export interface SlpV2Call_astar_dapp_staking {
    __kind: 'astar_dapp_staking'
    delegator: Delegator
    task: DappStaking
}
 ...
 */
export interface SlpV2Call_notify_astar_dapp_staking {
    __kind: 'notify_astar_dapp_staking'
    queryId: bigint
    response: V4Response
}
 ...
 */
export interface SlpV2Call_remove_delegator {
 ...
 */
export interface SlpV2Call_remove_validator {
 ...
 */
export interface SlpV2Call_set_ledger {
    __kind: 'set_ledger'
    stakingProtocol: StakingProtocol
    delegator: Delegator
    ledger: Type_461
 ...
 */
export interface SlpV2Call_set_protocol_configuration {
    __kind: 'set_protocol_configuration'
    stakingProtocol: StakingProtocol
    configuration: ProtocolConfiguration
}
 ...
 */
export interface SlpV2Call_transfer_back {
 ...
 * - `delegator`: Select the delegator which is existed.
 */
export interface SlpV2Call_transfer_to {
    __kind: 'transfer_to'
    stakingProtocol: StakingProtocol
    delegator: Delegator
}
 ...
 */
export interface SlpV2Call_update_ongoing_time_unit {
    __kind: 'update_ongoing_time_unit'
    stakingProtocol: StakingProtocol
    timeUintOption?: (TimeUnit | undefined)
}
 ...
 */
export interface SlpV2Call_update_token_exchange_rate {
    __kind: 'update_token_exchange_rate'
    stakingProtocol: StakingProtocol
    delegator: Delegator
    amount: bigint
}
...
export interface ProtocolConfiguration {
    ...
    unlockPeriod: TimeUnit
    operator: AccountId32
    maxUpdateTokenExchangeRate: Permill
    updateTimeUnitInterval: number
    updateExchangeRateInterval: number
}

export interface XcmFee {
    weight: Weight
    fee: bigint
}

export type Type_461 = Type_461_AstarDappStaking

export interface Type_461_AstarDappStaking {
    __kind: 'AstarDappStaking'
    value: AstarDappStakingLedger
}

export interface AstarDappStakingLedger {
    locked: bigint
    unlocking: AstarUnlockingRecord[]
}

export interface AstarUnlockingRecord {
    amount: bigint
    unlockTime: TimeUnit
}

export type Validator = Validator_AstarDappStaking | Validator_MoonbeamParachainStaking | Validator_PolkadotStaking

export interface Validator_AstarDappStaking {
    __kind: 'AstarDappStaking'
    value: AstarValidator
}

export interface Validator_MoonbeamParachainStaking {
    __kind: 'MoonbeamParachainStaking'
    value: H160
}

export interface Validator_PolkadotStaking {
    __kind: 'PolkadotStaking'
    value: AccountId32
}

export type Delegator = Delegator_Ethereum | Delegator_Substrate

export interface Delegator_Ethereum {
    __kind: 'Ethereum'
    value: H160
}

export interface Delegator_Substrate {
    __kind: 'Substrate'
    value: AccountId32
}

export type StakingProtocol = StakingProtocol_AstarDappStaking | StakingProtocol_MoonbeamParachainStaking | StakingProtocol_PolkadotStaking

export interface StakingProtocol_AstarDappStaking {
    __kind: 'AstarDappStaking'
}

export interface StakingProtocol_MoonbeamParachainStaking {
    __kind: 'MoonbeamParachainStaking'
}

export interface StakingProtocol_PolkadotStaking {
    __kind: 'PolkadotStaking'
}
...
export const FeeShareCall: sts.Type<FeeShareCall> = sts.closedEnum(() => {
    return  {
        ...
        set_usd_config: sts.enumStruct({
            distributionId: sts.number(),
            targetValue: sts.bigint(),
            interval: sts.number(),
            targetAccountId: AccountId32,
        }),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FeeShareCall = FeeShareCall_create_distribution | FeeShareCall_delete_distribution | FeeShareCall_edit_distribution | FeeShareCall_execute_distribute | FeeShareCall_set_era_length | FeeShareCall_set_usd_config
 ...
 */
export interface FeeShareCall_set_usd_config {
    __kind: 'set_usd_config'
    distributionId: number
    targetValue: bigint
    interval: number
    targetAccountId: AccountId32
...
export const BuyBackCall: sts.Type<BuyBackCall> = sts.closedEnum(() => {
    return  {
        ...
        set_vtoken: sts.enumStruct({
            ...
            ifAuto: sts.boolean(),
            destructionRatio: sts.option(() => Permill),
            bias: Permill,
        }),
    }
})
...
export interface BuyBackCall_set_vtoken {
    ...
    ifAuto: boolean
    destructionRatio?: (Permill | undefined)
    bias: Permill
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const BbBNCCall: sts.Type<BbBNCCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type BbBNCCall = BbBNCCall_create_lock | BbBNCCall_deposit_markup | BbBNCCall_get_rewards | BbBNCCall_increase_amount | BbBNCCall_increase_unlock_time | BbBNCCall_notify_rewards | BbBNCCall_redeem_unlock | BbBNCCall_refresh | BbBNCCall_set_config | BbBNCCall_set_markup_coefficient | BbBNCCall_withdraw | BbBNCCall_withdraw_markup

export interface BbBNCCall_create_lock {
    __kind: 'create_lock'
    value: bigint
    unlockTime: number
}

export interface BbBNCCall_deposit_markup {
    __kind: 'deposit_markup'
    assetId: CurrencyId
    value: bigint
}

export interface BbBNCCall_get_rewards {
    __kind: 'get_rewards'
}

export interface BbBNCCall_increase_amount {
    __kind: 'increase_amount'
    position: bigint
    value: bigint
}

export interface BbBNCCall_increase_unlock_time {
    __kind: 'increase_unlock_time'
    position: bigint
    time: number
}

export interface BbBNCCall_notify_rewards {
...
export interface BbBNCCall_redeem_unlock {
    __kind: 'redeem_unlock'
    position: bigint
}

export interface BbBNCCall_refresh {
    __kind: 'refresh'
    assetId: CurrencyId
}

export interface BbBNCCall_set_config {
    __kind: 'set_config'
    minMint?: (bigint | undefined)
    minBlock?: (number | undefined)
}

export interface BbBNCCall_set_markup_coefficient {
...
export interface BbBNCCall_withdraw {
    __kind: 'withdraw'
    position: bigint
}

export interface BbBNCCall_withdraw_markup {
...
export type Call = Call_AssetRegistry | Call_Balances | Call_BbBNC | Call_BuyBack | Call_ChannelCommission | Call_CloudsConvert | Call_CollatorSelection | Call_ConvictionVoting | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_CumulusXcm | Call_Democracy | Call_DynamicFee | Call_EVM | Call_EVMAccounts | Call_Ethereum | Call_Farming | Call_FeeShare | Call_FellowshipCollective | Call_FellowshipReferenda | Call_FlexibleFee | Call_Identity | Call_Indices | Call_LendMarket | Call_LeverageStaking | Call_MerkleDistributor | Call_MessageQueue | Call_Multisig | Call_Oracle | Call_OracleMembership | Call_OrmlXcm | Call_ParachainInfo | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Prices | Call_Proxy | Call_Referenda | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_SlpV2 | Call_Slpx | Call_StablePool | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_TxPause | Call_Utility | Call_Vesting | Call_VtokenMinting | Call_VtokenVoting | Call_Whitelist | Call_XTokens | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
...
export const PendingStatus: sts.Type<PendingStatus> = sts.closedEnum(() => {
    return  {
        AstarDappStaking: AstarDappStakingPendingStatus,
    }
})

export const AstarDappStakingPendingStatus: sts.Type<AstarDappStakingPendingStatus> = sts.closedEnum(() => {
    return  {
        ClaimUnlocked: Delegator,
        Lock: sts.tuple(() => [Delegator, sts.bigint()]),
        UnLock: sts.tuple(() => [Delegator, sts.bigint()]),
    }
})

export type AstarDappStakingPendingStatus = AstarDappStakingPendingStatus_ClaimUnlocked | AstarDappStakingPendingStatus_Lock | AstarDappStakingPendingStatus_UnLock

export interface AstarDappStakingPendingStatus_ClaimUnlocked {
    __kind: 'ClaimUnlocked'
    value: Delegator
}

export interface AstarDappStakingPendingStatus_Lock {
    __kind: 'Lock'
    value: [Delegator, bigint]
}

export interface AstarDappStakingPendingStatus_UnLock {
    __kind: 'UnLock'
    value: [Delegator, bigint]
}

export type PendingStatus = PendingStatus_AstarDappStaking

export interface PendingStatus_AstarDappStaking {
    __kind: 'AstarDappStaking'
    value: AstarDappStakingPendingStatus
}

export const XcmTask: sts.Type<XcmTask> = sts.closedEnum(() => {
    return  {
        AstarDappStaking: DappStaking,
    }
})

export type XcmTask = XcmTask_AstarDappStaking

export interface XcmTask_AstarDappStaking {
    __kind: 'AstarDappStaking'
    value: DappStaking
}

export const Type_461: sts.Type<Type_461> = sts.closedEnum(() => {
    return  {
        AstarDappStaking: AstarDappStakingLedger,
    }
})

export const AstarDappStakingLedger: sts.Type<AstarDappStakingLedger> = sts.struct(() => {
    return  {
        locked: sts.bigint(),
        unlocking: sts.array(() => AstarUnlockingRecord),
    }
})

export const AstarUnlockingRecord: sts.Type<AstarUnlockingRecord> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
        unlockTime: TimeUnit,
    }
...
export const ProtocolConfiguration: sts.Type<ProtocolConfiguration> = sts.struct(() => {
    return  {
        xcmTaskFee: XcmFee,
        protocolFeeRate: Permill,
        unlockPeriod: TimeUnit,
        operator: AccountId32,
        maxUpdateTokenExchangeRate: Permill,
        updateTimeUnitInterval: sts.number(),
        updateExchangeRateInterval: sts.number(),
    }
})

export const XcmFee: sts.Type<XcmFee> = sts.struct(() => {
    return  {
        weight: Weight,
        fee: sts.bigint(),
    }
...
export const Validator: sts.Type<Validator> = sts.closedEnum(() => {
    return  {
        AstarDappStaking: AstarValidator,
        MoonbeamParachainStaking: H160,
        PolkadotStaking: AccountId32,
    }
})

export const Delegator: sts.Type<Delegator> = sts.closedEnum(() => {
    return  {
        Ethereum: H160,
...
export const StakingProtocol: sts.Type<StakingProtocol> = sts.closedEnum(() => {
    return  {
        AstarDappStaking: sts.unit(),
        MoonbeamParachainStaking: sts.unit(),
        PolkadotStaking: sts.unit(),
    }
})

export const IncentiveConfig: sts.Type<IncentiveConfig> = sts.struct(() => {
    return  {
        rewardRate: sts.array(() => sts.tuple(() => [CurrencyId, sts.bigint()])),
        rewardPerTokenStored: sts.array(() => sts.tuple(() => [CurrencyId, sts.bigint()])),
        rewardsDuration: sts.number(),
        periodFinish: sts.number(),
        lastUpdateTime: sts.number(),
        incentiveController: sts.option(() => AccountId32),
        lastReward: sts.array(() => sts.tuple(() => [CurrencyId, sts.bigint()])),
    }
})

export interface IncentiveConfig {
    rewardRate: [CurrencyId, bigint][]
    rewardPerTokenStored: [CurrencyId, bigint][]
    rewardsDuration: number
    periodFinish: number
    lastUpdateTime: number
    incentiveController?: (AccountId32 | undefined)
    lastReward: [CurrencyId, bigint][]
}

export const VeConfig: sts.Type<VeConfig> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
        minMint: sts.bigint(),
        minBlock: sts.number(),
...
export const DollarStandardInfo: sts.Type<DollarStandardInfo> = sts.struct(() => {
    return  {
        targetValue: sts.bigint(),
        cumulative: sts.bigint(),
        targetAccountId: AccountId32,
        targetBlock: sts.number(),
        interval: sts.number(),
    }
})

export interface DollarStandardInfo {
    targetValue: bigint
    cumulative: bigint
    targetAccountId: AccountId32
    targetBlock: number
