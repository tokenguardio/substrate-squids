...
export class AlephChangeEmergencyFinalizerEvent {
    ...
    get asV39(): Uint8Array {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}

export class AlephChangeValidatorsEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'Aleph.ChangeValidators')
        this._chain = ctx._chain
        this.event = event
    }

    get isV3(): boolean {
        return this._chain.getEventHash('Aleph.ChangeValidators') === 'e93c1a5a56095e646628f211655a4b5506440dd2f59282b3bfc35091e02aa271'
    }
...
export class BalancesBalanceSetEvent {
     ...
     *  A balance was set by root. \[who, free, reserved\]
     */
    get asV3(): [Uint8Array, bigint, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A balance was set by root.
     */
    get asV68(): {who: Uint8Array, free: bigint} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     *  \[from, to, balance, destination_status\]
     */
    get asV3(): [Uint8Array, Uint8Array, bigint, v3.BalanceStatus] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class ContractsCalledEvent {
     ...
     * rolled back.
     */
    get asV68(): {caller: v68.Origin, contract: Uint8Array} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ElectionsBanValidatorsEvent {
     ...
     * Validators have been banned from the committee
     */
    get asV39(): [Uint8Array, v39.BanInfo][] {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class IdentityIdentityClearedEvent {
     ...
     * A name was cleared, and the given balance returned.
     */
    get asV39(): {who: Uint8Array, deposit: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class IdentityJudgementGivenEvent {
     ...
     * A judgement was given by a registrar.
     */
    get asV39(): {target: Uint8Array, registrarIndex: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class IdentityJudgementRequestedEvent {
     ...
     * A judgement was asked from a registrar.
     */
    get asV39(): {who: Uint8Array, registrarIndex: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class IdentityRegistrarAddedEvent {
     ...
     * A registrar was added.
     */
    get asV39(): {registrarIndex: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class IdentitySubIdentityAddedEvent {
     ...
     * A sub-identity was added to an identity and the deposit paid.
     */
    get asV39(): {sub: Uint8Array, main: Uint8Array, deposit: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultisigMultisigApprovalEvent {
     ...
     *  \[approving, timepoint, multisig, call_hash\]
     */
    get asV3(): [Uint8Array, v3.Timepoint, Uint8Array, Uint8Array] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class MultisigMultisigExecutedEvent {
     ...
     *  A multisig operation has been executed. \[approving, timepoint, multisig, call_hash\]
     */
    get asV3(): [Uint8Array, v3.Timepoint, Uint8Array, Uint8Array, v3.DispatchResult] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A multisig operation has been executed.
     */
    get asV39(): {approving: Uint8Array, timepoint: v39.Timepoint, multisig: Uint8Array, callHash: Uint8Array, result: v39.Type_30} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A multisig operation has been executed.
     */
    get asV68(): {approving: Uint8Array, timepoint: v68.Timepoint, multisig: Uint8Array, callHash: Uint8Array, result: v68.Type_33} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultisigNewMultisigEvent {
     ...
     *  A new multisig operation has begun. \[approving, multisig, call_hash\]
     */
    get asV3(): [Uint8Array, Uint8Array, Uint8Array] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class NominationPoolsBondedEvent {
     ...
     * A member has became bonded in a pool.
     */
    get asV39(): {member: Uint8Array, poolId: number, bonded: bigint, joined: boolean} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsCreatedEvent {
     ...
     * A pool has been created.
     */
    get asV39(): {depositor: Uint8Array, poolId: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsMemberRemovedEvent {
     ...
     * The removal can be voluntary (withdrawn all unbonded funds) or involuntary (kicked).
     */
    get asV39(): {poolId: number, member: Uint8Array} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsPaidOutEvent {
     ...
     * A payout has been made to a member.
     */
    get asV39(): {member: Uint8Array, poolId: number, payout: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsPoolCommissionClaimedEvent {
     ...
     * Pool commission has been claimed.
     */
    get asV68(): {poolId: number, commission: bigint} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsPoolCommissionUpdatedEvent {
     ...
     * A pool's commission setting has been changed.
     */
    get asV68(): {poolId: number, current: ([number, Uint8Array] | undefined)} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsPoolSlashedEvent {
     ...
     * The active balance of pool `pool_id` has been slashed to `balance`.
     */
    get asV39(): {poolId: number, balance: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsRolesUpdatedEvent {
     ...
     * can never change.
     */
    get asV39(): {root: (Uint8Array | undefined), stateToggler: (Uint8Array | undefined), nominator: (Uint8Array | undefined)} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * can never change.
     */
    get asV68(): {root: (Uint8Array | undefined), bouncer: (Uint8Array | undefined), nominator: (Uint8Array | undefined)} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsStateChangedEvent {
     ...
     * The state of a pool has changed
     */
    get asV39(): {poolId: number, newState: v39.PoolState} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsUnbondedEvent {
     ...
     * requested to be unbonded.
     */
    get asV39(): {member: Uint8Array, poolId: number, balance: bigint, points: bigint, era: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsUnbondingPoolSlashedEvent {
     ...
     * The unbond pool at `era` of pool `pool_id` has been slashed to `balance`.
     */
    get asV39(): {poolId: number, era: number, balance: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NominationPoolsWithdrawnEvent {
     ...
     * will be 1.
     */
    get asV39(): {member: Uint8Array, poolId: number, balance: bigint, points: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerCallLookupFailedEvent {
     ...
     * The call for the provided hash was not found so the task has been aborted.
     */
    get asV39(): {task: [number, number], id: (Uint8Array | undefined), error: v39.LookupError} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerCanceledEvent {
     ...
     * Canceled some task.
     */
    get asV39(): {when: number, index: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     *  Dispatched some task. \[task, id, result\]
     */
    get asV3(): [[number, number], (Uint8Array | undefined), v3.DispatchResult] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Dispatched some task.
     */
    get asV68(): {task: [number, number], id: (Uint8Array | undefined), result: v68.Type_33} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SudoKeyChangedEvent {
     ...
     * The \[sudoer\] just switched identity; the old key is supplied if one existed.
     */
    get asV39(): {oldSudoer: (Uint8Array | undefined)} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SudoSudidEvent {
     ...
     * A sudo just took place. \[result\]
     */
    get asV68(): {sudoResult: v68.Type_33} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SystemExtrinsicFailedEvent {
     ...
     *  An extrinsic failed. \[error, info\]
     */
    get asV3(): [v3.DispatchError, v3.DispatchInfo] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * An extrinsic failed.
     */
    get asV39(): {dispatchError: v39.DispatchError, dispatchInfo: v39.DispatchInfo} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * An extrinsic failed.
     */
    get asV68(): {dispatchError: v68.DispatchError, dispatchInfo: v68.DispatchInfo} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SystemRemarkedEvent {
     ...
     * On on-chain remark happened.
     */
    get asV39(): {sender: Uint8Array, hash: Uint8Array} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TransactionPaymentTransactionFeePaidEvent {
     ...
     * has been paid by `who`.
     */
    get asV39(): {who: Uint8Array, actualFee: bigint, tip: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryAwardedEvent {
     ...
     * Some funds have been allocated.
     */
    get asV39(): {proposalIndex: number, award: bigint, account: Uint8Array} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryProposedEvent {
     ...
     * New proposal.
     */
    get asV39(): {proposalIndex: number} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryRejectedEvent {
     ...
     * A proposal was rejected; funds were slashed.
     */
    get asV39(): {proposalIndex: number, slashed: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryRolloverEvent {
     ...
     * Spending has finished; this is the amount that rolls over until next spend.
     */
    get asV39(): {rolloverBalance: bigint} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasurySpendApprovedEvent {
     ...
     * A new spend proposal has been approved.
     */
    get asV39(): {proposalIndex: number, amount: bigint, beneficiary: Uint8Array} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class UtilityBatchInterruptedEvent {
     ...
     * well as the error.
     */
    get asV39(): {index: number, error: v39.DispatchError} {
        assert(this.isV39)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * well as the error.
     */
    get asV68(): {index: number, error: v68.DispatchError} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class UtilityItemFailedEvent {
     ...
     * A single item within a Batch of dispatches has completed with error.
     */
    get asV68(): {error: v68.DispatchError} {
        assert(this.isV68)
        return this._chain.decodeEvent(this.event)
    }
}
