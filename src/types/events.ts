...
export class AssetRegistryRegisteredAssetEvent {
    ...
    get asV3000(): {assetId: number, metadata: v3000.AssetMetadata} {
        assert(this.isV3000)
...
export class BountiesBountyAwardedEvent {
     ...
     * A bounty is awarded to a beneficiary.
     */
    get asV2(): {index: number, beneficiary: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BountiesBountyClaimedEvent {
     ...
     * A bounty is claimed by beneficiary.
     */
    get asV2(): {index: number, payout: bigint, beneficiary: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BountiesBountyRejectedEvent {
     ...
     * A bounty proposal was rejected; funds were slashed.
     */
    get asV2(): {index: number, bond: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ClaimsClaimedEvent {
     ...
     * Someone claimed some EFIs. `[who, ethereum_address, amount]`
     */
    get asV2(): {who: Uint8Array, ethereumAddress: Uint8Array, amount: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CollatorStakingCandidateJoinedEvent {
     ...
     * A new candidate joined the list of candidates.
     */
    get asV2(): {accountId: Uint8Array, amount: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A new candidate joined the list of candidates.
     */
    get asV3012(): {accountId: Uint8Array, amount: bigint, rewardsCut: number} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CollatorStakingNominatedEvent {
     ...
     * A new nomination was registered for a specific candidate.
     */
    get asV2(): {accountId: Uint8Array, collatorId: Uint8Array, amount: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CommunityPoolAwardedEvent {
     ...
     * Some funds have been allocated.
     */
    get asV2(): {proposalIndex: number, award: bigint, account: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CommunityPoolRejectedEvent {
     ...
     * A proposal was rejected; funds were slashed.
     */
    get asV2(): {proposalIndex: number, slashed: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CommunityPoolRolloverEvent {
     ...
     * Spending has finished; this is the amount that rolls over until next spend.
     */
    get asV2(): {rolloverBalance: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CommunityPoolSpendApprovedEvent {
     ...
     * A new spend proposal has been approved.
     */
    get asV3000(): {proposalIndex: number, amount: bigint, beneficiary: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CommunityPoolSpendingEvent {
     ...
     * We have ended a spend period and will now allocate funds.
     */
    get asV2(): {budgetRemaining: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilApprovedEvent {
     ...
     * A motion was approved by the required threshold.
     */
    get asV2(): {proposalHash: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilClosedEvent {
     ...
     * A proposal was closed because its threshold was reached or after its duration was up.
     */
    get asV2(): {proposalHash: Uint8Array, yes: number, no: number} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilExecutedEvent {
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV2(): {proposalHash: Uint8Array, result: v2.Type_28} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV3(): {proposalHash: Uint8Array, result: v3.Type_29} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class CouncilProposedEvent {
     ...
     * `MemberCount`).
     */
    get asV2(): {account: Uint8Array, proposalIndex: number, proposalHash: Uint8Array, threshold: number} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilVotedEvent {
     ...
     * a tally (yes votes and no votes given respectively as `MemberCount`).
     */
    get asV2(): {account: Uint8Array, proposalHash: Uint8Array, voted: boolean, yes: number, no: number} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CumulusXcmExecutedDownwardEvent {
     ...
     * \[ id, outcome \]
     */
    get asV2(): [Uint8Array, v2.V2Outcome] {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyDelegatedEvent {
     ...
     * An account has delegated their vote to another account.
     */
    get asV2(): {who: Uint8Array, target: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted.
     */
    get asV2(): {refIndex: number, result: v2.Type_28} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A proposal has been enacted.
     */
    get asV3(): {refIndex: number, result: v3.Type_29} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageInvalidEvent {
     ...
     * A proposal could not be executed because its preimage was invalid.
     */
    get asV2(): {proposalHash: Uint8Array, refIndex: number} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageNotedEvent {
     ...
     * A proposal's preimage was noted, and the deposit taken.
     */
    get asV2(): {proposalHash: Uint8Array, who: Uint8Array, deposit: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageReapedEvent {
     ...
     * A registered preimage was removed and the deposit collected by the reaper.
     */
    get asV2(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint, reaper: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageUsedEvent {
     ...
     * A proposal preimage was removed and used (the deposit was returned).
     */
    get asV2(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyProposedEvent {
     ...
     * A motion has been proposed by a public account.
     */
    get asV2(): {proposalIndex: number, deposit: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracySecondedEvent {
     ...
     * An account has secconded a proposal
     */
    get asV2(): {seconder: Uint8Array, propIndex: number} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyStartedEvent {
     ...
     * A referendum has begun.
     */
    get asV2(): {refIndex: number, threshold: v2.VoteThreshold} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyTabledEvent {
     ...
     * A public proposal has been tabled for referendum vote.
     */
    get asV2(): {proposalIndex: number, deposit: bigint, depositors: Uint8Array[]} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
...
export class DemocracyVetoedEvent {
     ...
     * An external proposal has been vetoed.
     */
    get asV2(): {who: Uint8Array, proposalHash: Uint8Array, until: number} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyVotedEvent {
     ...
     * An account has voted in a referendum
     */
    get asV2(): {voter: Uint8Array, refIndex: number, vote: v2.AccountVote} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DmpQueueExecutedDownwardEvent {
     ...
     * Downward message executed with the given outcome.
     */
    get asV3000(): {messageId: Uint8Array, outcome: v3000.V2Outcome} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DmpQueueInvalidFormatEvent {
     ...
     * Downward message is invalid XCM.
     */
    get asV3000(): {messageId: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class EfinityUtilityBatchPartiallyDispatchedEvent {
     ...
     * Indexes and errors of failing dispatch calls are provided.
     */
    get asV3012(): [number, v3012.DispatchError][] {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ExtrinsicPauseExtrinsicPausedEvent {
     ...
     * Extrinsic is paused.
     */
    get asV3000(): {palletName: Uint8Array, extrinsicName: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ExtrinsicPausePalletPausedEvent {
     ...
     * All pallet extrinsics are paused.
     */
    get asV3000(): {palletName: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksAccountAddedEvent {
     ...
     * An account was added to a `FuelTank`
     */
    get asV3000(): {tankId: Uint8Array, userId: Uint8Array, tankDeposit: bigint, userDeposit: bigint} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksAccountRemovedEvent {
     ...
     * An account was removed from a `FuelTank`
     */
    get asV3000(): {tankId: Uint8Array, userId: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksAccountRuleDataRemovedEvent {
     ...
     * Account data of `AccountId` was removed from `RuleSetId`
     */
    get asV3012(): {tankId: Uint8Array, userId: Uint8Array, ruleSetId: number, ruleKind: v3012.DispatchRuleKind} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksCallDispatchedEvent {
     ...
     * A call was dispatched through a `FuelTank`.
     */
    get asV3000(): {caller: Uint8Array, tankId: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksFreezeStateMutatedEvent {
     ...
     * The freeze state change for fuel tank or its rule set was executed in `on_finalize`
     */
    get asV3000(): {tankId: Uint8Array, ruleSetId: (number | undefined), isFrozen: boolean} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksFuelTankCreatedEvent {
     ...
     * A new `FuelTank` was created.
     */
    get asV3000(): {owner: Uint8Array, name: Uint8Array, tankId: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksFuelTankMutatedEvent {
     ...
     * A `FuelTank` was mutated
     */
    get asV3012(): {tankId: Uint8Array, mutation: v3012.DefaultTankMutation} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FuelTanksRuleSetInsertedEvent {
    ...
    get asV3000(): {tankId: Uint8Array, ruleSetId: number} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MarketplaceAuctionFinalizedEvent {
     ...
     * An auction was finalized
     */
    get asV3000(): {listingId: Uint8Array, winningBid: (v3000.Bid | undefined), protocolFee: bigint, royalty: bigint} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MarketplaceBidPlacedEvent {
     ...
     * A bid was placed
     */
    get asV3000(): {listingId: Uint8Array, bid: v3000.Bid} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MarketplaceListingCancelledEvent {
     ...
     * A listing was cancelled
     */
    get asV3000(): {listingId: Uint8Array} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MarketplaceListingCreatedEvent {
     ...
     * A listing was created
     */
    get asV3000(): {listingId: Uint8Array, listing: v3000.Listing} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MarketplaceListingFilledEvent {
     ...
     * A listing was filled or partially filled
     */
    get asV3000(): {listingId: Uint8Array, buyer: Uint8Array, amountFilled: bigint, amountRemaining: bigint, protocolFee: bigint, royalty: bigint} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MarketplaceProtocolFeeSetEvent {
     ...
     * Protocol fee was set
     */
    get asV3012(): {protocolFee: number} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsAssetAttributeSetEvent {
     ...
     * New asset attribute has been set for an asset. \[asset_id, key, value\]
     */
    get asV1(): [bigint, Uint8Array, Uint8Array] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTokenAttributeClearedEvent {
     ...
     * Token attribute has been cleared for an asset. \[asset_id, token, key\]
     */
    get asV1(): [bigint, number, Uint8Array] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTokenAttributeSetEvent {
     ...
     * New token attribute has been set for an asset. \[asset_id, token, key, value\]
     */
    get asV1(): [bigint, number, Uint8Array, Uint8Array] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTokensBurnedEvent {
     ...
     * `tokens` of `asset` from `account` were burned. \[ account, asset, tokens \]
     */
    get asV1(): [Uint8Array, bigint, v1.Range[]] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTokensMintedEvent {
     ...
     * New tokens were minted on asset. \[owner, asset, from_token, to_token \]
     */
    get asV1(): [Uint8Array, bigint, number, number] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTransferredBatchEvent {
     ...
     * The given `recipients` were transfer from `from` account. \[from, asset, recipients\]
     */
    get asV1(): [Uint8Array, bigint, v1.Recipient[]] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTransferredSingleEvent {
     ...
     * The given amount of `token` from `asset` was transferred. \[from, to, asset, token, amount\]
     */
    get asV1(): [Uint8Array, Uint8Array, bigint, (number | undefined), bigint] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsTransferredSingleChunkEvent {
     ...
     * \[source, destination, asset, chunk\]
     */
    get asV1(): [Uint8Array, Uint8Array, bigint, v1.Range[]] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsOperatorExtApprovedEvent {
     ...
     * Asset(s) were approved. If `asset` and `token` are None, it applies to all.
     */
    get asV1(): {owner: Uint8Array, operator: Uint8Array, asset: (bigint | undefined), token: (number | undefined), amount: (bigint | undefined), expiration: v1.Expiration} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiAssetsOperatorExtUnapprovedEvent {
     ...
     * Asset(s) were unapproved. If `asset` and `token` are None, it applies to all.
     */
    get asV1(): {owner: Uint8Array, operator: Uint8Array, asset: (bigint | undefined), token: (number | undefined)} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensApprovedEvent {
     ...
     * An approval took place. If `token_id` is `None`, it applies to the whole collection.
     */
    get asV2(): {collectionId: bigint, tokenId: (bigint | undefined), owner: Uint8Array, operator: Uint8Array, amount: (bigint | undefined), expiration: (number | undefined)} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensBalanceSetEvent {
     ...
     * The balance of an account was set
     */
    get asV3(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, balance: bigint, reservedBalance: bigint} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensBurnedEvent {
     ...
     * Units of a `Token` were burned
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, amount: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensCollectionAccountCreatedEvent {
     ...
     * A new `CollectionAccount` was created
     */
    get asV2(): {collectionId: bigint, accountId: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensCollectionAccountUpdatedEvent {
     ...
     * TokenAccount storage was set to `value`
     */
    get asV2(): {collectionId: bigint, accountId: Uint8Array, value: (v2.CollectionAccount | undefined)} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensCollectionCreatedEvent {
     ...
     * A new `Collection` was created
     */
    get asV2(): {collectionId: bigint, owner: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensCollectionDestroyedEvent {
     ...
     * A `Collection` was destroyed.
     */
    get asV2(): {collectionId: bigint, caller: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensCollectionMutatedEvent {
     ...
     * A `Collection` was mutated
     */
    get asV3012(): {collectionId: bigint, mutation: v3012.DefaultCollectionMutation} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensCollectionUpdatedEvent {
     ...
     * Collection storage was set to `value`
     */
    get asV3000(): {collectionId: bigint, value: (v3000.Collection | undefined)} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensDepositEvent {
     ...
     * Token units were deposited
     */
    get asV3(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, amount: bigint} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensMigrationStatusUpdatedEvent {
     ...
     * Migration stage updated
     */
    get asV3012(): {stage: v3012.MigrationStage} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensMintedEvent {
     ...
     * Units of a `Token` were minted
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, issuer: Uint8Array, recipient: Uint8Array, amount: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Units of a `Token` were minted
     */
    get asV3012(): {collectionId: bigint, tokenId: bigint, issuer: v3012.RootOrSigned, recipient: Uint8Array, amount: bigint} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensMovedReservesEvent {
     ...
     * Reserved token units were moved
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, source: Uint8Array, destination: Uint8Array, amount: bigint, reserveId: (Uint8Array | undefined)} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensReserveRepatriatedEvent {
     ...
     * Reserved token units were transferred
     */
    get asV3(): {collectionId: bigint, tokenId: bigint, source: Uint8Array, destination: Uint8Array, amount: bigint, reserveId: (Uint8Array | undefined)} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensReservedEvent {
     ...
     * Token units were reserved
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, amount: bigint, reserveId: (Uint8Array | undefined)} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenAccountCreatedEvent {
     ...
     * A new `TokenAccount` was created
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, balance: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenAccountDestroyedEvent {
     ...
     * A `TokenAccount` was destroyed
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenAccountUpdatedEvent {
     ...
     * TokenAccount storage was set to `value`
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, value: (v2.TokenAccount | undefined)} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * TokenAccount storage was set to `value`
     */
    get asV3(): {collectionId: bigint, tokenId: bigint, accountId: Uint8Array, value: (v3.TokenAccount | undefined)} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenCreatedEvent {
     ...
     * A `Token` was created
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, issuer: Uint8Array, initialSupply: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A `Token` was created
     */
    get asV3012(): {collectionId: bigint, tokenId: bigint, issuer: v3012.RootOrSigned, initialSupply: bigint} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenDestroyedEvent {
     ...
     * A `Token` was destroyed
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, caller: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenMutatedEvent {
     ...
     * A `Token` was mutated
     */
    get asV3012(): {collectionId: bigint, tokenId: bigint, mutation: v3012.DefaultTokenMutation} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTokenUpdatedEvent {
     ...
     * Token storage was set to `value`
     */
    get asV3012(): {collectionId: bigint, tokenId: bigint, value: (v3012.Token | undefined)} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensTransferredEvent {
     ...
     * Units of a `Token` were transferred
     */
    get asV2(): {collectionId: bigint, tokenId: bigint, operator: Uint8Array, from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultiTokensUnapprovedEvent {
     ...
     * An unapproval took place. If `token_id` is `None`, it applies to the collection.
     */
    get asV2(): {collectionId: bigint, tokenId: (bigint | undefined), owner: Uint8Array, operator: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultisigMultisigApprovalEvent {
     ...
     * A multisig operation has been approved by someone.
     */
    get asV2(): {approving: Uint8Array, timepoint: v2.Timepoint, multisig: Uint8Array, callHash: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultisigMultisigCancelledEvent {
     ...
     * A multisig operation has been cancelled.
     */
    get asV2(): {cancelling: Uint8Array, timepoint: v2.Timepoint, multisig: Uint8Array, callHash: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MultisigMultisigExecutedEvent {
     ...
     * A multisig operation has been executed.
     */
    get asV2(): {approving: Uint8Array, timepoint: v2.Timepoint, multisig: Uint8Array, callHash: Uint8Array, result: v2.Type_28} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A multisig operation has been executed.
     */
    get asV3(): {approving: Uint8Array, timepoint: v3.Timepoint, multisig: Uint8Array, callHash: Uint8Array, result: v3.Type_29} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class MultisigNewMultisigEvent {
     ...
     * A new multisig operation has begun.
     */
    get asV2(): {approving: Uint8Array, multisig: Uint8Array, callHash: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ParachainSystemValidationFunctionAppliedEvent {
     ...
     * The validation function was applied as of the contained relay chain block number.
     */
    get asV3000(): {relayChainBlockNum: number} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PolkadotXcmAssetsClaimedEvent {
     ...
     * \[ hash, origin, assets \]
     */
    get asV3012(): [Uint8Array, v3012.V1MultiLocation, v3012.VersionedMultiAssets] {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PoolsPoolFundTransferredEvent {
     ...
     * Funds have been transferred from pool.
     */
    get asV1(): [bigint, v1.PoolType, Uint8Array, bigint] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PoolsPoolOwnershipChangedEvent {
     ...
     * A new owner has been assigned to an existing pool.
     */
    get asV1(): [bigint, v1.PoolType, Uint8Array, Uint8Array] {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PoolsPoolsMutatedEvent {
    ...
    get asV3000(): v3000.PoolsMutation {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerCallLookupFailedEvent {
     ...
     * The call for the provided hash was not found so the task has been aborted.
     */
    get asV2(): {task: [number, number], id: (Uint8Array | undefined), error: v2.LookupError} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerCallUnavailableEvent {
     ...
     * The call for the provided hash was not found so the task has been aborted.
     */
    get asV3012(): {task: [number, number], id: (Uint8Array | undefined)} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     * Dispatched some task.
     */
    get asV2(): {task: [number, number], id: (Uint8Array | undefined), result: v2.Type_28} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Dispatched some task.
     */
    get asV3(): {task: [number, number], id: (Uint8Array | undefined), result: v3.Type_29} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class SudoKeyChangedEvent {
     ...
     * The \[sudoer\] just switched identity; the old key is supplied if one existed.
     */
    get asV2(): {oldSudoer: (Uint8Array | undefined)} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SudoSudidEvent {
     ...
     * A sudo just took place. \[result\]
     */
    get asV2(): {sudoResult: v2.Type_28} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A sudo just took place. \[result\]
     */
    get asV3(): {sudoResult: v3.Type_29} {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
...
export class SystemExtrinsicSuccessEvent {
     ...
     * An extrinsic completed successfully.
     */
    get asV2(): {dispatchInfo: v2.DispatchInfo} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
...
export class SystemRemarkedEvent {
     ...
     * On on-chain remark happened.
     */
    get asV2(): {sender: Uint8Array, hash: Uint8Array} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TagsAssetTaggedEvent {
     ...
     * `asset_id` was tagged with `tag_id`
     */
    get asV1(): {assetId: bigint, tagId: bigint} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TagsTagCreatedEvent {
     ...
     * A new `Tag` with `id` was created by `owner`
     */
    get asV1(): {id: bigint, owner: Uint8Array} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TransactionPaymentTransactionFeePaidEvent {
     ...
     * has been paid by `who`.
     */
    get asV3000(): {who: Uint8Array, actualFee: bigint, tip: bigint} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class UnknownTokensDepositedEvent {
     ...
     * Deposit success.
     */
    get asV3012(): {asset: v3012.V1MultiAsset, who: v3012.V1MultiLocation} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class VestingVestingScheduleAddedEvent {
     ...
     * Added new vesting schedule.
     */
    get asV2(): {from: Uint8Array, to: Uint8Array, vestingSchedule: v2.VestingSchedule} {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XTokensTransferredMultiAssetsEvent {
     ...
     * Transferred `MultiAsset` with fee.
     */
    get asV3012(): {sender: Uint8Array, assets: v3012.V1MultiAsset[], fee: v3012.V1MultiAsset, dest: v3012.V1MultiLocation} {
        assert(this.isV3012)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmpQueueBadFormatEvent {
     ...
     * Bad XCM format used.
     */
    get asV3000(): {messageHash: (Uint8Array | undefined)} {
        assert(this.isV3000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmpQueueFailEvent {
     ...
     * Some XCM failed.
     */
    get asV2(): [(Uint8Array | undefined), v2.V2Error] {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
...
export class XcmpQueueOverweightEnqueuedEvent {
     ...
     * An XCM exceeded the individual message weight budget.
     */
    get asV2(): [number, number, bigint, bigint] {
        assert(this.isV2)
        return this._chain.decodeEvent(this.event)
    }
