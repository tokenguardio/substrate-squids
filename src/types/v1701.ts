 ...
 */
export interface XcmTransactorCall_transact_through_signed_multilocation {
    __kind: 'transact_through_signed_multilocation'
    dest: VersionedMultiLocation
    feeLocation: VersionedMultiLocation
    destWeight: bigint
    call: Uint8Array
