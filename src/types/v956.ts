...
export type LedgerUpdateEntry = LedgerUpdateEntry_Substrate | LedgerUpdateEntry_Moonbeam
...
export type Ledger = Ledger_Substrate | Ledger_Moonbeam
...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_ParachainSystem | Call_Balances | Call_Authorship | Call_Session | Call_ParachainStaking | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_PhragmenElection | Call_CouncilMembership | Call_TechnicalMembership | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_Utility | Call_Scheduler | Call_Proxy | Call_Multisig | Call_Identity | Call_Vesting | Call_Treasury | Call_Bounties | Call_Tips | Call_Preimage | Call_XTokens | Call_Tokens | Call_Currencies | Call_OrmlXcm | Call_ZenlinkProtocol | Call_MerkleDistributor | Call_FlexibleFee | Call_Salp | Call_LiquidityMiningDOT | Call_LiquidityMining | Call_TokenIssuer | Call_LighteningRedeem | Call_SalpLite | Call_CallSwitchgear | Call_VSBondAuction | Call_AssetRegistry | Call_VtokenMinting | Call_Slp | Call_XcmInterface | Call_VstokenConversion | Call_Farming | Call_SystemStaking
...
export interface SubstrateValidatorsByDelegatorUpdateEntry {
    currencyId: CurrencyId
    delegatorId: V1MultiLocation
    validators: [V1MultiLocation, Uint8Array][]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetRegistryCall = AssetRegistryCall_register_foreign_asset | AssetRegistryCall_update_foreign_asset | AssetRegistryCall_register_native_asset | AssetRegistryCall_update_native_asset | AssetRegistryCall_register_token_metadata | AssetRegistryCall_register_vtoken_metadata | AssetRegistryCall_register_vstoken_metadata | AssetRegistryCall_register_vsbond_metadata | AssetRegistryCall_register_multilocation
...
export type Type_374 = Type_374_Members | Type_374_Member | Type_374__Phantom

export interface Type_374_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_374_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_374__Phantom {
    __kind: '_Phantom'
}

export type Type_375 = Type_375_Members | Type_375_Member | Type_375__Phantom

export interface Type_375_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_375_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_375__Phantom {
    __kind: '_Phantom'
}
...
export type Type_377 = Type_377_Relay | Type_377_SiblingParachain

export interface Type_377_Relay {
    __kind: 'Relay'
}

export interface Type_377_SiblingParachain {
...
export type MoonbeamLedgerUpdateOperation = MoonbeamLedgerUpdateOperation_Bond | MoonbeamLedgerUpdateOperation_BondLess | MoonbeamLedgerUpdateOperation_Revoke | MoonbeamLedgerUpdateOperation_CancelRequest | MoonbeamLedgerUpdateOperation_LeaveDelegator | MoonbeamLedgerUpdateOperation_CancelLeave | MoonbeamLedgerUpdateOperation_ExecuteLeave | MoonbeamLedgerUpdateOperation_ExecuteRequest
...
export type Type_356 = Type_356_V0 | Type_356_V1 | Type_356_V2

export interface Type_356_V0 {
    __kind: 'V0'
    value: Type_357
}

export interface Type_356_V1 {
    __kind: 'V1'
    value: Type_362
}

export interface Type_356_V2 {
    __kind: 'V2'
    value: Type_368[]
}
...
export type Type_455 = Type_455_Ongoing | Type_455_Retired | Type_455_Success | Type_455_Failed | Type_455_RefundWithdrew | Type_455_RedeemWithdrew | Type_455_FailedToContinue

export interface Type_455_Ongoing {
    __kind: 'Ongoing'
}

export interface Type_455_Retired {
    __kind: 'Retired'
}

export interface Type_455_Success {
    __kind: 'Success'
}

export interface Type_455_Failed {
    __kind: 'Failed'
}

export interface Type_455_RefundWithdrew {
    __kind: 'RefundWithdrew'
}

export interface Type_455_RedeemWithdrew {
    __kind: 'RedeemWithdrew'
}

export interface Type_455_FailedToContinue {
    __kind: 'FailedToContinue'
}
...
export type Type_357 = Type_357_WithdrawAsset | Type_357_ReserveAssetDeposit | Type_357_TeleportAsset | Type_357_QueryResponse | Type_357_TransferAsset | Type_357_TransferReserveAsset | Type_357_Transact | Type_357_HrmpNewChannelOpenRequest | Type_357_HrmpChannelAccepted | Type_357_HrmpChannelClosing | Type_357_RelayedFrom
...
export interface Type_357_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_359[]
}

export interface Type_357_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_359[]
}
...
export interface Type_357_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_357
}

export type Type_362 = Type_362_WithdrawAsset | Type_362_ReserveAssetDeposited | Type_362_ReceiveTeleportedAsset | Type_362_QueryResponse | Type_362_TransferAsset | Type_362_TransferReserveAsset | Type_362_Transact | Type_362_HrmpNewChannelOpenRequest | Type_362_HrmpChannelAccepted | Type_362_HrmpChannelClosing | Type_362_RelayedFrom | Type_362_SubscribeVersion | Type_362_UnsubscribeVersion
...
export interface Type_362_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_364[]
}

export interface Type_362_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_364[]
}
...
export interface Type_362_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_362_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_368 = Type_368_WithdrawAsset | Type_368_ReserveAssetDeposited | Type_368_ReceiveTeleportedAsset | Type_368_QueryResponse | Type_368_TransferAsset | Type_368_TransferReserveAsset | Type_368_Transact | Type_368_HrmpNewChannelOpenRequest | Type_368_HrmpChannelAccepted | Type_368_HrmpChannelClosing | Type_368_ClearOrigin | Type_368_DescendOrigin | Type_368_ReportError | Type_368_DepositAsset | Type_368_DepositReserveAsset | Type_368_ExchangeAsset | Type_368_InitiateReserveWithdraw | Type_368_InitiateTeleport | Type_368_QueryHolding | Type_368_BuyExecution | Type_368_RefundSurplus | Type_368_SetErrorHandler | Type_368_SetAppendix | Type_368_ClearError | Type_368_ClaimAsset | Type_368_Trap | Type_368_SubscribeVersion | Type_368_UnsubscribeVersion
...
export type Type_359 = Type_359_Null | Type_359_DepositAsset | Type_359_DepositReserveAsset | Type_359_ExchangeAsset | Type_359_InitiateReserveWithdraw | Type_359_InitiateTeleport | Type_359_QueryHolding | Type_359_BuyExecution

export interface Type_359_Null {
    __kind: 'Null'
}
...
export interface Type_359_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Type_364 = Type_364_Noop | Type_364_DepositAsset | Type_364_DepositReserveAsset | Type_364_ExchangeAsset | Type_364_InitiateReserveWithdraw | Type_364_InitiateTeleport | Type_364_QueryHolding | Type_364_BuyExecution

export interface Type_364_Noop {
    __kind: 'Noop'
}
