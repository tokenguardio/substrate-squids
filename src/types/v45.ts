...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_115
    maxValidatorCount: Type_115
    chillThreshold: Type_116
    minCommission: Type_117
}
...
export interface NominationPoolsCall_update_roles {
    ...
    poolId: number
    newRoot: Type_148
    newNominator: Type_148
    newStateToggler: Type_148
}
