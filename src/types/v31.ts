...
export type VoteStage = VoteStage_PreVoting | VoteStage_Commit | VoteStage_Voting | VoteStage_Completed

export interface VoteStage_PreVoting {
    __kind: 'PreVoting'
}

export interface VoteStage_Commit {
    __kind: 'Commit'
}

export interface VoteStage_Voting {
    __kind: 'Voting'
}

export interface VoteStage_Completed {
    __kind: 'Completed'
}

export type VoteType = VoteType_Binary | VoteType_MultiOption | VoteType_RankedChoice

export interface VoteType_Binary {
    __kind: 'Binary'
}

export interface VoteType_MultiOption {
    __kind: 'MultiOption'
}

export interface VoteType_RankedChoice {
    __kind: 'RankedChoice'
}
...
export type Proposal = Proposal_System | Proposal_Utility | Proposal_Timestamp | Proposal_Authorship | Proposal_Indices | Proposal_Balances | Proposal_Staking | Proposal_Session | Proposal_Democracy | Proposal_Council | Proposal_Elections | Proposal_FinalityTracker | Proposal_Grandpa | Proposal_Treasury | Proposal_Contracts | Proposal_Identity | Proposal_ImOnline | Proposal_AuthorityDiscovery | Proposal_Offences | Proposal_RandomnessCollectiveFlip | Proposal_Nicks | Proposal_Sudo | Proposal_Vesting | Proposal_Signaling | Proposal_Voting | Proposal_TreasuryReward
...
export interface Proposal_Signaling {
    __kind: 'Signaling'
    value: SignalingCall
}

export interface Proposal_Voting {
    __kind: 'Voting'
    value: VotingCall
}
...
export type TallyType = TallyType_OnePerson | TallyType_OneCoin

export interface TallyType_OnePerson {
    __kind: 'OnePerson'
}

export interface TallyType_OneCoin {
    __kind: 'OneCoin'
}
...
export type Type_41 = Type_41_System | Type_41_Utility | Type_41_Timestamp | Type_41_Authorship | Type_41_Indices | Type_41_Balances | Type_41_Staking | Type_41_Session | Type_41_Democracy | Type_41_Council | Type_41_Elections | Type_41_FinalityTracker | Type_41_Grandpa | Type_41_Treasury | Type_41_Contracts | Type_41_Identity | Type_41_ImOnline | Type_41_AuthorityDiscovery | Type_41_Offences | Type_41_RandomnessCollectiveFlip | Type_41_Nicks | Type_41_Sudo | Type_41_Vesting | Type_41_Signaling | Type_41_Voting | Type_41_TreasuryReward

export interface Type_41_System {
    __kind: 'System'
    value: SystemCall
}

export interface Type_41_Utility {
    __kind: 'Utility'
    value: UtilityCall
}

export interface Type_41_Timestamp {
    __kind: 'Timestamp'
    value: TimestampCall
}

export interface Type_41_Authorship {
    __kind: 'Authorship'
    value: AuthorshipCall
}

export interface Type_41_Indices {
    __kind: 'Indices'
    value: IndicesCall
}

export interface Type_41_Balances {
    __kind: 'Balances'
    value: BalancesCall
}

export interface Type_41_Staking {
    __kind: 'Staking'
    value: StakingCall
}

export interface Type_41_Session {
    __kind: 'Session'
    value: SessionCall
}

export interface Type_41_Democracy {
    __kind: 'Democracy'
    value: DemocracyCall
}

export interface Type_41_Council {
    __kind: 'Council'
    value: CouncilCall
}

export interface Type_41_Elections {
    __kind: 'Elections'
    value: ElectionsCall
}

export interface Type_41_FinalityTracker {
    __kind: 'FinalityTracker'
    value: FinalityTrackerCall
}

export interface Type_41_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaCall
}

export interface Type_41_Treasury {
    __kind: 'Treasury'
    value: TreasuryCall
}

export interface Type_41_Contracts {
    __kind: 'Contracts'
    value: ContractsCall
}

export interface Type_41_Identity {
    __kind: 'Identity'
    value: IdentityCall
}

export interface Type_41_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineCall
}

export interface Type_41_AuthorityDiscovery {
    __kind: 'AuthorityDiscovery'
    value: AuthorityDiscoveryCall
}

export interface Type_41_Offences {
    __kind: 'Offences'
    value: OffencesCall
}

export interface Type_41_RandomnessCollectiveFlip {
    __kind: 'RandomnessCollectiveFlip'
    value: RandomnessCollectiveFlipCall
}

export interface Type_41_Nicks {
    __kind: 'Nicks'
    value: NicksCall
}

export interface Type_41_Sudo {
    __kind: 'Sudo'
    value: SudoCall
}

export interface Type_41_Vesting {
    __kind: 'Vesting'
    value: VestingCall
}

export interface Type_41_Signaling {
    __kind: 'Signaling'
    value: SignalingCall
}

export interface Type_41_Voting {
    __kind: 'Voting'
    value: VotingCall
}

export interface Type_41_TreasuryReward {
    __kind: 'TreasuryReward'
    value: TreasuryRewardCall
}
...
export interface HostFnWeights {
    ...
    inputPerByte: number
    return: number
    returnPerByte: number
    terminate: number
    terminatePerCodeByte: number
    restoreTo: number
    restoreToPerCallerCodeByte: number
    restoreToPerTombstoneCodeByte: number
    restoreToPerDelta: number
    random: number
    depositEvent: number
    depositEventPerTopic: number
    depositEventPerByte: number
    setRentAllowance: number
    setStorage: number
    setStoragePerByte: number
    clearStorage: number
    getStorage: number
    getStoragePerByte: number
    transfer: number
    call: number
    callPerCodeByte: number
    callTransferSurcharge: number
    callPerInputByte: number
    callPerOutputByte: number
    instantiate: number
    instantiatePerCodeByte: number
    instantiatePerInputByte: number
    instantiatePerOutputByte: number
    instantiatePerSaltByte: number
    hashSha2256: number
    hashSha2256PerByte: number
    hashKeccak256: number
    hashKeccak256PerByte: number
    hashBlake2256: number
    hashBlake2256PerByte: number
    hashBlake2128: number
    hashBlake2128PerByte: number
    rentParams: number
}
...
export type VestingCall = VestingCall_vest | VestingCall_vest_other
...
export type SignalingCall = SignalingCall_create_proposal | SignalingCall_advance_proposal

/**
 *  Creates a new signaling proposal.
 */
export interface SignalingCall_create_proposal {
    __kind: 'create_proposal'
    title: Uint8Array
    contents: Uint8Array
    outcomes: Uint8Array[]
    voteType: VoteType
 ...
 */
export interface SignalingCall_advance_proposal {
    __kind: 'advance_proposal'
    proposalHash: Uint8Array
}

export type VotingCall = VotingCall_commit | VotingCall_reveal
 ...
 *  commitment.
 */
export interface VotingCall_commit {
    __kind: 'commit'
    voteId: bigint
    commit: Uint8Array
}
 ...
 */
export interface VotingCall_reveal {
    __kind: 'reveal'
    voteId: bigint
    vote: Uint8Array[]
...
export type TreasuryRewardCall = never
