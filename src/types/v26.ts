 ...
 *      zero in this vector are sold. Must have the same length as amounts.
 */
export interface PredictionMarketsCall_deploy_swap_pool_and_additional_liqudity {
    __kind: 'deploy_swap_pool_and_additional_liqudity'
    marketId: bigint
    amounts: bigint[]
    weights: bigint[]
    keep: bigint[]
