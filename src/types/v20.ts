...
export type Call = Call_System | Call_Scheduler | Call_Timestamp | Call_Balances | Call_Authorship | Call_Staking | Call_Session | Call_Elections | Call_Treasury | Call_Vesting | Call_Utility | Call_Multisig | Call_Sudo | Call_Contracts | Call_NominationPools | Call_Identity
...
export type Type_132 = Type_132_Noop | Type_132_Set | Type_132_Remove
...
export interface NominationPoolsCall_update_roles {
    ...
    poolId: number
    newRoot: Type_133
    newNominator: Type_133
    newStateToggler: Type_133
}
