...
export interface ContractStakeAmount {
    staked: StakeAmount
    stakedFuture: (StakeAmount | undefined)
}
...
export interface DAppInfo {
    owner: Uint8Array
    id: number
    rewardBeneficiary: (Uint8Array | undefined)
}
...
export type MigrationState = MigrationState_NotInProgress | MigrationState_RegisteredDApps | MigrationState_Ledgers | MigrationState_Cleanup | MigrationState_Finished

export interface MigrationState_NotInProgress {
    __kind: 'NotInProgress'
}

export interface MigrationState_RegisteredDApps {
    __kind: 'RegisteredDApps'
}

export interface MigrationState_Ledgers {
    __kind: 'Ledgers'
}

export interface MigrationState_Cleanup {
    __kind: 'Cleanup'
}

export interface MigrationState_Finished {
    __kind: 'Finished'
}
...
export type RuntimeFreezeReason = RuntimeFreezeReason_DappStaking

export interface RuntimeFreezeReason_DappStaking {
    __kind: 'DappStaking'
    value: FreezeReason
}
...
export type TierThreshold = TierThreshold_FixedTvlAmount | TierThreshold_DynamicTvlAmount

export interface TierThreshold_FixedTvlAmount {
    __kind: 'FixedTvlAmount'
    amount: bigint
}

export interface TierThreshold_DynamicTvlAmount {
    __kind: 'DynamicTvlAmount'
    amount: bigint
...
export type FreezeReason = FreezeReason_DAppStaking

export interface FreezeReason_DAppStaking {
    __kind: 'DAppStaking'
}
