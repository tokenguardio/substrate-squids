 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type SlpxCall = SlpxCall_add_whitelist | SlpxCall_mint | SlpxCall_redeem | SlpxCall_remove_whitelist | SlpxCall_set_currency_ethereum_call_switch | SlpxCall_set_currency_support_xcm_fee | SlpxCall_set_ethereum_call_configration | SlpxCall_set_execution_fee | SlpxCall_set_transfer_to_fee | SlpxCall_stable_pool_swap | SlpxCall_zenlink_swap
