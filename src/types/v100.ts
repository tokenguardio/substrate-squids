...
export type Call = Call_System | Call_Timestamp | Call_Balances | Call_Treasury | Call_Utility | Call_ParachainSystem | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Sudo
