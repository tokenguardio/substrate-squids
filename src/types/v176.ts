...
export const Type_332: sts.Type<Type_332> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_332 {
    encoded: Bytes
}
...
export const Type_331: sts.Type<Type_331> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_331),
        SetErrorHandler: sts.array(() => Type_331),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_331 = Type_331_BuyExecution | Type_331_ClaimAsset | Type_331_ClearError | Type_331_ClearOrigin | Type_331_DepositAsset | Type_331_DepositReserveAsset | Type_331_DescendOrigin | Type_331_ExchangeAsset | Type_331_HrmpChannelAccepted | Type_331_HrmpChannelClosing | Type_331_HrmpNewChannelOpenRequest | Type_331_InitiateReserveWithdraw | Type_331_InitiateTeleport | Type_331_QueryHolding | Type_331_QueryResponse | Type_331_ReceiveTeleportedAsset | Type_331_RefundSurplus | Type_331_ReportError | Type_331_ReserveAssetDeposited | Type_331_SetAppendix | Type_331_SetErrorHandler | Type_331_SubscribeVersion | Type_331_Transact | Type_331_TransferAsset | Type_331_TransferReserveAsset | Type_331_Trap | Type_331_UnsubscribeVersion | Type_331_WithdrawAsset
...
export interface Type_331_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_331_ClearError {
    __kind: 'ClearError'
}

export interface Type_331_ClearOrigin {
    __kind: 'ClearOrigin'
}
...
export interface Type_331_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}
...
export interface Type_331_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_331_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_331_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_331[]
}

export interface Type_331_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_331[]
}
...
export interface Type_331_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_328 = Type_328_V2 | Type_328_V3
