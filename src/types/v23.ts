...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        BaseFee: BaseFeeCall,
        BlockReward: BlockRewardCall,
        CollatorSelection: CollatorSelectionCall,
        DappsStaking: DappsStakingCall,
...
export const VestingCall: sts.Type<VestingCall> = sts.closedEnum(() => {
    return  {
        force_update_schedules: sts.enumStruct({
            target: MultiAddress,
            schedules: sts.array(() => VestingInfo),
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestingCall = VestingCall_force_update_schedules | VestingCall_force_vested_transfer | VestingCall_merge_schedules | VestingCall_vest | VestingCall_vest_other | VestingCall_vested_transfer
...
export const Type_267: sts.Type<Type_267> = sts.closedEnum(() => {
    return  {
        EthereumTransaction: H160,
    }
})

export type Type_267 = Type_267_EthereumTransaction

export interface Type_267_EthereumTransaction {
...
export const PolkadotXcmCall: sts.Type<PolkadotXcmCall> = sts.closedEnum(() => {
    return  {
        ...
        limited_reserve_withdraw_assets: sts.enumStruct({
            dest: VersionedMultiLocation,
            beneficiary: VersionedMultiLocation,
            assets: VersionedMultiAssets,
            feeAssetItem: sts.number(),
        ...
        reserve_withdraw_assets: sts.enumStruct({
            dest: VersionedMultiLocation,
            beneficiary: VersionedMultiLocation,
            assets: VersionedMultiAssets,
            feeAssetItem: sts.number(),
...
export const Type_230: sts.Type<Type_230> = sts.closedEnum(() => {
    return  {
        V0: Type_231,
        V1: Type_236,
        V2: sts.array(() => Type_242),
    }
})

export const Type_242: sts.Type<Type_242> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V1MultiAsset,
            weightLimit: V2WeightLimit,
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_242),
        SetErrorHandler: sts.array(() => Type_242),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_235: sts.Type<Type_235> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export type Type_242 = Type_242_BuyExecution | Type_242_ClaimAsset | Type_242_ClearError | Type_242_ClearOrigin | Type_242_DepositAsset | Type_242_DepositReserveAsset | Type_242_DescendOrigin | Type_242_ExchangeAsset | Type_242_HrmpChannelAccepted | Type_242_HrmpChannelClosing | Type_242_HrmpNewChannelOpenRequest | Type_242_InitiateReserveWithdraw | Type_242_InitiateTeleport | Type_242_QueryHolding | Type_242_QueryResponse | Type_242_ReceiveTeleportedAsset | Type_242_RefundSurplus | Type_242_ReportError | Type_242_ReserveAssetDeposited | Type_242_SetAppendix | Type_242_SetErrorHandler | Type_242_SubscribeVersion | Type_242_Transact | Type_242_TransferAsset | Type_242_TransferReserveAsset | Type_242_Trap | Type_242_UnsubscribeVersion | Type_242_WithdrawAsset

export interface Type_242_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_242_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_242_ClearError {
    __kind: 'ClearError'
}

export interface Type_242_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_242_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_242_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_242_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_242_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}
...
export interface Type_242_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_242_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_242_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_242_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_242_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_242_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_242[]
}

export interface Type_242_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_242[]
}
...
export interface Type_242_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export const Type_236: sts.Type<Type_236> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export const Type_238: sts.Type<Type_238> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V1MultiAsset,
            weight: sts.bigint(),
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_236),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_238 = Type_238_BuyExecution | Type_238_DepositAsset | Type_238_DepositReserveAsset | Type_238_ExchangeAsset | Type_238_InitiateReserveWithdraw | Type_238_InitiateTeleport | Type_238_Noop | Type_238_QueryHolding
...
export interface Type_238_Noop {
    __kind: 'Noop'
}
...
export type Type_236 = Type_236_HrmpChannelAccepted | Type_236_HrmpChannelClosing | Type_236_HrmpNewChannelOpenRequest | Type_236_QueryResponse | Type_236_ReceiveTeleportedAsset | Type_236_RelayedFrom | Type_236_ReserveAssetDeposited | Type_236_SubscribeVersion | Type_236_Transact | Type_236_TransferAsset | Type_236_TransferReserveAsset | Type_236_UnsubscribeVersion | Type_236_WithdrawAsset

export interface Type_236_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_236_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_236_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_236_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V1Response
}

export interface Type_236_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_238[]
}

export interface Type_236_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_236
}

export interface Type_236_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_238[]
}

export interface Type_236_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_236_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_235
...
export interface Type_236_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_236_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_236_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_236_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V1MultiAsset[]
    effects: Type_238[]
}
...
export type Type_233 = Type_233_BuyExecution | Type_233_DepositAsset | Type_233_DepositReserveAsset | Type_233_ExchangeAsset | Type_233_InitiateReserveWithdraw | Type_233_InitiateTeleport | Type_233_Null | Type_233_QueryHolding

export interface Type_233_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export interface Type_233_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_233_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_233_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_233_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_233_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_233_Null {
    __kind: 'Null'
}

export interface Type_233_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Type_231 = Type_231_HrmpChannelAccepted | Type_231_HrmpChannelClosing | Type_231_HrmpNewChannelOpenRequest | Type_231_QueryResponse | Type_231_RelayedFrom | Type_231_ReserveAssetDeposit | Type_231_TeleportAsset | Type_231_Transact | Type_231_TransferAsset | Type_231_TransferReserveAsset | Type_231_WithdrawAsset
...
export interface Type_231_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_231
}

export interface Type_231_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_233[]
}

export interface Type_231_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_233[]
}
...
export type Type_230 = Type_230_V0 | Type_230_V1 | Type_230_V2

export interface Type_230_V0 {
    __kind: 'V0'
    value: Type_231
}

export interface Type_230_V1 {
    __kind: 'V1'
    value: Type_236
}

export interface Type_230_V2 {
    __kind: 'V2'
    value: Type_242[]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const EthCallCall: sts.Type<EthCallCall> = sts.closedEnum(() => {
    return  {
        call: sts.enumStruct({
            call: Call,
            signer: AccountId32,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const DappsStakingCall: sts.Type<DappsStakingCall> = sts.closedEnum(() => {
    return  {
        bond_and_stake: sts.enumStruct({
            contractId: SmartContract,
            value: sts.bigint(),
        }),
        claim_dapp: sts.enumStruct({
            contractId: SmartContract,
            era: sts.number(),
        }),
        claim_staker: sts.enumStruct({
            contractId: SmartContract,
        }),
        developer_pre_approval: sts.enumStruct({
            developer: AccountId32,
        }),
        enable_developer_pre_approval: sts.enumStruct({
            enabled: sts.boolean(),
        }),
        ...
        nomination_transfer: sts.enumStruct({
        ...
        set_contract_stake_info: sts.enumStruct({
            contract: SmartContract,
            era: sts.number(),
            contractStakeInfo: ContractStakeInfo,
        }),
        set_reward_destination: sts.enumStruct({
        ...
        withdraw_from_unregistered: sts.enumStruct({
            contractId: SmartContract,
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DappsStakingCall = DappsStakingCall_bond_and_stake | DappsStakingCall_claim_dapp | DappsStakingCall_claim_staker | DappsStakingCall_developer_pre_approval | DappsStakingCall_enable_developer_pre_approval | DappsStakingCall_force_new_era | DappsStakingCall_maintenance_mode | DappsStakingCall_nomination_transfer | DappsStakingCall_register | DappsStakingCall_set_contract_stake_info | DappsStakingCall_set_reward_destination | DappsStakingCall_unbond_and_unstake | DappsStakingCall_unregister | DappsStakingCall_withdraw_from_unregistered | DappsStakingCall_withdraw_unbonded
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const BlockRewardCall: sts.Type<BlockRewardCall> = sts.closedEnum(() => {
    return  {
        set_configuration: sts.enumStruct({
            rewardDistroParams: RewardDistributionConfig,
        }),
    }
})

export const RewardDistributionConfig: sts.Type<RewardDistributionConfig> = sts.struct(() => {
    return  {
        baseTreasuryPercent: sts.number(),
        baseStakerPercent: sts.number(),
        dappsPercent: sts.number(),
        collatorsPercent: sts.number(),
        adjustablePercent: sts.number(),
        idealDappsStakingTvl: sts.number(),
    }
})
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BaseFeeCall = BaseFeeCall_set_base_fee_per_gas | BaseFeeCall_set_elasticity | BaseFeeCall_set_is_active
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsCall = AssetsCall_approve_transfer | AssetsCall_burn | AssetsCall_cancel_approval | AssetsCall_clear_metadata | AssetsCall_create | AssetsCall_destroy | AssetsCall_force_asset_status | AssetsCall_force_cancel_approval | AssetsCall_force_clear_metadata | AssetsCall_force_create | AssetsCall_force_set_metadata | AssetsCall_force_transfer | AssetsCall_freeze | AssetsCall_freeze_asset | AssetsCall_mint | AssetsCall_refund | AssetsCall_set_metadata | AssetsCall_set_team | AssetsCall_thaw | AssetsCall_thaw_asset | AssetsCall_touch | AssetsCall_transfer | AssetsCall_transfer_approved | AssetsCall_transfer_keep_alive | AssetsCall_transfer_ownership
...
export type Call = Call_Assets | Call_Authorship | Call_Balances | Call_BaseFee | Call_BlockReward | Call_CollatorSelection | Call_DappsStaking | Call_DmpQueue | Call_EVM | Call_EthCall | Call_Ethereum | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_PolkadotXcm | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting | Call_XcAssetConfig | Call_XcmpQueue
