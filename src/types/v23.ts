...
export type Type_44 = Type_44_AuthorityDiscovery | Type_44_Authorship | Type_44_Babe | Type_44_Balances | Type_44_Claims | Type_44_Council | Type_44_Democracy | Type_44_DummyAttestations | Type_44_DummyParachains | Type_44_DummyRegistrar | Type_44_DummySlots | Type_44_ElectionsPhragmen | Type_44_FinalityTracker | Type_44_Grandpa | Type_44_Identity | Type_44_ImOnline | Type_44_Indices | Type_44_Multisig | Type_44_Offences | Type_44_Proxy | Type_44_Purchase | Type_44_Scheduler | Type_44_Session | Type_44_Staking | Type_44_System | Type_44_TechnicalCommittee | Type_44_TechnicalMembership | Type_44_Timestamp | Type_44_Treasury | Type_44_Utility | Type_44_Vesting
...
export interface Type_44_DummyAttestations {
    __kind: 'DummyAttestations'
    value: DummyAttestationsCall
}

export interface Type_44_DummyParachains {
    __kind: 'DummyParachains'
    value: DummyParachainsCall
}

export interface Type_44_DummyRegistrar {
    __kind: 'DummyRegistrar'
    value: DummyRegistrarCall
}

export interface Type_44_DummySlots {
    __kind: 'DummySlots'
...
export const DummySlotsCall: sts.Type<DummySlotsCall> = sts.closedEnum(() => {
    return  {
    }
})

export const DummyRegistrarCall: sts.Type<DummyRegistrarCall> = sts.closedEnum(() => {
    return  {
    }
})

export const DummyParachainsCall: sts.Type<DummyParachainsCall> = sts.closedEnum(() => {
    return  {
    }
})

export const DummyAttestationsCall: sts.Type<DummyAttestationsCall> = sts.closedEnum(() => {
    return  {
    }
})
