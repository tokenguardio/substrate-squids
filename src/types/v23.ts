...
export type Proposal = Proposal_System | Proposal_Timestamp | Proposal_Balances | Proposal_Treasury | Proposal_AdvisoryCommitteeCollective | Proposal_AdvisoryCommitteeMembership | Proposal_Identity | Proposal_Sudo | Proposal_Utility | Proposal_Currency | Proposal_LiquidityMining | Proposal_Swaps | Proposal_PredictionMarkets | Proposal_ParachainSystem | Proposal_ParachainStaking | Proposal_AuthorInherent | Proposal_AuthorMapping | Proposal_DmpQueue | Proposal_PolkadotXcm | Proposal_XcmpQueue | Proposal_Crowdloan
...
export type Type_61 = Type_61_System | Type_61_Timestamp | Type_61_Balances | Type_61_Treasury | Type_61_AdvisoryCommitteeCollective | Type_61_AdvisoryCommitteeMembership | Type_61_Identity | Type_61_Sudo | Type_61_Utility | Type_61_Currency | Type_61_LiquidityMining | Type_61_Swaps | Type_61_PredictionMarkets | Type_61_ParachainSystem | Type_61_ParachainStaking | Type_61_AuthorInherent | Type_61_AuthorMapping | Type_61_DmpQueue | Type_61_PolkadotXcm | Type_61_XcmpQueue | Type_61_Crowdloan

export interface Type_61_System {
    __kind: 'System'
    value: SystemCall
}

export interface Type_61_Timestamp {
    __kind: 'Timestamp'
    value: TimestampCall
}

export interface Type_61_Balances {
    __kind: 'Balances'
    value: BalancesCall
}

export interface Type_61_Treasury {
    __kind: 'Treasury'
    value: TreasuryCall
}

export interface Type_61_AdvisoryCommitteeCollective {
    __kind: 'AdvisoryCommitteeCollective'
    value: AdvisoryCommitteeCollectiveCall
}

export interface Type_61_AdvisoryCommitteeMembership {
    __kind: 'AdvisoryCommitteeMembership'
    value: AdvisoryCommitteeMembershipCall
}

export interface Type_61_Identity {
    __kind: 'Identity'
    value: IdentityCall
}

export interface Type_61_Sudo {
    __kind: 'Sudo'
    value: SudoCall
}

export interface Type_61_Utility {
    __kind: 'Utility'
    value: UtilityCall
}

export interface Type_61_Currency {
    __kind: 'Currency'
    value: CurrencyCall
}

export interface Type_61_LiquidityMining {
    __kind: 'LiquidityMining'
    value: LiquidityMiningCall
}

export interface Type_61_Swaps {
    __kind: 'Swaps'
    value: SwapsCall
}

export interface Type_61_PredictionMarkets {
    __kind: 'PredictionMarkets'
    value: PredictionMarketsCall
}

export interface Type_61_ParachainSystem {
    __kind: 'ParachainSystem'
    value: ParachainSystemCall
}

export interface Type_61_ParachainStaking {
    __kind: 'ParachainStaking'
    value: ParachainStakingCall
}

export interface Type_61_AuthorInherent {
    __kind: 'AuthorInherent'
    value: AuthorInherentCall
}

export interface Type_61_AuthorMapping {
    __kind: 'AuthorMapping'
    value: AuthorMappingCall
}

export interface Type_61_DmpQueue {
    __kind: 'DmpQueue'
    value: DmpQueueCall
}

export interface Type_61_PolkadotXcm {
    __kind: 'PolkadotXcm'
    value: PolkadotXcmCall
}

export interface Type_61_XcmpQueue {
    __kind: 'XcmpQueue'
    value: XcmpQueueCall
}

export interface Type_61_Crowdloan {
    __kind: 'Crowdloan'
    value: CrowdloanCall
}
...
export type JurorStatus = JurorStatus_Ok | JurorStatus_Tardy

export interface JurorStatus_Ok {
    __kind: 'Ok'
}

export interface JurorStatus_Tardy {
    __kind: 'Tardy'
}
...
export interface PredictionMarketsCall_create_cpmm_market_and_deploy_assets {
    ...
    amount: bigint
    weights: bigint[]
    poolJoinAdditionalAssets: [Asset, bigint, bigint][]
    mdm: MarketDisputeMechanism
}
