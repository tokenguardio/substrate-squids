...
export const setMetadata =  {
    ...
    v205: new CallType(
        ...
        sts.struct({
            ...
            maybeHash: sts.option(() => v205.H256),
        })
    ),
}

export const forceRemoveVote =  {
    name: 'Democracy.force_remove_vote',
    /**
