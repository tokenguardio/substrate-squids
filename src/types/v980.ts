...
export type Type_362 = Type_362_Member | Type_362_Members | Type_362__Phantom

export interface Type_362_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_362_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_362__Phantom {
    __kind: '_Phantom'
}
...
export type Type_364 = Type_364_Relay | Type_364_SiblingParachain

export interface Type_364_Relay {
    __kind: 'Relay'
}

export interface Type_364_SiblingParachain {
...
export interface Type_361_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_361__Phantom {
    __kind: '_Phantom'
}
...
export const Type_348: sts.Type<Type_348> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_351),
        V3: sts.array(() => Type_355),
    }
})

export const Type_355: sts.Type<Type_355> = sts.closedEnum(() => {
    return  {
        AliasOrigin: V3MultiLocation,
        BurnAsset: sts.array(() => V3MultiAsset),
        BuyExecution: sts.enumStruct({
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_355),
        SetErrorHandler: sts.array(() => Type_355),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_352: sts.Type<Type_352> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_352 {
    encoded: Bytes
}

export type Type_355 = Type_355_AliasOrigin | Type_355_BurnAsset | Type_355_BuyExecution | Type_355_ClaimAsset | Type_355_ClearError | Type_355_ClearOrigin | Type_355_ClearTopic | Type_355_ClearTransactStatus | Type_355_DepositAsset | Type_355_DepositReserveAsset | Type_355_DescendOrigin | Type_355_ExchangeAsset | Type_355_ExpectAsset | Type_355_ExpectError | Type_355_ExpectOrigin | Type_355_ExpectPallet | Type_355_ExpectTransactStatus | Type_355_ExportMessage | Type_355_HrmpChannelAccepted | Type_355_HrmpChannelClosing | Type_355_HrmpNewChannelOpenRequest | Type_355_InitiateReserveWithdraw | Type_355_InitiateTeleport | Type_355_LockAsset | Type_355_NoteUnlockable | Type_355_QueryPallet | Type_355_QueryResponse | Type_355_ReceiveTeleportedAsset | Type_355_RefundSurplus | Type_355_ReportError | Type_355_ReportHolding | Type_355_ReportTransactStatus | Type_355_RequestUnlock | Type_355_ReserveAssetDeposited | Type_355_SetAppendix | Type_355_SetErrorHandler | Type_355_SetFeesMode | Type_355_SetTopic | Type_355_SubscribeVersion | Type_355_Transact | Type_355_TransferAsset | Type_355_TransferReserveAsset | Type_355_Trap | Type_355_UniversalOrigin | Type_355_UnlockAsset | Type_355_UnpaidExecution | Type_355_UnsubscribeVersion | Type_355_WithdrawAsset

export interface Type_355_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_355_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_355_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_355_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_355_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_355_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_355_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_355_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_355_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_355_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_355_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_355_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_355_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_355_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_355_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_355_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_355_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_355_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_355_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_355_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_355_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export const Type_351: sts.Type<Type_351> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_351),
        SetErrorHandler: sts.array(() => Type_351),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_351 = Type_351_BuyExecution | Type_351_ClaimAsset | Type_351_ClearError | Type_351_ClearOrigin | Type_351_DepositAsset | Type_351_DepositReserveAsset | Type_351_DescendOrigin | Type_351_ExchangeAsset | Type_351_HrmpChannelAccepted | Type_351_HrmpChannelClosing | Type_351_HrmpNewChannelOpenRequest | Type_351_InitiateReserveWithdraw | Type_351_InitiateTeleport | Type_351_QueryHolding | Type_351_QueryResponse | Type_351_ReceiveTeleportedAsset | Type_351_RefundSurplus | Type_351_ReportError | Type_351_ReserveAssetDeposited | Type_351_SetAppendix | Type_351_SetErrorHandler | Type_351_SubscribeVersion | Type_351_Transact | Type_351_TransferAsset | Type_351_TransferReserveAsset | Type_351_Trap | Type_351_UnsubscribeVersion | Type_351_WithdrawAsset

export interface Type_351_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_351_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_351_ClearError {
    __kind: 'ClearError'
}

export interface Type_351_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_351_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_351_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_351_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_351_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_351_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_351_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_351_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_351_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_351_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_351_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_351_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_351_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_351_RefundSurplus {
    __kind: 'RefundSurplus'
}
...
export interface Type_351_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_351_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_351[]
}

export interface Type_351_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_351[]
}

export interface Type_351_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_351_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_352
...
export interface Type_351_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_351_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_351_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_351_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_351_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_348 = Type_348_V2 | Type_348_V3

export interface Type_348_V2 {
    __kind: 'V2'
    value: Type_351[]
}

export interface Type_348_V3 {
    __kind: 'V3'
    value: Type_355[]
}
...
export type Call = Call_AssetRegistry | Call_Balances | Call_Bounties | Call_CallSwitchgear | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FeeShare | Call_FlexibleFee | Call_Identity | Call_Indices | Call_MerkleDistributor | Call_Multisig | Call_OrmlXcm | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_Slpx | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_Utility | Call_VeMinting | Call_Vesting | Call_VtokenMinting | Call_XTokens | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
...
export const Type_222: sts.Type<Type_222> = sts.struct(() => {
    return  {
...
export const MoonbeamLedgerUpdateEntry: sts.Type<MoonbeamLedgerUpdateEntry> = sts.struct(() => {
    return  {
        currencyId: CurrencyId,
        delegatorId: V3MultiLocation,
        validatorId: sts.option(() => V3MultiLocation),
...
export interface MoonbeamLedgerUpdateEntry {
    currencyId: CurrencyId
    delegatorId: V3MultiLocation
    validatorId?: (V3MultiLocation | undefined)
    updateOperation: MoonbeamLedgerUpdateOperation
    amount: bigint
    unlockTime?: (TimeUnit | undefined)
}
