...
export type HrmpOperation = HrmpOperation_InitOpen | HrmpOperation_Accept | HrmpOperation_Close
...
export interface TransactWeights {
    ...
    overallWeight: (bigint | undefined)
}
...
export interface XcmTransactorCall_set_transact_info {
    ...
    maxWeight: bigint
    transactExtraWeightSigned: (bigint | undefined)
}
...
export type Type_372 = Type_372_EthereumTransaction

export interface Type_372_EthereumTransaction {
    __kind: 'EthereumTransaction'
    value: Uint8Array
}

export type Type_373 = Type_373_Members | Type_373_Member | Type_373__Phantom

export interface Type_373_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_373_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_373__Phantom {
    __kind: '_Phantom'
}
...
export type Type_377 = Type_377_Xcm | Type_377_Response

export interface Type_377_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}

export interface Type_377_Response {
    __kind: 'Response'
    value: V1MultiLocation
}
...
export type Type_341 = Type_341_V0 | Type_341_V1 | Type_341_V2

export interface Type_341_V0 {
    __kind: 'V0'
    value: Type_342
}

export interface Type_341_V1 {
    __kind: 'V1'
    value: Type_347
}
...
export type Type_342 = Type_342_WithdrawAsset | Type_342_ReserveAssetDeposit | Type_342_TeleportAsset | Type_342_QueryResponse | Type_342_TransferAsset | Type_342_TransferReserveAsset | Type_342_Transact | Type_342_HrmpNewChannelOpenRequest | Type_342_HrmpChannelAccepted | Type_342_HrmpChannelClosing | Type_342_RelayedFrom
...
export interface Type_342_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_344[]
}

export interface Type_342_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_344[]
}
...
export interface Type_342_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_342
}

export type Type_347 = Type_347_WithdrawAsset | Type_347_ReserveAssetDeposited | Type_347_ReceiveTeleportedAsset | Type_347_QueryResponse | Type_347_TransferAsset | Type_347_TransferReserveAsset | Type_347_Transact | Type_347_HrmpNewChannelOpenRequest | Type_347_HrmpChannelAccepted | Type_347_HrmpChannelClosing | Type_347_RelayedFrom | Type_347_SubscribeVersion | Type_347_UnsubscribeVersion
...
export interface Type_347_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_347
}
...
export type Type_353 = Type_353_WithdrawAsset | Type_353_ReserveAssetDeposited | Type_353_ReceiveTeleportedAsset | Type_353_QueryResponse | Type_353_TransferAsset | Type_353_TransferReserveAsset | Type_353_Transact | Type_353_HrmpNewChannelOpenRequest | Type_353_HrmpChannelAccepted | Type_353_HrmpChannelClosing | Type_353_ClearOrigin | Type_353_DescendOrigin | Type_353_ReportError | Type_353_DepositAsset | Type_353_DepositReserveAsset | Type_353_ExchangeAsset | Type_353_InitiateReserveWithdraw | Type_353_InitiateTeleport | Type_353_QueryHolding | Type_353_BuyExecution | Type_353_RefundSurplus | Type_353_SetErrorHandler | Type_353_SetAppendix | Type_353_ClearError | Type_353_ClaimAsset | Type_353_Trap | Type_353_SubscribeVersion | Type_353_UnsubscribeVersion
...
export interface Type_353_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_344 = Type_344_Null | Type_344_DepositAsset | Type_344_DepositReserveAsset | Type_344_ExchangeAsset | Type_344_InitiateReserveWithdraw | Type_344_InitiateTeleport | Type_344_QueryHolding | Type_344_BuyExecution

export interface Type_344_Null {
    __kind: 'Null'
}
...
export type Type_349 = Type_349_Noop | Type_349_DepositAsset | Type_349_DepositReserveAsset | Type_349_ExchangeAsset | Type_349_InitiateReserveWithdraw | Type_349_InitiateTeleport | Type_349_QueryHolding | Type_349_BuyExecution

export interface Type_349_Noop {
    __kind: 'Noop'
}
