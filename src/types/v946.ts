...
export type LedgerUpdateEntry = LedgerUpdateEntry_Substrate | LedgerUpdateEntry_Moonriver
...
export interface LedgerUpdateEntry_Moonriver {
    __kind: 'Moonriver'
    value: MoonriverLedgerUpdateEntry
}

export type Ledger = Ledger_Substrate | Ledger_Moonriver
...
export interface Ledger_Moonriver {
    __kind: 'Moonriver'
    value: OneToManyLedger
}

export type TimeUnit = TimeUnit_Era | TimeUnit_SlashingSpan | TimeUnit_Round
...
export interface MoonriverLedgerUpdateEntry {
    currencyId: CurrencyId
    delegatorId: V1MultiLocation
    validatorId: (V1MultiLocation | undefined)
    updateOperation: MoonriverLedgerUpdateOperation
    amount: bigint
    unlockTime: (TimeUnit | undefined)
}
...
export type SubstrateLedgerUpdateOperation = SubstrateLedgerUpdateOperation_Bond | SubstrateLedgerUpdateOperation_Unlock | SubstrateLedgerUpdateOperation_Rebond | SubstrateLedgerUpdateOperation_Liquidize
...
export type MoonriverLedgerUpdateOperation = MoonriverLedgerUpdateOperation_Bond | MoonriverLedgerUpdateOperation_BondLess | MoonriverLedgerUpdateOperation_Revoke | MoonriverLedgerUpdateOperation_CancelRequest | MoonriverLedgerUpdateOperation_LeaveDelegator | MoonriverLedgerUpdateOperation_CancelLeave | MoonriverLedgerUpdateOperation_ExecuteLeave | MoonriverLedgerUpdateOperation_ExecuteRequest

export interface MoonriverLedgerUpdateOperation_Bond {
    __kind: 'Bond'
}

export interface MoonriverLedgerUpdateOperation_BondLess {
    __kind: 'BondLess'
}

export interface MoonriverLedgerUpdateOperation_Revoke {
    __kind: 'Revoke'
}

export interface MoonriverLedgerUpdateOperation_CancelRequest {
    __kind: 'CancelRequest'
}

export interface MoonriverLedgerUpdateOperation_LeaveDelegator {
    __kind: 'LeaveDelegator'
}

export interface MoonriverLedgerUpdateOperation_CancelLeave {
    __kind: 'CancelLeave'
}

export interface MoonriverLedgerUpdateOperation_ExecuteLeave {
    __kind: 'ExecuteLeave'
}

export interface MoonriverLedgerUpdateOperation_ExecuteRequest {
...
export type Type_361 = Type_361_V0 | Type_361_V1 | Type_361_V2

export interface Type_361_V0 {
    __kind: 'V0'
    value: Type_362
}

export interface Type_361_V1 {
    __kind: 'V1'
    value: Type_367
}

export interface Type_361_V2 {
    __kind: 'V2'
    value: Type_373[]
}
...
export type Type_461 = Type_461_Ongoing | Type_461_Retired | Type_461_Success | Type_461_Failed | Type_461_RefundWithdrew | Type_461_RedeemWithdrew | Type_461_FailedToContinue

export interface Type_461_Ongoing {
    __kind: 'Ongoing'
}

export interface Type_461_Retired {
    __kind: 'Retired'
}

export interface Type_461_Success {
    __kind: 'Success'
}

export interface Type_461_Failed {
    __kind: 'Failed'
}

export interface Type_461_RefundWithdrew {
    __kind: 'RefundWithdrew'
}

export interface Type_461_RedeemWithdrew {
    __kind: 'RedeemWithdrew'
}

export interface Type_461_FailedToContinue {
    __kind: 'FailedToContinue'
}
...
export type Type_362 = Type_362_WithdrawAsset | Type_362_ReserveAssetDeposit | Type_362_TeleportAsset | Type_362_QueryResponse | Type_362_TransferAsset | Type_362_TransferReserveAsset | Type_362_Transact | Type_362_HrmpNewChannelOpenRequest | Type_362_HrmpChannelAccepted | Type_362_HrmpChannelClosing | Type_362_RelayedFrom

export interface Type_362_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_364[]
}

export interface Type_362_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_364[]
}

export interface Type_362_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_364[]
}

export interface Type_362_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_362_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_362_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_362_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_362_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_362_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_362_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_362_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_362
}

export type Type_367 = Type_367_WithdrawAsset | Type_367_ReserveAssetDeposited | Type_367_ReceiveTeleportedAsset | Type_367_QueryResponse | Type_367_TransferAsset | Type_367_TransferReserveAsset | Type_367_Transact | Type_367_HrmpNewChannelOpenRequest | Type_367_HrmpChannelAccepted | Type_367_HrmpChannelClosing | Type_367_RelayedFrom | Type_367_SubscribeVersion | Type_367_UnsubscribeVersion
...
export interface Type_367_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_367
}
...
export type Type_373 = Type_373_WithdrawAsset | Type_373_ReserveAssetDeposited | Type_373_ReceiveTeleportedAsset | Type_373_QueryResponse | Type_373_TransferAsset | Type_373_TransferReserveAsset | Type_373_Transact | Type_373_HrmpNewChannelOpenRequest | Type_373_HrmpChannelAccepted | Type_373_HrmpChannelClosing | Type_373_ClearOrigin | Type_373_DescendOrigin | Type_373_ReportError | Type_373_DepositAsset | Type_373_DepositReserveAsset | Type_373_ExchangeAsset | Type_373_InitiateReserveWithdraw | Type_373_InitiateTeleport | Type_373_QueryHolding | Type_373_BuyExecution | Type_373_RefundSurplus | Type_373_SetErrorHandler | Type_373_SetAppendix | Type_373_ClearError | Type_373_ClaimAsset | Type_373_Trap | Type_373_SubscribeVersion | Type_373_UnsubscribeVersion

export interface Type_373_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V1MultiAsset[]
}

export interface Type_373_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_373_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_373_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_373_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_373_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_373_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_373_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_373_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_373_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_373_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_373_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_373_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_373_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_373_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_373_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_373_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_373_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_373_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_373_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_373_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_373_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_373[]
}

export interface Type_373_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_373[]
}

export interface Type_373_ClearError {
    __kind: 'ClearError'
}

export interface Type_373_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_373_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_373_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_373_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_364 = Type_364_Null | Type_364_DepositAsset | Type_364_DepositReserveAsset | Type_364_ExchangeAsset | Type_364_InitiateReserveWithdraw | Type_364_InitiateTeleport | Type_364_QueryHolding | Type_364_BuyExecution

export interface Type_364_Null {
    __kind: 'Null'
}
...
export interface Type_364_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Type_369 = Type_369_Noop | Type_369_DepositAsset | Type_369_DepositReserveAsset | Type_369_ExchangeAsset | Type_369_InitiateReserveWithdraw | Type_369_InitiateTeleport | Type_369_QueryHolding | Type_369_BuyExecution

export interface Type_369_Noop {
    __kind: 'Noop'
}

export interface Type_369_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_369_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_369_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_369_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_369_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_369_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_369_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_367[]
}
