...
export const Type_426: sts.Type<Type_426> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_426),
        SetErrorHandler: sts.array(() => Type_426),
...
export const Type_419: sts.Type<Type_419> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_419 {
    encoded: Bytes
}
...
export interface Type_426_DepositReserveAsset {
...
export interface Type_426_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_426_ExchangeAsset {
...
export interface Type_426_InitiateReserveWithdraw {
...
export interface Type_426_InitiateTeleport {
...
export interface Type_426_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_426_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_426_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_426_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_426_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_426_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_426[]
}

export interface Type_426_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_426[]
}

export interface Type_426_SubscribeVersion {
...
export interface Type_426_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_426_UnsubscribeVersion {
...
export const Type_422: sts.Type<Type_422> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_420),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_422 = Type_422_BuyExecution | Type_422_DepositAsset | Type_422_DepositReserveAsset | Type_422_ExchangeAsset | Type_422_InitiateReserveWithdraw | Type_422_InitiateTeleport | Type_422_Noop | Type_422_QueryHolding

export interface Type_422_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_420[]
}

export interface Type_422_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_422_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_422_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_422_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_422_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_422_Noop {
    __kind: 'Noop'
}

export interface Type_422_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_420 = Type_420_HrmpChannelAccepted | Type_420_HrmpChannelClosing | Type_420_HrmpNewChannelOpenRequest | Type_420_QueryResponse | Type_420_ReceiveTeleportedAsset | Type_420_RelayedFrom | Type_420_ReserveAssetDeposited | Type_420_SubscribeVersion | Type_420_Transact | Type_420_TransferAsset | Type_420_TransferReserveAsset | Type_420_UnsubscribeVersion | Type_420_WithdrawAsset
...
export interface Type_420_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_420
}
...
export const Type_417: sts.Type<Type_417> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V0MultiAsset,
            weight: sts.bigint(),
...
export type Type_417 = Type_417_BuyExecution | Type_417_DepositAsset | Type_417_DepositReserveAsset | Type_417_ExchangeAsset | Type_417_InitiateReserveWithdraw | Type_417_InitiateTeleport | Type_417_Null | Type_417_QueryHolding

export interface Type_417_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export interface Type_417_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_417_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_417_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_417_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_417_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_417_Null {
    __kind: 'Null'
}

export interface Type_417_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export type Type_415 = Type_415_HrmpChannelAccepted | Type_415_HrmpChannelClosing | Type_415_HrmpNewChannelOpenRequest | Type_415_QueryResponse | Type_415_RelayedFrom | Type_415_ReserveAssetDeposit | Type_415_TeleportAsset | Type_415_Transact | Type_415_TransferAsset | Type_415_TransferReserveAsset | Type_415_WithdrawAsset

export interface Type_415_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_415_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_415_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_415_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_415_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_415
}

export interface Type_415_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_417[]
}

export interface Type_415_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_417[]
}

export interface Type_415_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_419
...
export interface Type_415_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_415_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_415_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_417[]
}

export type Type_414 = Type_414_V0 | Type_414_V1 | Type_414_V2

export interface Type_414_V0 {
    __kind: 'V0'
    value: Type_415
}

export interface Type_414_V1 {
    __kind: 'V1'
    value: Type_420
}

export interface Type_414_V2 {
    __kind: 'V2'
    value: Type_426[]
}
...
export type Type_245 = Type_245_Response | Type_245_Xcm

export interface Type_245_Response {
    __kind: 'Response'
    value: V1MultiLocation
}

export interface Type_245_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}
...
export type Type_242 = Type_242_Member | Type_242_Members | Type_242__Phantom
...
export const Type_205: sts.Type<Type_205> = sts.struct(() => {
    return  {
...
export const Type_210: sts.Type<Type_210> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export type Call = Call_Auctions | Call_Authorship | Call_Babe | Call_BagsList | Call_Balances | Call_Bounties | Call_Claims | Call_Configuration | Call_Council | Call_Crowdloan | Call_Democracy | Call_Dmp | Call_ElectionProviderMultiPhase | Call_Grandpa | Call_Hrmp | Call_Identity | Call_ImOnline | Call_Indices | Call_Initializer | Call_Multisig | Call_ParaInclusion | Call_ParaInherent | Call_Paras | Call_ParasShared | Call_PhragmenElection | Call_Preimage | Call_Proxy | Call_Registrar | Call_Scheduler | Call_Session | Call_Slots | Call_Staking | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_Treasury | Call_Ump | Call_Utility | Call_Vesting | Call_XcmPallet
