...
export type Call = Call_System | Call_Utility | Call_Identity | Call_Timestamp | Call_Multisig | Call_ParachainSystem | Call_Balances | Call_Vesting | Call_DappsStaking | Call_BlockReward | Call_Assets | Call_Authorship | Call_CollatorSelection | Call_Session | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_EVM | Call_Ethereum | Call_EthCall | Call_BaseFee | Call_Sudo
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DappsStakingCall = DappsStakingCall_register | DappsStakingCall_unregister | DappsStakingCall_withdraw_from_unregistered | DappsStakingCall_bond_and_stake | DappsStakingCall_unbond_and_unstake | DappsStakingCall_withdraw_unbonded | DappsStakingCall_claim_staker | DappsStakingCall_claim_dapp | DappsStakingCall_force_new_era | DappsStakingCall_developer_pre_approval | DappsStakingCall_enable_developer_pre_approval | DappsStakingCall_maintenance_mode | DappsStakingCall_set_reward_destination | DappsStakingCall_set_contract_stake_info
