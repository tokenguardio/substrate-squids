...
export const Type_404: sts.Type<Type_404> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_407),
        V3: sts.array(() => Type_411),
    }
})
...
export const Type_411: sts.Type<Type_411> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_411),
        SetErrorHandler: sts.array(() => Type_411),
...
export const Type_408: sts.Type<Type_408> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_408 {
    encoded: Bytes
}
...
export type Type_411 = Type_411_AliasOrigin | Type_411_BurnAsset | Type_411_BuyExecution | Type_411_ClaimAsset | Type_411_ClearError | Type_411_ClearOrigin | Type_411_ClearTopic | Type_411_ClearTransactStatus | Type_411_DepositAsset | Type_411_DepositReserveAsset | Type_411_DescendOrigin | Type_411_ExchangeAsset | Type_411_ExpectAsset | Type_411_ExpectError | Type_411_ExpectOrigin | Type_411_ExpectPallet | Type_411_ExpectTransactStatus | Type_411_ExportMessage | Type_411_HrmpChannelAccepted | Type_411_HrmpChannelClosing | Type_411_HrmpNewChannelOpenRequest | Type_411_InitiateReserveWithdraw | Type_411_InitiateTeleport | Type_411_LockAsset | Type_411_NoteUnlockable | Type_411_QueryPallet | Type_411_QueryResponse | Type_411_ReceiveTeleportedAsset | Type_411_RefundSurplus | Type_411_ReportError | Type_411_ReportHolding | Type_411_ReportTransactStatus | Type_411_RequestUnlock | Type_411_ReserveAssetDeposited | Type_411_SetAppendix | Type_411_SetErrorHandler | Type_411_SetFeesMode | Type_411_SetTopic | Type_411_SubscribeVersion | Type_411_Transact | Type_411_TransferAsset | Type_411_TransferReserveAsset | Type_411_Trap | Type_411_UniversalOrigin | Type_411_UnlockAsset | Type_411_UnpaidExecution | Type_411_UnsubscribeVersion | Type_411_WithdrawAsset

export interface Type_411_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_411_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_411_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_411_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_411_ClearError {
    __kind: 'ClearError'
}

export interface Type_411_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_411_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_411_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_411_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_411_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_411_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_411_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_411_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_411_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_411_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_411_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_411_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_411_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_411_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_411_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_411_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_411_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_411_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_411_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_411_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_411_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_411_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_411_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_411_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_411_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_411_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_411_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_411_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_411_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_411_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_411[]
}

export interface Type_411_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_411[]
}

export interface Type_411_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_411_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_411_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_411_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_408
...
export interface Type_411_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_411_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_411_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_411_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_411_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_411_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_411_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_411_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export const Type_407: sts.Type<Type_407> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_407),
        SetErrorHandler: sts.array(() => Type_407),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_407 = Type_407_BuyExecution | Type_407_ClaimAsset | Type_407_ClearError | Type_407_ClearOrigin | Type_407_DepositAsset | Type_407_DepositReserveAsset | Type_407_DescendOrigin | Type_407_ExchangeAsset | Type_407_HrmpChannelAccepted | Type_407_HrmpChannelClosing | Type_407_HrmpNewChannelOpenRequest | Type_407_InitiateReserveWithdraw | Type_407_InitiateTeleport | Type_407_QueryHolding | Type_407_QueryResponse | Type_407_ReceiveTeleportedAsset | Type_407_RefundSurplus | Type_407_ReportError | Type_407_ReserveAssetDeposited | Type_407_SetAppendix | Type_407_SetErrorHandler | Type_407_SubscribeVersion | Type_407_Transact | Type_407_TransferAsset | Type_407_TransferReserveAsset | Type_407_Trap | Type_407_UnsubscribeVersion | Type_407_WithdrawAsset

export interface Type_407_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_407_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_407_ClearError {
    __kind: 'ClearError'
}

export interface Type_407_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_407_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_407_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_407_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_407_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_407_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_407_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_407_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_407_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_407_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_407_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_407_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_407_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_407_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_407_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_407_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_407_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_407[]
}

export interface Type_407_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_407[]
}

export interface Type_407_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_407_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_408
...
export interface Type_407_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_407_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_407_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_407_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_407_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_404 = Type_404_V2 | Type_404_V3

export interface Type_404_V2 {
    __kind: 'V2'
    value: Type_407[]
}

export interface Type_404_V3 {
    __kind: 'V3'
    value: Type_411[]
}
...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_configs: sts.enumStruct({
            ...
            maxNominatorCount: Type_99,
            maxValidatorCount: Type_99,
            chillThreshold: Type_100,
            minCommission: Type_101,
        }),
...
export type Type_101 = Type_101_Noop | Type_101_Remove | Type_101_Set

export interface Type_101_Noop {
    __kind: 'Noop'
}

export interface Type_101_Remove {
    __kind: 'Remove'
}

export interface Type_101_Set {
    __kind: 'Set'
    value: Perbill
}
...
export type Type_100 = Type_100_Noop | Type_100_Remove | Type_100_Set

export interface Type_100_Noop {
    __kind: 'Noop'
}

export interface Type_100_Remove {
    __kind: 'Remove'
}

export interface Type_100_Set {
    __kind: 'Set'
    value: Percent
}
...
export type Type_99 = Type_99_Noop | Type_99_Remove | Type_99_Set

export interface Type_99_Noop {
    __kind: 'Noop'
}

export interface Type_99_Remove {
    __kind: 'Remove'
}

export interface Type_99_Set {
    __kind: 'Set'
    value: number
}
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_275,
            minCreateBond: Type_275,
            maxPools: Type_276,
            maxMembers: Type_276,
            maxMembersPerPool: Type_276,
            globalMaxCommission: Type_277,
        }),
        set_metadata: sts.enumStruct({
            poolId: sts.number(),
            metadata: sts.bytes(),
...
export type Type_277 = Type_277_Noop | Type_277_Remove | Type_277_Set

export interface Type_277_Noop {
    __kind: 'Noop'
}

export interface Type_277_Remove {
    __kind: 'Remove'
}

export interface Type_277_Set {
    __kind: 'Set'
    value: Perbill
}
...
export type Type_276 = Type_276_Noop | Type_276_Remove | Type_276_Set

export interface Type_276_Noop {
    __kind: 'Noop'
}

export interface Type_276_Remove {
    __kind: 'Remove'
}

export interface Type_276_Set {
    __kind: 'Set'
    value: number
}
...
export type Type_275 = Type_275_Noop | Type_275_Remove | Type_275_Set
...
export const Type_108: sts.Type<Type_108> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export type Call = Call_Auctions | Call_Babe | Call_Balances | Call_Bounties | Call_ChildBounties | Call_Claims | Call_Configuration | Call_ConvictionVoting | Call_Crowdloan | Call_ElectionProviderMultiPhase | Call_FastUnstake | Call_Grandpa | Call_Hrmp | Call_Identity | Call_ImOnline | Call_Indices | Call_Initializer | Call_MessageQueue | Call_Multisig | Call_NominationPools | Call_ParaInclusion | Call_ParaInherent | Call_Paras | Call_ParasDisputes | Call_ParasShared | Call_ParasSlashing | Call_Preimage | Call_Proxy | Call_Referenda | Call_Registrar | Call_Scheduler | Call_Session | Call_Slots | Call_Staking | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_VoterList | Call_Whitelist | Call_XcmPallet
