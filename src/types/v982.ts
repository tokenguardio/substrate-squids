...
export type Type_103 = Type_103_Locked1x | Type_103_Locked2x | Type_103_Locked3x | Type_103_Locked4x | Type_103_Locked5x | Type_103_Locked6x | Type_103_None

export interface Type_103_Locked1x {
    __kind: 'Locked1x'
}

export interface Type_103_Locked2x {
    __kind: 'Locked2x'
}

export interface Type_103_Locked3x {
    __kind: 'Locked3x'
}

export interface Type_103_Locked4x {
    __kind: 'Locked4x'
}

export interface Type_103_Locked5x {
    __kind: 'Locked5x'
}

export interface Type_103_Locked6x {
    __kind: 'Locked6x'
}

export interface Type_103_None {
    __kind: 'None'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        ...
        CumulusXcm: Type_119,
        Origins: Origin,
        PolkadotXcm: Type_111,
        TechnicalCommittee: Type_109,
        Void: Void,
        system: RawOrigin,
    }
})
...
export type Type_111 = Type_111_Response | Type_111_Xcm

export interface Type_111_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_111_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export const Origin: sts.Type<Origin> = sts.closedEnum(() => {
    return  {
        ...
        SALPAdmin: sts.unit(),
        SystemStakingAdmin: sts.unit(),
        TechAdmin: sts.unit(),
        ValidatorElection: sts.unit(),
        WhitelistedCaller: sts.unit(),
    }
})

export type Origin = Origin_CoreAdmin | Origin_Fellows | Origin_Fellowship1Dan | Origin_Fellowship2Dan | Origin_Fellowship3Dan | Origin_Fellowship4Dan | Origin_Fellowship5Dan | Origin_Fellowship6Dan | Origin_Fellowship7Dan | Origin_Fellowship8Dan | Origin_Fellowship9Dan | Origin_FellowshipAdmin | Origin_FellowshipExperts | Origin_FellowshipInitiates | Origin_FellowshipMasters | Origin_ReferendumCanceller | Origin_ReferendumKiller | Origin_SALPAdmin | Origin_SystemStakingAdmin | Origin_TechAdmin | Origin_ValidatorElection | Origin_WhitelistedCaller
...
export interface Origin_SystemStakingAdmin {
    __kind: 'SystemStakingAdmin'
}
...
export interface Origin_ValidatorElection {
    __kind: 'ValidatorElection'
}
...
export type Type_119 = Type_119_Relay | Type_119_SiblingParachain

export interface Type_119_Relay {
    __kind: 'Relay'
}

export interface Type_119_SiblingParachain {
...
export type Type_108 = Type_108_Member | Type_108_Members | Type_108__Phantom

export interface Type_108_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_108_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_108__Phantom {
    __kind: '_Phantom'
}
...
export type CurrencyId = CurrencyId_BLP | CurrencyId_ForeignAsset | CurrencyId_LPToken | CurrencyId_Native | CurrencyId_Stable | CurrencyId_StableLpToken | CurrencyId_Token | CurrencyId_Token2 | CurrencyId_VSBond | CurrencyId_VSBond2 | CurrencyId_VSToken | CurrencyId_VSToken2 | CurrencyId_VToken | CurrencyId_VToken2
...
export const VtokenVotingCall: sts.Type<VtokenVotingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_delegator_role: sts.enumStruct({
            vtoken: CurrencyId,
            derivativeIndex: sts.number(),
            voteRole: VoteRole,
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VtokenVotingCall = VtokenVotingCall_kill_referendum | VtokenVotingCall_notify_remove_delegator_vote | VtokenVotingCall_notify_vote | VtokenVotingCall_remove_delegator_vote | VtokenVotingCall_set_delegator_role | VtokenVotingCall_set_referendum_status | VtokenVotingCall_set_undeciding_timeout | VtokenVotingCall_set_vote_locking_period | VtokenVotingCall_unlock | VtokenVotingCall_vote
...
export interface VtokenVotingCall_set_delegator_role {
    __kind: 'set_delegator_role'
    vtoken: CurrencyId
    derivativeIndex: number
    voteRole: VoteRole
}
...
export type Type_365 = Type_365_Split | Type_365_SplitAbstain | Type_365_Standard

export interface Type_365_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}

export interface Type_365_SplitAbstain {
    __kind: 'SplitAbstain'
    aye: bigint
    nay: bigint
    abstain: bigint
...
export interface Type_365_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}
...
export type VoteRole = VoteRole_Split | VoteRole_SplitAbstain | VoteRole_Standard

export interface VoteRole_Split {
    __kind: 'Split'
}

export interface VoteRole_SplitAbstain {
    __kind: 'SplitAbstain'
}

export interface VoteRole_Standard {
    __kind: 'Standard'
    aye: boolean
    conviction: Type_103
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type StablePoolCall = StablePoolCall_add_liquidity | StablePoolCall_create_pool | StablePoolCall_edit_token_rate | StablePoolCall_modify_a | StablePoolCall_modify_fees | StablePoolCall_modify_recipients | StablePoolCall_redeem_multi | StablePoolCall_redeem_proportion | StablePoolCall_redeem_single | StablePoolCall_swap
...
export type TargetChain = TargetChain_Astar | TargetChain_Hydradx | TargetChain_Moonbeam
...
export type SupportChain = SupportChain_Astar | SupportChain_Hydradx | SupportChain_Moonbeam
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SlpxCall = SlpxCall_add_whitelist | SlpxCall_mint | SlpxCall_redeem | SlpxCall_remove_whitelist | SlpxCall_set_execution_fee | SlpxCall_set_transfer_to_fee | SlpxCall_stable_pool_swap | SlpxCall_zenlink_swap
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SalpCall = SalpCall_batch_unlock | SalpCall_buyback | SalpCall_buyback_vstoken_by_stable_pool | SalpCall_confirm_contribute | SalpCall_confirm_contribution | SalpCall_continue_fund | SalpCall_contribute | SalpCall_create | SalpCall_dissolve | SalpCall_dissolve_refunded | SalpCall_edit | SalpCall_fund_end | SalpCall_fund_fail | SalpCall_fund_retire | SalpCall_fund_success | SalpCall_redeem | SalpCall_refund | SalpCall_set_multisig_confirm_account | SalpCall_unlock | SalpCall_unlock_by_vsbond | SalpCall_unlock_vstoken | SalpCall_withdraw
...
export const Type_181: sts.Type<Type_181> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_184),
        V3: sts.array(() => Type_188),
    }
})
...
export const Type_188: sts.Type<Type_188> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_188),
        SetErrorHandler: sts.array(() => Type_188),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_185: sts.Type<Type_185> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_185 {
    encoded: Bytes
}

export type Type_188 = Type_188_AliasOrigin | Type_188_BurnAsset | Type_188_BuyExecution | Type_188_ClaimAsset | Type_188_ClearError | Type_188_ClearOrigin | Type_188_ClearTopic | Type_188_ClearTransactStatus | Type_188_DepositAsset | Type_188_DepositReserveAsset | Type_188_DescendOrigin | Type_188_ExchangeAsset | Type_188_ExpectAsset | Type_188_ExpectError | Type_188_ExpectOrigin | Type_188_ExpectPallet | Type_188_ExpectTransactStatus | Type_188_ExportMessage | Type_188_HrmpChannelAccepted | Type_188_HrmpChannelClosing | Type_188_HrmpNewChannelOpenRequest | Type_188_InitiateReserveWithdraw | Type_188_InitiateTeleport | Type_188_LockAsset | Type_188_NoteUnlockable | Type_188_QueryPallet | Type_188_QueryResponse | Type_188_ReceiveTeleportedAsset | Type_188_RefundSurplus | Type_188_ReportError | Type_188_ReportHolding | Type_188_ReportTransactStatus | Type_188_RequestUnlock | Type_188_ReserveAssetDeposited | Type_188_SetAppendix | Type_188_SetErrorHandler | Type_188_SetFeesMode | Type_188_SetTopic | Type_188_SubscribeVersion | Type_188_Transact | Type_188_TransferAsset | Type_188_TransferReserveAsset | Type_188_Trap | Type_188_UniversalOrigin | Type_188_UnlockAsset | Type_188_UnpaidExecution | Type_188_UnsubscribeVersion | Type_188_WithdrawAsset

export interface Type_188_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_188_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_188_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_188_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_188_ClearError {
    __kind: 'ClearError'
}

export interface Type_188_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_188_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_188_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_188_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_188_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_188_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_188_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_188_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_188_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_188_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_188_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_188_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_188_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_188_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_188_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_188_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_188_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_188_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_188_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_188_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_188_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_188_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_188_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_188_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_188_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_188_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_188_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_188_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_188_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_188_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_188[]
}

export interface Type_188_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_188[]
}

export interface Type_188_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_188_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_188_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_188_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_185
...
export interface Type_188_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_188_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_188_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_188_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_188_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_188_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_188_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_188_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export const Type_184: sts.Type<Type_184> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_184),
        SetErrorHandler: sts.array(() => Type_184),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_184 = Type_184_BuyExecution | Type_184_ClaimAsset | Type_184_ClearError | Type_184_ClearOrigin | Type_184_DepositAsset | Type_184_DepositReserveAsset | Type_184_DescendOrigin | Type_184_ExchangeAsset | Type_184_HrmpChannelAccepted | Type_184_HrmpChannelClosing | Type_184_HrmpNewChannelOpenRequest | Type_184_InitiateReserveWithdraw | Type_184_InitiateTeleport | Type_184_QueryHolding | Type_184_QueryResponse | Type_184_ReceiveTeleportedAsset | Type_184_RefundSurplus | Type_184_ReportError | Type_184_ReserveAssetDeposited | Type_184_SetAppendix | Type_184_SetErrorHandler | Type_184_SubscribeVersion | Type_184_Transact | Type_184_TransferAsset | Type_184_TransferReserveAsset | Type_184_Trap | Type_184_UnsubscribeVersion | Type_184_WithdrawAsset

export interface Type_184_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_184_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_184_ClearError {
    __kind: 'ClearError'
}

export interface Type_184_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_184_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_184_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_184_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_184_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}
...
export interface Type_184_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_184_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_184_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_184_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_184_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_184_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_184[]
}

export interface Type_184_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_184[]
}
...
export interface Type_184_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_181 = Type_181_V2 | Type_181_V3

export interface Type_181_V2 {
    __kind: 'V2'
    value: Type_184[]
}

export interface Type_181_V3 {
    __kind: 'V3'
    value: Type_188[]
}
...
export type Call = Call_AssetRegistry | Call_Balances | Call_Bounties | Call_CallSwitchgear | Call_CollatorSelection | Call_ConvictionVoting | Call_Council | Call_CouncilMembership | Call_CrossInOut | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FeeShare | Call_FellowshipCollective | Call_FellowshipReferenda | Call_FlexibleFee | Call_Identity | Call_Indices | Call_MerkleDistributor | Call_Multisig | Call_OrmlXcm | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Referenda | Call_Salp | Call_Scheduler | Call_Session | Call_Slp | Call_Slpx | Call_StablePool | Call_System | Call_SystemMaker | Call_SystemStaking | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TokenConversion | Call_Tokens | Call_Treasury | Call_Utility | Call_VeMinting | Call_Vesting | Call_VtokenMinting | Call_VtokenVoting | Call_Whitelist | Call_XTokens | Call_XcmInterface | Call_XcmpQueue | Call_ZenlinkProtocol
...
export const VoteRole: sts.Type<VoteRole> = sts.closedEnum(() => {
    return  {
        Split: sts.unit(),
        SplitAbstain: sts.unit(),
        Standard: sts.enumStruct({
            aye: sts.boolean(),
            conviction: Type_103,
        }),
...
export const Type_371: sts.Type<Type_371> = sts.struct(() => {
    return  {
        ayes: sts.bigint(),
        nays: sts.bigint(),
        support: sts.bigint(),
...
export type ExtraFeeName = ExtraFeeName_NoExtraFee | ExtraFeeName_SalpContribute | ExtraFeeName_StatemineTransfer | ExtraFeeName_VoteRemoveDelegatorVote | ExtraFeeName_VoteVtoken
