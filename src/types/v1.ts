...
export type Call = Call_System | Call_Timestamp | Call_Balances | Call_Scheduler | Call_CompanyReserve | Call_InternationalReserve | Call_UsaReserve | Call_Vesting | Call_Authorship | Call_ValidatorsSet | Call_Session | Call_ParachainSystem | Call_CumulusXcm | Call_Utility | Call_Multisig | Call_EmergencyShutdown | Call_Allocations | Call_AllocationsOracles | Call_Sudo
