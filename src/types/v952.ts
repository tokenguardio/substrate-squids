...
export type Call = Call_AssetRegistry | Call_Authorship | Call_Balances | Call_Bounties | Call_CallSwitchgear | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Identity | Call_Indices | Call_Multisig | Call_OrmlXcm | Call_ParachainSystem | Call_PhragmenElection | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_Tokens | Call_Treasury | Call_Utility | Call_Vesting | Call_XTokens | Call_XcmInterface | Call_XcmpQueue
...
export type Type_218 = Type_218_Member | Type_218_Members | Type_218__Phantom

export interface Type_218_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_218_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_218__Phantom {
    __kind: '_Phantom'
}
...
export type Type_220 = Type_220_Relay | Type_220_SiblingParachain

export interface Type_220_Relay {
    __kind: 'Relay'
}

export interface Type_220_SiblingParachain {
...
export type Type_217 = Type_217_Member | Type_217_Members | Type_217__Phantom

export interface Type_217_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_217_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_217__Phantom {
    __kind: '_Phantom'
}
