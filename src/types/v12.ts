...
export interface V3OldEraRewardAndStake {
    rewards: bigint
    staked: bigint
}

export type Forcing = Forcing_NotForcing | Forcing_ForceNew
...
export type V2MigrationState = V2MigrationState_NotStarted | V2MigrationState_Ledger | V2MigrationState_StakingInfo | V2MigrationState_RewardsAndStakes | V2MigrationState_Finished

export interface V2MigrationState_NotStarted {
    __kind: 'NotStarted'
}

export interface V2MigrationState_Ledger {
    __kind: 'Ledger'
    value: (Uint8Array | undefined)
}

export interface V2MigrationState_StakingInfo {
    __kind: 'StakingInfo'
    value: (Uint8Array | undefined)
}

export interface V2MigrationState_RewardsAndStakes {
    __kind: 'RewardsAndStakes'
    value: (Uint8Array | undefined)
}

export interface V2MigrationState_Finished {
    __kind: 'Finished'
}

export type V3MigrationState = V3MigrationState_NotStarted | V3MigrationState_AccountLedger | V3MigrationState_GeneralEraInfo | V3MigrationState_GeneralStakerInfo | V3MigrationState_StakingInfo | V3MigrationState_DAppInfo | V3MigrationState_EraRewardAndStake | V3MigrationState_ContractStakeInfoRotation | V3MigrationState_Finished

export interface V3MigrationState_NotStarted {
    __kind: 'NotStarted'
}

export interface V3MigrationState_AccountLedger {
    __kind: 'AccountLedger'
    value: (Uint8Array | undefined)
}

export interface V3MigrationState_GeneralEraInfo {
    __kind: 'GeneralEraInfo'
    value: (Uint8Array | undefined)
}

export interface V3MigrationState_GeneralStakerInfo {
    __kind: 'GeneralStakerInfo'
    value: V3StakersInfoMigrationState
}

export interface V3MigrationState_StakingInfo {
    __kind: 'StakingInfo'
    value: (Uint8Array | undefined)
}

export interface V3MigrationState_DAppInfo {
    __kind: 'DAppInfo'
    value: (Uint8Array | undefined)
}

export interface V3MigrationState_EraRewardAndStake {
    __kind: 'EraRewardAndStake'
}

export interface V3MigrationState_ContractStakeInfoRotation {
    __kind: 'ContractStakeInfoRotation'
    value: (Uint8Array | undefined)
}

export interface V3MigrationState_Finished {
    __kind: 'Finished'
}
...
export type Version = Version_V1_0_0 | Version_V2_0_0 | Version_V3_0_0

export interface Version_V1_0_0 {
    __kind: 'V1_0_0'
}

export interface Version_V2_0_0 {
    __kind: 'V2_0_0'
}

export interface Version_V3_0_0 {
    __kind: 'V3_0_0'
}
...
export interface V3StakersInfoMigrationState {
    lastProcessedKey: (Uint8Array | undefined)
    processedItems: number
}

export type DAppState = DAppState_Registered | DAppState_Unregistered

export interface DAppState_Registered {
    __kind: 'Registered'
}

export interface DAppState_Unregistered {
    __kind: 'Unregistered'
    value: number
}
...
export type Event = Event_System | Event_Utility | Event_Identity | Event_Multisig | Event_ParachainSystem | Event_Balances | Event_Vesting | Event_DappsStaking | Event_BlockReward | Event_CollatorSelection | Event_Session | Event_EVM | Event_Ethereum | Event_EthCall | Event_BaseFee | Event_Sudo
