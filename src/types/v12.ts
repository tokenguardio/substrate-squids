 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DappsStakingCall = DappsStakingCall_bond_and_stake | DappsStakingCall_claim_dapp | DappsStakingCall_claim_staker | DappsStakingCall_developer_pre_approval | DappsStakingCall_do_upgrade | DappsStakingCall_enable_developer_pre_approval | DappsStakingCall_force_new_era | DappsStakingCall_maintenance_mode | DappsStakingCall_register | DappsStakingCall_unbond_and_unstake | DappsStakingCall_unregister | DappsStakingCall_withdraw_from_unregistered | DappsStakingCall_withdraw_unbonded
...
export type Call = Call_Authorship | Call_Balances | Call_BaseFee | Call_BlockReward | Call_CollatorSelection | Call_DappsStaking | Call_EVM | Call_EthCall | Call_Ethereum | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting
