...
export type ProxyType = ProxyType_Any | ProxyType_Assets | ProxyType_Balances | ProxyType_CancelProxy | ProxyType_DappsStaking | ProxyType_IdentityJudgement | ProxyType_NonTransfer | ProxyType_StakerRewardClaim
...
export const Type_251: sts.Type<Type_251> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_254),
        V3: sts.array(() => Type_258),
    }
})
...
export const Type_258: sts.Type<Type_258> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_258),
        SetErrorHandler: sts.array(() => Type_258),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_255: sts.Type<Type_255> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export type Type_258 = Type_258_AliasOrigin | Type_258_BurnAsset | Type_258_BuyExecution | Type_258_ClaimAsset | Type_258_ClearError | Type_258_ClearOrigin | Type_258_ClearTopic | Type_258_ClearTransactStatus | Type_258_DepositAsset | Type_258_DepositReserveAsset | Type_258_DescendOrigin | Type_258_ExchangeAsset | Type_258_ExpectAsset | Type_258_ExpectError | Type_258_ExpectOrigin | Type_258_ExpectPallet | Type_258_ExpectTransactStatus | Type_258_ExportMessage | Type_258_HrmpChannelAccepted | Type_258_HrmpChannelClosing | Type_258_HrmpNewChannelOpenRequest | Type_258_InitiateReserveWithdraw | Type_258_InitiateTeleport | Type_258_LockAsset | Type_258_NoteUnlockable | Type_258_QueryPallet | Type_258_QueryResponse | Type_258_ReceiveTeleportedAsset | Type_258_RefundSurplus | Type_258_ReportError | Type_258_ReportHolding | Type_258_ReportTransactStatus | Type_258_RequestUnlock | Type_258_ReserveAssetDeposited | Type_258_SetAppendix | Type_258_SetErrorHandler | Type_258_SetFeesMode | Type_258_SetTopic | Type_258_SubscribeVersion | Type_258_Transact | Type_258_TransferAsset | Type_258_TransferReserveAsset | Type_258_Trap | Type_258_UniversalOrigin | Type_258_UnlockAsset | Type_258_UnpaidExecution | Type_258_UnsubscribeVersion | Type_258_WithdrawAsset
...
export const Type_254: sts.Type<Type_254> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_254),
        SetErrorHandler: sts.array(() => Type_254),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_254 = Type_254_BuyExecution | Type_254_ClaimAsset | Type_254_ClearError | Type_254_ClearOrigin | Type_254_DepositAsset | Type_254_DepositReserveAsset | Type_254_DescendOrigin | Type_254_ExchangeAsset | Type_254_HrmpChannelAccepted | Type_254_HrmpChannelClosing | Type_254_HrmpNewChannelOpenRequest | Type_254_InitiateReserveWithdraw | Type_254_InitiateTeleport | Type_254_QueryHolding | Type_254_QueryResponse | Type_254_ReceiveTeleportedAsset | Type_254_RefundSurplus | Type_254_ReportError | Type_254_ReserveAssetDeposited | Type_254_SetAppendix | Type_254_SetErrorHandler | Type_254_SubscribeVersion | Type_254_Transact | Type_254_TransferAsset | Type_254_TransferReserveAsset | Type_254_Trap | Type_254_UnsubscribeVersion | Type_254_WithdrawAsset
...
export type Call = Call_Assets | Call_Balances | Call_BaseFee | Call_BlockReward | Call_CollatorSelection | Call_Contracts | Call_CumulusXcm | Call_DappsStaking | Call_DmpQueue | Call_EVM | Call_EthCall | Call_Ethereum | Call_Identity | Call_Multisig | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Proxy | Call_Session | Call_StateTrieMigration | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting | Call_XcAssetConfig | Call_XcmpQueue
