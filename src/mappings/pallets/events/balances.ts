...
export function normalizeBalancesEventsArgs(ctx: ChainContext, event: Event) {
  ...
  switch (event.name) {
    case "Balances.BalanceSet":
      ...
      if (e.isV100) {
        let [who, free, reserved] = e.asV100;
        return {
          who: bufferToHex(who),
          free,
          reserved,
    ...
    case "Balances.Endowed":
      ...
      if (e.isV100) {
        let [account, freeBalance] = e.asV100;
        return {
          account: bufferToHex(account),
          freeBalance,
        };
    ...
    case "Balances.ReserveRepatriated":
      ...
      if (e.isV100) {
        let [from, to, balance, destinationStatus] = e.asV100;
        return {
    ...
    case "Balances.Slashed":
      ...
      if (e.isV100) {
        let [who, amountSlashed] = e.asV100;
        return {
          who: bufferToHex(who),
