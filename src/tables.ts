...
export const Transaction = new Table(
  "transaction.parquet",
  {
    ...
    fee: Column(Types.Decimal(64, 0)),
    value: Column(Types.Decimal(64, 0)),
...
export const TraceCreate = new Table(
  "trace_create.parquet",
  {
    ...
    gas: Column(Types.Decimal(64, 0), {
      nullable: true,
    }),
    init: Column(Types.String(), {
      nullable: true,
    }),
    gasUsed: Column(Types.Decimal(64, 0), {
      nullable: true,
    }),
...
export const TraceSuicide = new Table(
  "trace_suicide.parquet",
  {
    ...
    balance: Column(Types.Decimal(64, 0), {
      nullable: true,
    }),
  },
  { compression: compression }
