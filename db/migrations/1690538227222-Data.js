module.exports = class Data1690538227222 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "wasm_contract_decoding_error" ("id" character varying NOT NULL, "block_hash" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "contract" text NOT NULL, "type" character varying(11) NOT NULL, "error_message" text, "name" text NOT NULL, "args" jsonb, CONSTRAINT "PK_bab19f16f70956306db64e8c744" PRIMARY KEY ("id"))`)
