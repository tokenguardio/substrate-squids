module.exports = class Data1713271882825 {
    name = 'Data1713271882825'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "substrate_transaction" ("id" character varying NOT NULL, "block_hash" text NOT NULL, "extrinsic_hash" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "name" text NOT NULL, "args" jsonb, "label" character varying(15) NOT NULL, "fee" numeric NOT NULL, "tip" numeric, "from" text, "to" text, "success" boolean NOT NULL, CONSTRAINT "PK_34de898449e2832c9db92960c1f" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_38928611a8bb5641f2535f7104" ON "substrate_transaction" ("extrinsic_hash") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_38928611a8bb5641f2535f7104"`)
