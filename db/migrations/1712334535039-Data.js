module.exports = class Data1712334535039 {
    name = 'Data1712334535039'

    async up(db) {
        await db.query(`CREATE TABLE "wasm_contract_abi" ("id" character varying NOT NULL, "dapp_name" text NOT NULL, "abi" jsonb NOT NULL, "label" text, "from_block" numeric, "added_by" text, CONSTRAINT "PK_4a938f3f82d0a85a20877451a4b" PRIMARY KEY ("id"))`)
